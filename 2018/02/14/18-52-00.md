...
| **Date** | 2018-02-14T10:52:00-08:00 |
| **Message-ID** | [20180214185206.15492-24-newren@gmail.com](https://lore.kernel.org/git/20180214185206.15492-24-newren@gmail.com) |

---

**Thread**: [thread](./18-51-37.thread.md#:~:text=2018/02/14/18-52-00)
...
@@ -1389,6 +1424,24 @@ static int conflict_rename_rename_2to1(struct merge_options *o,
 		if (!ret)
...
@@ -1951,6 +2004,111 @@ static char *check_for_directory_rename(struct merge_options *o,
 	return new_path;
 }
...
@@ -2000,6 +2158,7 @@ static struct string_list *get_renames(struct merge_options *o,
...
+		re->add_turned_into_rename = 0;
 		...
 		if (!item)
@@ -2016,6 +2175,12 @@ static struct string_list *get_renames(struct merge_options *o,
 			re->dst_entry = item->util;

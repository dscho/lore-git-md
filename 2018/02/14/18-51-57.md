...
| **Date** | 2018-02-14T10:51:57-08:00 |
| **Message-ID** | [20180214185206.15492-21-newren@gmail.com](https://lore.kernel.org/git/20180214185206.15492-21-newren@gmail.com) |

---

**Thread**: [thread](./18-51-37.thread.md#:~:text=2018/02/14/18-51-57)
...
@@ -1403,6 +1426,31 @@ static int tree_has_path(struct tree *tree, const char *path)
 			       hashy, &mode_o);
 }
...
+
 ...
 {
@@ -1672,6 +1720,84 @@ static struct hashmap *get_directory_renames(struct diff_queue_struct *pairs,
 	return dir_renames;
 }
...
@@ -1681,6 +1807,7 @@ static struct hashmap *get_directory_renames(struct diff_queue_struct *pairs,
  */
...
+				       struct hashmap *dir_renames,
 				       ...
 				       struct tree *o_tree,
 				       struct tree *a_tree,
@@ -1688,8 +1815,12 @@ static struct string_list *get_renames(struct merge_options *o,
...
+	compute_collisions(&collisions, dir_renames, pairs);
 	...
 	for (i = 0; i < pairs->nr; ++i) {
@@ -1720,6 +1851,13 @@ static struct string_list *get_renames(struct merge_options *o,

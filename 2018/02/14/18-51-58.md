...
| **Date** | 2018-02-14T10:51:58-08:00 |
| **Message-ID** | [20180214185206.15492-22-newren@gmail.com](https://lore.kernel.org/git/20180214185206.15492-22-newren@gmail.com) |

---

**Thread**: [thread](./18-51-37.thread.md#:~:text=2018/02/14/18-51-58)
...
--- a/merge-recursive.c
+++ b/merge-recursive.c
@@ -1519,6 +1519,91 @@ static void remove_hashmap_entries(struct hashmap *dir_renames,
...
@@ -1798,6 +1883,59 @@ static void compute_collisions(struct hashmap *collisions,
 	}
 }
...
@@ -1808,11 +1946,13 @@ static void compute_collisions(struct hashmap *collisions,
...
+				       int *clean_merge)
 {
 	int i;
 	struct hashmap collisions;
@@ -1827,11 +1967,22 @@ static struct string_list *get_renames(struct merge_options *o,
...
+
 		...
 		re->processed = 0;
 		re->pair = pair;
@@ -2149,7 +2300,7 @@ static int handle_renames(struct merge_options *o,
 {
...
@@ -2168,13 +2319,20 @@ static int handle_renames(struct merge_options *o,
 					 dir_re_merge, merge);

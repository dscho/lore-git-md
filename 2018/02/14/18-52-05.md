...
| **Date** | 2018-02-14T10:52:05-08:00 |
| **Message-ID** | [20180214185206.15492-29-newren@gmail.com](https://lore.kernel.org/git/20180214185206.15492-29-newren@gmail.com) |

---

**Thread**: [thread](./18-51-37.thread.md#:~:text=2018/02/14/18-52-05)
...
+		if (pair->status != 'A' && pair->status != 'R')
 		...
 		dir_rename_ent = check_dir_renamed(pair->two->path,
 						   dir_renames);
@@ -2218,7 +2218,7 @@ static struct string_list *get_renames(struct merge_options *o,
 		struct diff_filepair *pair = pairs->queue[i];

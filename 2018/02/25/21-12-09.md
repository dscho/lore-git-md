...
| **Date** | 2018-02-25T21:12:09Z |
| **Message-ID** | [20180225211212.477570-34-sandals@crustytoothpaste.net](https://lore.kernel.org/git/20180225211212.477570-34-sandals@crustytoothpaste.net) |

---

**Thread**: [thread](./21-11-36.thread.md#:~:text=2018/02/25/21-12-09)
...
+						     &file_size);
 		...
 		if (!file->ptr)
@@ -1828,8 +1828,8 @@ void setup_scoreboard(struct blame_scoreboard *sb, const char *path, struct blam
 				    &sb->final_buf_size))
 			;
 		else
...
index 17382f2fa4..044b82bcee 100644
...
index 02ec19060d..aedae7a14d 100644
...
index 7c2843a492..a0592ed065 100644
--- a/builtin/grep.c
+++ b/builtin/grep.c
...
index 27aa50396b..5b6ef98f48 100644
...
index 16d6069e16..91c7b62ec3 100644
...
index 2233725315..e8e32db92e 100644
--- a/builtin/reflog.c
+++ b/builtin/reflog.c
...
index 3340cbedd4..85d326fbe0 100644
--- a/builtin/tag.c
+++ b/builtin/tag.c
...
+	buf = read_object_file(oid, &type, &size);
 	if (!buf)
 		return;
 	/* skip header */
@@ -300,7 +300,7 @@ static void create_reflog_msg(const struct object_id *oid, struct strbuf *sb)
...
index 6e712081e0..299608cc32 100644
...
index ba38ac9b15..3c37ba911e 100644
...
index c482fb92fe..970d6edd04 100644
--- a/cache.h
+++ b/cache.h
...
index 3d86304c5a..e5290ac05c 100644
--- a/combine-diff.c
+++ b/combine-diff.c
...
index b9f028976f..5e401340c4 100644
--- a/commit.c
+++ b/commit.c
...
index d838ee2e9a..b117bf5105 100644
--- a/diff.c
+++ b/diff.c
...
index 536416ff2d..a4aef1deff 100644
--- a/dir.c
+++ b/dir.c
...
index 30211447ac..3f21d2c913 100644
--- a/entry.c
+++ b/entry.c
...
index 004a9c9f99..f1fdbac81a 100644
--- a/fast-import.c
+++ b/fast-import.c
...
index 032699e9ac..1e3724b0eb 100644
--- a/fsck.c
+++ b/fsck.c
...
index 3d7cd0e96f..b92a336591 100644
--- a/grep.c
+++ b/grep.c
@@ -2010,7 +2010,7 @@ static int grep_source_load_oid(struct grep_source *gs)
 	enum object_type type;
...
index 0913f8ab86..58dd57ffd3 100644
--- a/http-push.c
+++ b/http-push.c
...
index be8f23271b..ea1a6f18e8 100644
--- a/object.c
+++ b/object.c
...
index 28bf0db9d9..64d00e7fd0 100644
--- a/read-cache.c
+++ b/read-cache.c
...
index 62834f7153..07cc454d0f 100644
--- a/ref-filter.c
+++ b/ref-filter.c
...
index bf8a713185..7493bc7f11 100644
--- a/sha1_file.c
+++ b/sha1_file.c
...
index 2aa8a1747f..883e52a005 100644
...
index ea963e406a..0354a0cc7e 100644
--- a/tag.c
+++ b/tag.c

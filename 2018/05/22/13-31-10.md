...
| **Date** | 2018-05-22T15:31:10+02:00 |
| **Message-ID** | [20180522133110.32723-5-alban.gruin@gmail.com](https://lore.kernel.org/git/20180522133110.32723-5-alban.gruin@gmail.com) |

---

**Thread**: [thread](./13-31-06.thread.md#:~:text=2018/05/22/13-31-10)
...
@@ -761,77 +225,13 @@ get_missing_commit_check_level () {
 initiate_action () {
 	case "$1" in
 	continue)
-		if test ! -d "$rewritten"
...
@@ -979,91 +375,3 @@ git_rebase__interactive () {

...
| **Date** | 2018-05-28T14:34:22+02:00 |
| **Message-ID** | [20180528123422.6718-5-alban.gruin@gmail.com](https://lore.kernel.org/git/20180528123422.6718-5-alban.gruin@gmail.com) |

---

**Thread**: [thread](./../22/13-31-06.thread.md#:~:text=2018/05/28/12-34-22)
...
-
 append_todo_help () {
 	gettext "
 Commands:
@@ -184,50 +71,6 @@ If you remove a line here THAT COMMIT WILL BE LOST.
 	fi
 }
...
-
 git_sequence_editor () {
 	...
 	then
@@ -275,455 +94,6 @@ git_sequence_editor () {
...
@@ -761,77 +131,13 @@ get_missing_commit_check_level () {
 initiate_action () {
 	case "$1" in
 	continue)
-		if test ! -d "$rewritten"
...
@@ -979,91 +281,3 @@ git_rebase__interactive () {

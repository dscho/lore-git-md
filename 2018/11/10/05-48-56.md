...
| **Date** | 2018-11-10T06:48:56+01:00 |
| **Message-ID** | [20181110054910.10568-9-pclouds@gmail.com](https://lore.kernel.org/git/20181110054910.10568-9-pclouds@gmail.com) |

---

**Thread**: [thread](./05-48-48.thread.md#:~:text=2018/11/10/05-48-56)
...
@@ -1352,7 +1364,8 @@ static int try_to_commit(struct strbuf *msg, const char *author,
 	return res;
 }
...
+							item->commit,
 							...
 							item->arg_len, opts,
 							res, 0);
@@ -3641,7 +3675,7 @@ static int pick_commits(struct todo_list *todo_list, struct replay_opts *opts)
...
index 660cff5050..ba86515ad6 100644
--- a/sequencer.h
+++ b/sequencer.h
@@ -5,6 +5,7 @@
 #include "strbuf.h"

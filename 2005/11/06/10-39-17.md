# [PATCH]: Add git help command. A good patch this time, I hope

| Header | Value |
|--------|-------|
| **From** | Yaacov Akiba Slama <ya@slamail.org> |
| **To** | Yaacov Akiba Slama <ya@slamail.org> |
| **Date** | 2005-11-06T12:39:17+02:00 |
| **Message-ID** | [11312735573649-git-send-email-ya@slamail.org](https://lore.kernel.org/git/11312735573649-git-send-email-ya@slamail.org) |

---

**Thread**: [thread](./../05/21-43-11.thread.md#:~:text=2005/11/06/10-39-17)

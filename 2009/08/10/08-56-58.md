...
| **Date** | 2009-08-10T10:56:58+02:00 |
| **Message-ID** | [vpqbpmo59np.fsf@bauges.imag.fr](https://lore.kernel.org/git/vpqbpmo59np.fsf@bauges.imag.fr) |

---

**Thread**: [thread](./../06/17-32-13.thread.md#:~:text=2009/08/10/08-56-58)

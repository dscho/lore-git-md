# [PATCH v2 1/5] revert: libify pick

| Header | Value |
|--------|-------|
| **From** | Christian Couder <chriscool@tuxfamily.org> |
| **To** | Junio C Hamano <gitster@pobox.com> |
| **Date** | 2009-08-01T17:46:02+02:00 |
| **Message-ID** | [20090801154607.20922.87382.chriscool@tuxfamily.org](https://lore.kernel.org/git/20090801154607.20922.87382.chriscool@tuxfamily.org) |

---

**Thread**: [thread](./15-46-02.thread.md#:~:text=2009/08/01/15-46-02)
...
index 6b39d56..139a7b7 100644
--- a/Makefile
+++ b/Makefile
@@ -438,6 +438,7 @@ LIB_H += pack-refs.h
...
+LIB_H += pick.h
 ...
 LIB_H += progress.h
 LIB_H += quote.h
@@ -526,6 +527,7 @@ LIB_OBJS += parse-options.o

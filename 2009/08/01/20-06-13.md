# [PATCHv2 1/2] gitweb: add support for XZ compressed snapshots

| Header | Value |
|--------|-------|
| **From** | Mark A Rada <marada@uwaterloo.ca> |
| **To** | git@vger.kernel.org |
| **Date** | 2009-08-01T16:06:13-04:00 |
| **Message-ID** | [F58C96F8-01A3-48F9-B2A1-E4FB3908B399@uwaterloo.ca](https://lore.kernel.org/git/F58C96F8-01A3-48F9-B2A1-E4FB3908B399@uwaterloo.ca) |

---

**Thread**: [thread](./20-06-13.thread.md#:~:text=2009/08/01/20-06-13)

Another go at it....no changes for this commit.
...
Subject: [PATCH 1/2] gitweb: add support for XZ compressed snapshots
...
memory load put on the server to actualy generate a compressed

# [RFC/PATCH v2] git-gui: display summary when showing diff of a submodule

| Header | Value |
|--------|-------|
| **From** | Jens Lehmann <Jens.Lehmann@web.de> |
| **To** | git@vger.kernel.org |
| **Date** | 2009-07-07T17:50:20+02:00 |
| **Message-ID** | [4A536EBC.8080107@web.de](https://lore.kernel.org/git/4A536EBC.8080107@web.de) |

---

**Thread**: [thread](./15-50-20.thread.md#:~:text=2009/07/07/15-50-20)

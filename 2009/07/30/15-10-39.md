# [PATCH] push: add -q option

| Header | Value |
|--------|-------|
| **From** | Michal Marek <mmarek@suse.cz> |
| **To** | git@vger.kernel.org |
| **Date** | 2009-07-30T17:10:39+02:00 |
| **Message-ID** | [1248966639-14393-1-git-send-email-mmarek@suse.cz](https://lore.kernel.org/git/1248966639-14393-1-git-send-email-mmarek@suse.cz) |

---

**Thread**: [thread](./15-10-39.thread.md#:~:text=2009/07/30/15-10-39)

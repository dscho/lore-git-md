...
| **Date** | 2009-07-25T13:51:33-04:00 |
| **Message-ID** | [alpine.LNX.2.00.0907251333370.2147@iabervon.org](https://lore.kernel.org/git/alpine.LNX.2.00.0907251333370.2147@iabervon.org) |

---

**Thread**: [thread](./17-51-33.thread.md#:~:text=2009/07/25/17-51-33)
...
+				if (posn->symref)
+					printf("%s @%s\n", posn->name, posn->symref);
+				else
+					printf("%s %s\n", posn->name, sha1_to_hex(posn->old_sha1));
+			}
+			printf("\n");
+			fflush(stdout);
+		} else {

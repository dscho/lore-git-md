# [PATCH v2 2/2] Teach "-m <msg>" and "-F <file>" to "git notes edit"

| Header | Value |
|--------|-------|
| **From** | Johan Herland <johan@herland.net> |
| **To** | Johannes Schindelin <Johannes.Schindelin@gmx.de>, Junio C Hamano <gitster@pobox.com> |
| **Date** | 2009-04-21T03:26:22+02:00 |
| **Message-ID** | [200904210326.22864.johan@herland.net](https://lore.kernel.org/git/200904210326.22864.johan@herland.net) |

---

**Thread**: [thread](./00-39-21.thread.md#:~:text=2009/04/21/01-26-22)

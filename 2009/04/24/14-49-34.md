# [PATCH 1/2] Documentation: replace sha1 by SHA-1

| Header | Value |
|--------|-------|
| **From** | Michael J Gruber <git@drmicha.warpmail.net> |
| **To** | git@vger.kernel.org |
| **Date** | 2009-04-24T16:49:34+02:00 |
| **Message-ID** | [1240584575-5702-2-git-send-email-git@drmicha.warpmail.net](https://lore.kernel.org/git/1240584575-5702-2-git-send-email-git@drmicha.warpmail.net) |

---

**Thread**: [thread](./14-49-34.thread.md#:~:text=2009/04/24/14-49-34)

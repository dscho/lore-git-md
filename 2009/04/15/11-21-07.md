# [PATCH] git-cvsserver: use non-dashed git commands

| Header | Value |
|--------|-------|
| **From** | Byron Bradley <byronb@picochip.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2009-04-15T12:21:07+01:00 |
| **Message-ID** | [alpine.LRH.2.00.0904151218570.885@dunsop.picochip.com](https://lore.kernel.org/git/alpine.LRH.2.00.0904151218570.885@dunsop.picochip.com) |

---

**Thread**: [thread](./11-21-07.thread.md#:~:text=2009/04/15/11-21-07)

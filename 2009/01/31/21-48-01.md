# [PATCH 4/4] Change current mailmap usage to do matching on both name and email of author/committer.

| Header | Value |
|--------|-------|
| **From** | Marius Storm-Olsen <marius@trolltech.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2009-01-31T22:48:01+01:00 |
| **Message-ID** | [34f625b57597810e4c084fcd3eaf2cfd9def803e.1233438174.git.marius@trolltech.com](https://lore.kernel.org/git/34f625b57597810e4c084fcd3eaf2cfd9def803e.1233438174.git.marius@trolltech.com) |

---

**Thread**: [thread](./21-47-57.thread.md#:~:text=2009/01/31/21-48-01)
...
index 4226683..1cdb03f 100644
--- a/Documentation/git-shortlog.txt
+++ b/Documentation/git-shortlog.txt
@@ -58,27 +58,20 @@ their name and/or email address was spelled differently.
...
-+
 ...
 --
-+
-Which allow mailmap to replace both the name and the email of a commit
-matching the specified commit email address.
-
-+
+which allow mailmap to replace both the name and the email of a commit

...
| **Date** | 2009-01-11T14:28:59+01:00 |
| **Message-ID** | [1231680542-17315-1-git-send-email-barvik@broadpark.no](https://lore.kernel.org/git/1231680542-17315-1-git-send-email-barvik@broadpark.no) |

---

**Thread**: [thread](./13-28-59.thread.md#:~:text=2009/01/11/13-28-59)

Changes since version 5:

- After comments from Ren� Scharfe, the usage of the lstat_stat()
```

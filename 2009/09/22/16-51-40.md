# [PATCH v2] Trivial fix: Make all the usage strings to use the same pattern.

| Header | Value |
|--------|-------|
| **From** | Thiago Farina <tfransosi@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2009-09-22T12:51:40-04:00 |
| **Message-ID** | [1253638300-8666-1-git-send-email-tfransosi@gmail.com](https://lore.kernel.org/git/1253638300-8666-1-git-send-email-tfransosi@gmail.com) |

---

**Thread**: [thread](./16-51-40.thread.md#:~:text=2009/09/22/16-51-40)

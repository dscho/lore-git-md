# [PATCH v3] Trivial fix: Make all the usage strings to use the same pattern.

| Header | Value |
|--------|-------|
| **From** | Thiago Farina <tfransosi@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2009-09-22T13:08:50-04:00 |
| **Message-ID** | [1253639330-9185-1-git-send-email-tfransosi@gmail.com](https://lore.kernel.org/git/1253639330-9185-1-git-send-email-tfransosi@gmail.com) |

---

**Thread**: [thread](./17-08-50.thread.md#:~:text=2009/09/22/17-08-50)

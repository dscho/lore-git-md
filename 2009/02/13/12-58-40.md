...
| **Date** | 2009-02-13T13:58:40+01:00 |
| **Message-ID** | [1234529920-9694-1-git-send-email-trast@student.ethz.ch](https://lore.kernel.org/git/1234529920-9694-1-git-send-email-trast@student.ethz.ch) |

---

**Thread**: [thread](./12-58-40.thread.md#:~:text=2009/02/13/12-58-40)
...
Asked for by dato (Adeodato SimÃ³) on IRC.  The bad interaction with

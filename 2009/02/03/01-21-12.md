# [PATCH] Style cleanup - When declaring pointers the star sides with the variable

| Header | Value |
|--------|-------|
| **From** | Bernt Hansen <bernt@norang.ca> |
| **To** | Junio C. Hamano <junio@pobox.com> |
| **Date** | 2009-02-02T20:21:12-05:00 |
| **Message-ID** | [87pri0co3b.fsf@gollum.intra.norang.ca](https://lore.kernel.org/git/87pri0co3b.fsf@gollum.intra.norang.ca) |

---

**Thread**: [thread](./01-21-12.thread.md#:~:text=2009/02/03/01-21-12)

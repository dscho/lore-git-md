...
| **Date** | 2009-02-28T00:18:00Z |
| **Message-ID** | [87ljrre7nr.fsf@users.sourceforge.net](https://lore.kernel.org/git/87ljrre7nr.fsf@users.sourceforge.net) |

---

**Thread**: [thread](./00-18-00.thread.md#:~:text=2009/02/28/00-18-00)
...
+    wm withdraw $w
     ...
     make_transient $w .
     message $w.m -text [mc "
@@ -2623,14 +2710,18 @@ Copyright Â© 2005-2008 Paul Mackerras

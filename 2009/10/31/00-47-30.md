# [PATCH v5 11/28] Move WebDAV HTTP push under remote-curl

| Header | Value |
|--------|-------|
| **From** | Shawn O. Pearce <spearce@spearce.org> |
| **To** | git@vger.kernel.org |
| **Date** | 2009-10-30T17:47:30-07:00 |
| **Message-ID** | [1256950067-27938-13-git-send-email-spearce@spearce.org](https://lore.kernel.org/git/1256950067-27938-13-git-send-email-spearce@spearce.org) |

---

**Thread**: [thread](./00-47-18.thread.md#:~:text=2009/10/31/00-47-30)

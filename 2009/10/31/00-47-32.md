# [PATCH v5 13/28] Git-aware CGI to provide dumb HTTP transport

| Header | Value |
|--------|-------|
| **From** | Shawn O. Pearce <spearce@spearce.org> |
| **To** | git@vger.kernel.org |
| **Date** | 2009-10-30T17:47:32-07:00 |
| **Message-ID** | [1256950067-27938-15-git-send-email-spearce@spearce.org](https://lore.kernel.org/git/1256950067-27938-15-git-send-email-spearce@spearce.org) |

---

**Thread**: [thread](./00-47-18.thread.md#:~:text=2009/10/31/00-47-32)

# [PATCH v5 14/28] Add stateless RPC options to upload-pack, receive-pack

| Header | Value |
|--------|-------|
| **From** | Shawn O. Pearce <spearce@spearce.org> |
| **To** | git@vger.kernel.org |
| **Date** | 2009-10-30T17:47:33-07:00 |
| **Message-ID** | [1256950067-27938-16-git-send-email-spearce@spearce.org](https://lore.kernel.org/git/1256950067-27938-16-git-send-email-spearce@spearce.org) |

---

**Thread**: [thread](./00-47-18.thread.md#:~:text=2009/10/31/00-47-33)

...
| **To** | normaperson@yhbt.net |
| **Date** | 2009-05-01T15:46:56+04:00 |
| **Message-ID** | [BfKhGHDBpSzjNF/dt4ZDx88u9wI@BjOYljNjUB0FD+/Fw7pzaXMw/Hc](https://lore.kernel.org/git/BfKhGHDBpSzjNF/dt4ZDx88u9wI@BjOYljNjUB0FD+/Fw7pzaXMw/Hc) |

---

**Thread**: [thread](./11-46-56.thread.md#:~:text=2009/05/01/11-46-56)
...
```
 ...
 29 files changed, 222 insertions(+), 206 deletions(-)

```

```diff
diff --git a/t/lib-git-svn.sh b/t/lib-git-svn.sh
index 773d47c..f7b2249 100644
--- a/t/lib-git-svn.sh
+++ b/t/lib-git-svn.sh
@@ -26,6 +26,8 @@ fi

...
| **Date** | 2009-05-30T01:59:50+08:00 |
| **Message-ID** | [20090530015950.02b6125c.rctay89@gmail.com](https://lore.kernel.org/git/20090530015950.02b6125c.rctay89@gmail.com) |

---

**Thread**: [thread](./17-59-50.thread.md#:~:text=2009/05/29/17-59-50)
...
@@ -654,6 +456,7 @@ static int fetch_object(struct walker *walker, struct alt_base *repo, unsigned c
...
@@ -661,6 +464,8 @@ static int fetch_object(struct walker *walker, struct alt_base *repo, unsigned c
...
@@ -672,34 +477,42 @@ static int fetch_object(struct walker *walker, struct alt_base *repo, unsigned c
 	start_object_request(walker, obj_req);
 #endif

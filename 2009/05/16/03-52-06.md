...
| **Date** | 2009-05-16T11:52:06+08:00 |
| **Message-ID** | [20090516115206.6c6a637f.rctay89@gmail.com](https://lore.kernel.org/git/20090516115206.6c6a637f.rctay89@gmail.com) |

---

**Thread**: [thread](./03-52-06.thread.md#:~:text=2009/05/16/03-52-06)
...
@@ -838,7 +658,6 @@ static void add_fetch_request(struct object *obj)
 	request->url = NULL;
 	request->lock = NULL;
...
@@ -877,7 +696,6 @@ static int add_send_request(struct object *obj, struct remote_lock *lock)
 	request->url = NULL;
 	request->lock = lock;
 	request->headers = NULL;
-	request->local_fileno = -1;

...
| **Date** | 2009-05-27T14:15:38-04:00 |
| **Message-ID** | [alpine.LNX.2.00.0905271408050.2147@iabervon.org](https://lore.kernel.org/git/alpine.LNX.2.00.0905271408050.2147@iabervon.org) |

---

**Thread**: [thread](./18-15-38.thread.md#:~:text=2009/05/27/18-15-38)
...
index c935833..a659b0a 100644
--- a/builtin-clone.c
+++ b/builtin-clone.c
@@ -510,8 +510,10 @@ int cmd_clone(int argc, const char **argv, const char *prefix)
 					     option_upload_pack);
...
+	 **/
 	...
 	char *pack_lockfile;
 	signed verbose : 2;
@@ -71,7 +108,7 @@ int transport_push(struct transport *connection,

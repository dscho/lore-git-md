...
| **Date** | 2009-05-27T14:15:53-04:00 |
| **Message-ID** | [alpine.LNX.2.00.0905271406380.2147@iabervon.org](https://lore.kernel.org/git/alpine.LNX.2.00.0905271406380.2147@iabervon.org) |

---

**Thread**: [thread](./18-15-53.thread.md#:~:text=2009/05/27/18-15-53)
...
index e6e926e..103512c 100644
--- a/Makefile
+++ b/Makefile
@@ -344,6 +344,7 @@ PROGRAMS += git-unpack-file$X
...
@@ -1343,12 +1345,16 @@ git.o git.spec \
...
+	$(QUIET_CXX)$(CXX) -o $*.o -c $(ALL_CFLAGS) $<
 ...
 exec_cmd.o: exec_cmd.c GIT-CFLAGS
 	$(QUIET_CC)$(CC) -o $*.o -c $(ALL_CFLAGS) \
@@ -1384,6 +1390,22 @@ git-http-push$X: revision.o http.o http-push.o $(GITLIBS)

...
| **Date** | 2009-11-08T21:36:19+01:00 |
| **Message-ID** | [vpqeio8eou4.fsf@bauges.imag.fr](https://lore.kernel.org/git/vpqeio8eou4.fsf@bauges.imag.fr) |

---

**Thread**: [thread](./20-36-19.thread.md#:~:text=2009/11/08/20-36-19)
...
- [git-bug-output.txt](git-bug-output.txt) (application/octet-stream)

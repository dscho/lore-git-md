# [PATCH v3 2/4] http: try http_proxy env var when http.proxy config option is not set

| Header | Value |
|--------|-------|
| **From** | Nelson Benitez Leon <nelsonjesus.benitez@seap.minhap.es> |
| **To** | git@vger.kernel.org |
| **Date** | 2012-03-05T16:17:48+01:00 |
| **Message-ID** | [4F54D91C.6080905@seap.minhap.es](https://lore.kernel.org/git/4F54D91C.6080905@seap.minhap.es) |

---

**Thread**: [thread](./15-17-48.thread.md#:~:text=2012/03/05/15-17-48)

...
| **To** | stimming@tuhh.de, jk@jk.gs, trast@student.ethz.ch |
| **Date** | 2012-05-30T18:39:41+02:00 |
| **Message-ID** | [1338395981-8094-1-git-send-email-ralf.thielow@googlemail.com](https://lore.kernel.org/git/1338395981-8094-1-git-send-email-ralf.thielow@googlemail.com) |

---

**Thread**: [thread](./16-39-41.thread.md#:~:text=2012/05/30/16-39-41)
...
+msgstr "entfernt <Nummer> vorrangestellte Schrägstriche von herkömmlichen "
+"Differenzpfaden"
+
...
+msgstr "stellt sicher, dass mindestens <Nummer> Zeilen des Kontextes "
+"übereinstimmen"
+

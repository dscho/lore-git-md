...
| **Date** | 2012-09-20T19:26:15+07:00 |
| **Message-ID** | [1348143976-4506-2-git-send-email-pclouds@gmail.com](https://lore.kernel.org/git/1348143976-4506-2-git-send-email-pclouds@gmail.com) |

---

**Thread**: [thread](./../19/11-52-20.thread.md#:~:text=2012/09/20/12-26-15)
...
--- a/log-tree.c
+++ b/log-tree.c
@@ -174,36 +174,47 @@ static void show_children(struct rev_info *opt, struct commit *commit, int abbre
 	}
 }

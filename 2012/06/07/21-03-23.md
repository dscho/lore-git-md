# [PATCH] docs: fix cross-directory linkgit references

| Header | Value |
|--------|-------|
| **From** | Matthieu Moy <Matthieu.Moy@imag.fr> |
| **To** | git@vger.kernel.org, gitster@pobox.com |
| **Date** | 2012-06-07T23:03:23+02:00 |
| **Message-ID** | [1339103003-18447-1-git-send-email-Matthieu.Moy@imag.fr](https://lore.kernel.org/git/1339103003-18447-1-git-send-email-Matthieu.Moy@imag.fr) |

---

**Thread**: [thread](./21-03-23.thread.md#:~:text=2012/06/07/21-03-23)

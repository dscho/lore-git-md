# [PATCHv7 4/4] Write to $XDG_CONFIG_HOME/git/config file

| Header | Value |
|--------|-------|
| **From** | Huynh Khoi Nguyen Nguyen <Huynh-Khoi-Nguyen.Nguyen@ensimag.imag.fr> |
| **To** | git@vger.kernel.org |
| **Date** | 2012-06-12T04:49:56+02:00 |
| **Message-ID** | [1339469396-29677-4-git-send-email-Huynh-Khoi-Nguyen.Nguyen@ensimag.imag.fr](https://lore.kernel.org/git/1339469396-29677-4-git-send-email-Huynh-Khoi-Nguyen.Nguyen@ensimag.imag.fr) |

---

**Thread**: [thread](./../../05/30/21-19-35.thread.md#:~:text=2012/06/12/02-49-56)

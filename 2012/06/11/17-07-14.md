# [RFCv2] l10n: de.po: translate 27 new messages

| Header | Value |
|--------|-------|
| **From** | Ralf Thielow <ralf.thielow@googlemail.com> |
| **To** | trast@student.ethz.ch |
| **Date** | 2012-06-11T19:07:14+02:00 |
| **Message-ID** | [1339434434-2476-1-git-send-email-ralf.thielow@googlemail.com](https://lore.kernel.org/git/1339434434-2476-1-git-send-email-ralf.thielow@googlemail.com) |

---

**Thread**: [thread](./../10/15-11-20.thread.md#:~:text=2012/06/11/17-07-14)

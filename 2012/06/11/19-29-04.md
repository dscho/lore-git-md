# [PATCHv2 1/2] git-remote-mediawiki: import "File:" attachments

| Header | Value |
|--------|-------|
| **From** | Pavel Volek <Pavel.Volek@ensimag.imag.fr> |
| **To** | git@vger.kernel.org |
| **Date** | 2012-06-11T21:29:04+02:00 |
| **Message-ID** | [1339442945-8561-1-git-send-email-Pavel.Volek@ensimag.imag.fr](https://lore.kernel.org/git/1339442945-8561-1-git-send-email-Pavel.Volek@ensimag.imag.fr) |

---

**Thread**: [thread](./19-29-04.thread.md#:~:text=2012/06/11/19-29-04)

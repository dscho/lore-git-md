# [PATCH resend] diff --stat: use less columns for change counts

| Header | Value |
|--------|-------|
| **From** | Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> |
| **To** | git@vger.kernel.org, gitster@pobox.com |
| **Date** | 2012-04-30T22:38:58+02:00 |
| **Message-ID** | [1335818338-3657-1-git-send-email-zbyszek@in.waw.pl](https://lore.kernel.org/git/1335818338-3657-1-git-send-email-zbyszek@in.waw.pl) |

---

**Thread**: [thread](./20-38-58.thread.md#:~:text=2012/04/30/20-38-58)

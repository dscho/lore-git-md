# Re: [RFC/PATCH] git-sh-setup.sh: Add an pwd() function for MinGW

| Header | Value |
|--------|-------|
| **From** | Johannes Sixt <j6t@kdbg.org> |
| **To** | Ramsay Jones <ramsay@ramsay1.demon.co.uk> |
| **Date** | 2012-04-18T20:23:48+02:00 |
| **Message-ID** | [4F8F06B4.5070609@kdbg.org](https://lore.kernel.org/git/4F8F06B4.5070609@kdbg.org) |

---

**Thread**: [thread](./../17/18-48-39.thread.md#:~:text=2012/04/18/18-23-48)

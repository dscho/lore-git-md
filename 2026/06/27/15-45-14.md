# [PATCH v3 1/1] environment: move excludes_file into repo_config_values

| Header | Value |
|--------|-------|
| **From** | Tian Yuchen <cat@malon.dev> |
| **To** | git@vger.kernel.org |
| **Date** | 2026-06-27T23:45:14+08:00 |
| **Message-ID** | [20260627154514.1073154-2-cat@malon.dev](https://lore.kernel.org/git/20260627154514.1073154-2-cat@malon.dev) |

---

**Thread**: [thread](15-45-13.thread.md#:~:text=2026/06/27/15-45-14)

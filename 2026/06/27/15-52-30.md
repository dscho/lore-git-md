# Re: [PATCH v3 0/1] move excludes_file into repo_config_values

| Header | Value |
|--------|-------|
| **From** | Tian Yuchen <cat@malon.dev> |
| **To** | git@vger.kernel.org |
| **Date** | 2026-06-27T23:52:30+08:00 |
| **Message-ID** | [832fee0a-f61d-413a-9562-78eccf8b5eb0@malon.dev](https://lore.kernel.org/git/832fee0a-f61d-413a-9562-78eccf8b5eb0@malon.dev) |

---

**Thread**: [thread](15-45-13.thread.md#:~:text=2026/06/27/15-52-30)

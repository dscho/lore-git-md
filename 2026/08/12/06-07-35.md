# Re: [PATCH v3 2/9] odb/transaction: add transaction finalize interface

| Header | Value |
|--------|-------|
| **From** | Patrick Steinhardt <ps@pks.im> |
| **To** | Justin Tobler <jltobler@gmail.com> |
| **Date** | 2026-08-12T08:07:35+02:00 |
| **Message-ID** | [anwNp8cbCOOuI7nK@pks.im](https://lore.kernel.org/git/anwNp8cbCOOuI7nK@pks.im) |

---

**Thread**: [thread](../06/21-38-53.thread.md#:~:text=2026/08/12/06-07-35)

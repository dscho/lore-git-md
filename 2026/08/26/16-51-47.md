# [PATCH v3] t1401: check symbolic-ref failure and --quiet silence on a non-symbolic ref

| Header | Value |
|--------|-------|
| **From** | Nikolaus Schuetz via GitGitGadget <gitgitgadget@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2026-08-26T16:51:47Z |
| **Message-ID** | [pull.2204.v3.git.1787763107646.gitgitgadget@gmail.com](https://lore.kernel.org/git/pull.2204.v3.git.1787763107646.gitgitgadget@gmail.com) |

---

**Thread**: [thread](../13/21-12-33.thread.md#:~:text=2026/08/26/16-51-47)

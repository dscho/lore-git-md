# [PATCH v8 00/10] commit-reach: terminate merge-base walk when one side is exhausted

| Header | Value |
|--------|-------|
| **From** | Kristofer Karlsson via GitGitGadget <gitgitgadget@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2026-08-11T09:28:42Z |
| **Message-ID** | [pull.2149.v8.git.1786440533.gitgitgadget@gmail.com](https://lore.kernel.org/git/pull.2149.v8.git.1786440533.gitgitgadget@gmail.com) |

---

**Thread**: [thread](../../06/20/10-36-53.thread.md#:~:text=2026/08/11/09-28-42)

# [PATCH v3 3/6] send-pack: generate packfiles via the object database

| Header | Value |
|--------|-------|
| **From** | Patrick Steinhardt <ps@pks.im> |
| **To** | git@vger.kernel.org |
| **Date** | 2026-08-20T09:55:27+02:00 |
| **Message-ID** | [20260820-b4-pks-odb-generate-pack-v3-3-bc42252f6169@pks.im](https://lore.kernel.org/git/20260820-b4-pks-odb-generate-pack-v3-3-bc42252f6169@pks.im) |

---

**Thread**: [thread](../07/10-45-06.thread.md#:~:text=2026/08/20/07-55-27)

# [PATCH v3] add: support pre-add hook

| Header | Value |
|--------|-------|
| **From** | Chandra Kethi-Reddy via GitGitGadget <gitgitgadget@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2026-02-27T05:54:52Z |
| **Message-ID** | [pull.2045.v3.git.1772171692465.gitgitgadget@gmail.com](https://lore.kernel.org/git/pull.2045.v3.git.1772171692465.gitgitgadget@gmail.com) |

---

**Thread**: [thread](./../10/15-32-53.thread.md#:~:text=2026/02/27/05-54-52)

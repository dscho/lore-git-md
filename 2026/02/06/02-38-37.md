...
| **Date** | 2026-02-06T10:38:37+08:00 |
| **Message-ID** | [CANYiYbFM9+4xGmeBRNCC6VyW9EzjEFxEWHDNnOVhJNM73Ga_FA@mail.gmail.com](https://lore.kernel.org/git/CANYiYbFM9+4xGmeBRNCC6VyW9EzjEFxEWHDNnOVhJNM73Ga_FA@mail.gmail.com) |

---

**Thread**: [thread](./../04/09-31-27.thread.md#:~:text=2026/02/06/02-38-37)
...
of the Git repository with only ”po/*.po“ files checked out.
...
code (--pot-file=build) should be the safe and default behavior when
...
the --pot-file=build option explicitly.

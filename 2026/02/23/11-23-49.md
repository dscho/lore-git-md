# [PATCH v2] doc: format config values with backticks

| Header | Value |
|--------|-------|
| **From** | Md Ferdous Alam via GitGitGadget <gitgitgadget@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2026-02-23T11:23:49Z |
| **Message-ID** | [pull.2055.v2.git.1771845829480.gitgitgadget@gmail.com](https://lore.kernel.org/git/pull.2055.v2.git.1771845829480.gitgitgadget@gmail.com) |

---

**Thread**: [thread](./10-55-30.thread.md#:~:text=2026/02/23/11-23-49)

# Re: [PATCH 00/16] repack: incremental MIDX/bitmap-based repacking

| Header | Value |
|--------|-------|
| **From** | Taylor Blau <me@ttaylorr.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2026-04-14T18:38:37-04:00 |
| **Message-ID** | [ad7B7cxKP7tNCXUf@nand.local](https://lore.kernel.org/git/ad7B7cxKP7tNCXUf@nand.local) |

---

**Thread**: [thread](../../03/29/21-40-50.thread.md#:~:text=2026/04/14/22-38-37)

...
| **Date** | 2026-04-08T14:28:54+03:00 |
| **Message-ID** | [874ill3d3d.fsf@gentoo.mail-host-address-is-not-set](https://lore.kernel.org/git/874ill3d3d.fsf@gentoo.mail-host-address-is-not-set) |

---

**Thread**: [thread](../../02/04/16-51-22.thread.md#:~:text=2026/04/08/11-28-54)

On Mon, 06 Apr 2026, SZEDER Gábor <szeder.dev@gmail.com> wrote:

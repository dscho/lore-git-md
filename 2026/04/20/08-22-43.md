...
| **Date** | 2026-04-20T10:22:43+02:00 |
| **Message-ID** | [20260420-pks-setup-wo-the-repository-v1-13-f4a81c4988e8@pks.im](https://lore.kernel.org/git/20260420-pks-setup-wo-the-repository-v1-13-f4a81c4988e8@pks.im) |

---

**Thread**: [thread](08-22-30.thread.md#:~:text=2026/04/20/08-22-43)
...
index 7242a18740..4d4b43ab28 100644
--- a/setup.c
+++ b/setup.c
@@ -2127,9 +2127,9 @@ void check_repository_format(struct repository_format *fmt)

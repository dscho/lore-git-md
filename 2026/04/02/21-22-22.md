# Re: [PATCH v2 1/3] config: add "worktree" and "worktree/i" includeIf conditions

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | Chen Linxuan via B4 Relay <devnull+me.black-desk.cn@kernel.org> |
| **Date** | 2026-04-02T14:22:22-07:00 |
| **Message-ID** | [xmqqv7e9njld.fsf@gitster.g](https://lore.kernel.org/git/xmqqv7e9njld.fsf@gitster.g) |

---

**Thread**: [thread](02-58-44.thread.md#:~:text=2026/04/02/21-22-22)

...
| **Date** | 2026-05-25T13:58:49+03:00 |
| **Message-ID** | [87fr3fsql2.fsf@gentoo.mail-host-address-is-not-set](https://lore.kernel.org/git/87fr3fsql2.fsf@gentoo.mail-host-address-is-not-set) |

---

**Thread**: [thread](../21/16-25-54.thread.md#:~:text=2026/05/25/10-58-49)

# Re: [PATCH v2 1/2] utf8.c: Prepare workaround for iconv under macOS 14/15

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | tboegi@web.de |
| **Date** | 2026-01-11T20:58:45-08:00 |
| **Message-ID** | [xmqqwm1no29m.fsf@gitster.g](https://lore.kernel.org/git/xmqqwm1no29m.fsf@gitster.g) |

---

**Thread**: [thread](./../11/19-51-49.thread.md#:~:text=2026/01/12/04-58-45)

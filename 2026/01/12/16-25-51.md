# [PATCH v3 1/2] utf8.c: Prepare workaround for iconv under macOS 14/15

| Header | Value |
|--------|-------|
| **From** | tboegi@web.de |
| **To** | tboegi@web.de, git@vger.kernel.org, l.s.r@web.de |
| **Date** | 2026-01-12T17:25:51+01:00 |
| **Message-ID** | [20260112162551.774037-1-tboegi@web.de](https://lore.kernel.org/git/20260112162551.774037-1-tboegi@web.de) |

---

**Thread**: [thread](./../11/19-51-49.thread.md#:~:text=2026/01/12/16-25-51)

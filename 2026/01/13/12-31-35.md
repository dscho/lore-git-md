...
| **To** | Chris Darroch <chrisd@apache.org>, brian m. carlson <sandals@crustytoothpaste.net> |
| **Date** | 2026-01-13T14:31:35+02:00 |
| **Message-ID** | [87pl7diti0.fsf@gentoo.mail-host-address-is-not-set](https://lore.kernel.org/git/87pl7diti0.fsf@gentoo.mail-host-address-is-not-set) |

---

**Thread**: [thread](./../12/23-21-42.thread.md#:~:text=2026/01/13/12-31-35)

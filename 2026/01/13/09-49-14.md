...
| **Date** | 2026-01-13T11:49:14+02:00 |
| **Message-ID** | [87y0m1onad.fsf@gentoo.mail-host-address-is-not-set](https://lore.kernel.org/git/87y0m1onad.fsf@gentoo.mail-host-address-is-not-set) |

---

**Thread**: [thread](./../12/23-21-42.thread.md#:~:text=2026/01/13/09-49-14)

# [PATCH v6] lockfile: add PID file for debugging stale locks

| Header | Value |
|--------|-------|
| **From** | Paulo Casaretto via GitGitGadget <gitgitgadget@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2026-01-22T19:23:35Z |
| **Message-ID** | [pull.2011.v6.git.1769109815197.gitgitgadget@gmail.com](https://lore.kernel.org/git/pull.2011.v6.git.1769109815197.gitgitgadget@gmail.com) |

---

**Thread**: [thread](./../../../2025/12/02/15-07-27.thread.md#:~:text=2026/01/22/19-23-35)

# Re: [PATCH v3 3/4] doc: git-reset: clarify `git reset [mode]`

| Header | Value |
|--------|-------|
| **From** | Jean-Noël AVILA <jn.avila@free.fr> |
| **To** | git@vger.kernel.org, D. Ben Knoble <ben.knoble+github@gmail.com> |
| **Date** | 2026-01-02T15:28:09+01:00 |
| **Message-ID** | [1943073.tdWV9SEqCh@piment-oiseau](https://lore.kernel.org/git/1943073.tdWV9SEqCh@piment-oiseau) |

---

**Thread**: [thread](./../../../2025/10/17/20-05-54.thread.md#:~:text=2026/01/02/14-28-09)

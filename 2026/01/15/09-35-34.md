# [PATCH 3/3] commit: rename `free_commit_list()` to conform to coding guidelines

| Header | Value |
|--------|-------|
| **From** | Patrick Steinhardt <ps@pks.im> |
| **To** | git@vger.kernel.org |
| **Date** | 2026-01-15T10:35:34+01:00 |
| **Message-ID** | [20260115-pks-commit-list-coding-guidelines-v1-3-c58868dbf412@pks.im](https://lore.kernel.org/git/20260115-pks-commit-list-coding-guidelines-v1-3-c58868dbf412@pks.im) |

---

**Thread**: [thread](./09-35-31.thread.md#:~:text=2026/01/15/09-35-34)

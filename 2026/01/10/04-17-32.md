# Re: [PATCH v2 2/2] shallow: handling fetch relative-deepen

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | Samo Pogačnik via GitGitGadget <gitgitgadget@gmail.com> |
| **Date** | 2026-01-09T20:17:32-08:00 |
| **Message-ID** | [xmqqsecertib.fsf@gitster.g](https://lore.kernel.org/git/xmqqsecertib.fsf@gitster.g) |

---

**Thread**: [thread](./../../../2025/12/09/18-11-18.thread.md#:~:text=2026/01/10/04-17-32)

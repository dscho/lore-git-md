# [PATCH v8 0/7] Introduce git-history(1) command for easy history editing

| Header | Value |
|--------|-------|
| **From** | Patrick Steinhardt <ps@pks.im> |
| **To** | git@vger.kernel.org |
| **Date** | 2026-01-07T11:10:08+01:00 |
| **Message-ID** | [20260107-b4-pks-history-builtin-v8-0-18e9779e3a26@pks.im](https://lore.kernel.org/git/20260107-b4-pks-history-builtin-v8-0-18e9779e3a26@pks.im) |

---

**Thread**: [thread](./../../../2025/08/19/10-55-56.thread.md#:~:text=2026/01/07/10-10-08)

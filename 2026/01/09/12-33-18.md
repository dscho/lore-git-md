...
| **Date** | 2026-01-09T14:33:18+02:00 |
| **Message-ID** | [87jyxrvucx.fsf@gentoo.mail-host-address-is-not-set](https://lore.kernel.org/git/87jyxrvucx.fsf@gentoo.mail-host-address-is-not-set) |

---

**Thread**: [thread](./01-24-01.thread.md#:~:text=2026/01/09/12-33-18)

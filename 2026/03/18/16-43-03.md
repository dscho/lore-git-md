# Re: [PATCH v2 ] add-patch: use repository instance from add_p_state instead of the_repository

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | Shreyansh Paliwal <shreyanshpaliwalcmsmn@gmail.com> |
| **Date** | 2026-03-18T09:43:03-07:00 |
| **Message-ID** | [xmqqbjglgkbs.fsf@gitster.g](https://lore.kernel.org/git/xmqqbjglgkbs.fsf@gitster.g) |

---

**Thread**: [thread](./../17/15-50-29.thread.md#:~:text=2026/03/18/16-43-03)

# Re: [GSoC v4] Proposal: Complete and extend the remote-object-info command for git cat-file

| Header | Value |
|--------|-------|
| **From** | Pablo <pabloosabaterr@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2026-03-18T12:42:33+01:00 |
| **Message-ID** | [CAN5EUNQWvL7McJg833+pcZOmGyxegPewMpC4472-=V41-uaoJQ@mail.gmail.com](https://lore.kernel.org/git/CAN5EUNQWvL7McJg833+pcZOmGyxegPewMpC4472-=V41-uaoJQ@mail.gmail.com) |

---

**Thread**: [thread](./../13/10-17-25.thread.md#:~:text=2026/03/18/11-42-33)

I've realised that I've sent v3 in reply to v1 instead of v2, here and on some

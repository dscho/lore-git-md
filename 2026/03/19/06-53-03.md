# [PATCH 05/14] object-name: move logic to iterate through packed prefixed objects

| Header | Value |
|--------|-------|
| **From** | Patrick Steinhardt <ps@pks.im> |
| **To** | git@vger.kernel.org |
| **Date** | 2026-03-19T07:53:03+01:00 |
| **Message-ID** | [20260319-b4-pks-odb-source-abbrev-v1-5-5ddebad292b0@pks.im](https://lore.kernel.org/git/20260319-b4-pks-odb-source-abbrev-v1-5-5ddebad292b0@pks.im) |

---

**Thread**: [thread](./06-52-58.thread.md#:~:text=2026/03/19/06-53-03)

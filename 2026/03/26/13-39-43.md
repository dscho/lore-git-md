# [PATCH v2] odb: add write_packfile, for_each_unique_abbrev, convert_object_id

| Header | Value |
|--------|-------|
| **From** | Aaron Paterson via GitGitGadget <gitgitgadget@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2026-03-26T13:39:43Z |
| **Message-ID** | [pull.2074.v2.git.1774532383055.gitgitgadget@gmail.com](https://lore.kernel.org/git/pull.2074.v2.git.1774532383055.gitgitgadget@gmail.com) |

---

**Thread**: [thread](./13-07-17.thread.md#:~:text=2026/03/26/13-39-43)

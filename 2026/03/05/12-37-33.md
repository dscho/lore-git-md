# [PATCH v5] add: support pre-add hook

| Header | Value |
|--------|-------|
| **From** | Chandra Kethi-Reddy via GitGitGadget <gitgitgadget@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2026-03-05T12:37:33Z |
| **Message-ID** | [pull.2045.v5.git.1772714253412.gitgitgadget@gmail.com](https://lore.kernel.org/git/pull.2045.v5.git.1772714253412.gitgitgadget@gmail.com) |

---

**Thread**: [thread](./../../02/10/15-32-53.thread.md#:~:text=2026/03/05/12-37-33)

...
| **Date** | 2013-03-22T22:51:40+01:00 |
| **Message-ID** | [514CD26C.2070702@physik.tu-berlin.de](https://lore.kernel.org/git/514CD26C.2070702@physik.tu-berlin.de) |

---

**Thread**: [thread](./21-51-40.thread.md#:~:text=2013/03/22/21-51-40)
...
-
 ...
 static int format_reflog_person(struct strbuf *sb,
 				char part,
@@ -1182,18 +1125,20 @@ static size_t format_commit_one(struct strbuf *sb, const char *placeholder,
 	}

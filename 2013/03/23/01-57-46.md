...
| **Date** | 2013-03-23T02:57:46+01:00 |
| **Message-ID** | [514D0C1A.5060201@physik.tu-berlin.de](https://lore.kernel.org/git/514D0C1A.5060201@physik.tu-berlin.de) |

---

**Thread**: [thread](./01-57-46.thread.md#:~:text=2013/03/23/01-57-46)
...
--- a/commit.h
+++ b/commit.h
@@ -233,8 +233,8 @@ extern void print_commit_list(struct commit_list *list,

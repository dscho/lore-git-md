...
| **Date** | 2013-07-14T12:14:59+02:00 |
| **Message-ID** | [1373796899-23378-2-git-send-email-stefanbeller@googlemail.com](https://lore.kernel.org/git/1373796899-23378-2-git-send-email-stefanbeller@googlemail.com) |

---

**Thread**: [thread](./10-14-58.thread.md#:~:text=2013/07/14/10-14-59)
...
--- a/.mailmap
+++ b/.mailmap
@@ -17,6 +17,7 @@ Alexey Shumkin <alex.crezoff@gmail.com> <zapped@mail.ru>
...
@@ -24,6 +25,8 @@ Bryan Larsen <bryan@larsen.st> <bryan.larsen@gmail.com>
...
@@ -44,8 +47,11 @@ Florian Achleitner <florian.achleitner.2.6.31@gmail.com> <florian.achleitner2.6.
...
@@ -62,6 +68,7 @@ Jason Riedy <ejr@eecs.berkeley.edu> <ejr@cs.berkeley.edu>
...
@@ -95,6 +102,7 @@ Kirill Smelkov <kirr@navytux.spb.ru> <kirr@mns.spb.ru>
...
@@ -112,6 +120,7 @@ Martin Langhoff <martin@laptop.org> <martin@catalyst.net.nz>
...
@@ -120,6 +129,7 @@ Michael J Gruber <git@drmicha.warpmail.net> <michaeljgruber+gmane@fastmail.fm>
...
@@ -149,17 +164,24 @@ Ralf Thielow <ralf.thielow@gmail.com> <ralf.thielow@googlemail.com>
...
@@ -170,19 +192,25 @@ Thomas Rast <trast@inf.ethz.ch> <trast@student.ethz.ch>

...
| **Date** | 2013-07-03T00:39:49+02:00 |
| **Message-ID** | [1372804789-12732-8-git-send-email-benoit.person@ensimag.fr](https://lore.kernel.org/git/1372804789-12732-8-git-send-email-benoit.person@ensimag.fr) |

---

**Thread**: [thread](./22-39-49.thread.md#:~:text=2013/07/02/22-39-49)
...
+
 ...
 sub help {
@@ -55,6 +362,7 @@ usage: git mw <command> <args>

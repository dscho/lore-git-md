...
| **Date** | 2013-10-25T02:04:19-04:00 |
| **Message-ID** | [20131025060418.GK23098@sigill.intra.peff.net](https://lore.kernel.org/git/20131025060418.GK23098@sigill.intra.peff.net) |

---

**Thread**: [thread](./../24/17-59-15.thread.md#:~:text=2013/10/25/06-04-19)
...
index 73c52fd..0044ecc 100644
--- a/pack-bitmap.c
+++ b/pack-bitmap.c
@@ -963,3 +963,95 @@ void test_bitmap_walk(struct rev_info *revs)
 	else
...
+#include "pack-objects.h"
 ...
 struct bitmap_disk_entry {
 	uint32_t object_pos;
@@ -23,10 +24,16 @@ struct bitmap_disk_header {
...
@@ -42,5 +49,16 @@ void test_bitmap_walk(struct rev_info *revs);
...
+	 struct pack_idx_entry **index, uint32_t index_nr, const char *filename);

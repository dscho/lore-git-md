...
| **Date** | 2013-12-02T10:55:53-08:00 |
| **Message-ID** | [xmqqwqjnqdza.fsf@gitster.dls.corp.google.com](https://lore.kernel.org/git/xmqqwqjnqdza.fsf@gitster.dls.corp.google.com) |

---

**Thread**: [thread](./18-55-53.thread.md#:~:text=2013/12/02/18-55-53)

The latest feature release Git v1.8.5 is now available at the
usual places.  This was actually tagged a few days ago, but I forgot
to send this release notes.
...
56e4e3c59b0bd2996b81bb1de4283c9f427bd1a8  git-1.8.5.tar.gz
3901432173bcc3892a7be8ea2637a7d763015013  git-htmldocs-1.8.5.tar.gz
880864f95e3548e1f86066653aed3311caea89a4  git-manpages-1.8.5.tar.gz

The following public repositories all have a copy of the v1.8.5
...
Note that I haven't started post 1.8.5 integration cycle and the
'next' branch has not been rewound yet.  I'll be reading over the
"What's cooking" report in the coming few days to see which topics
need to be kicked back to 'pu'.  I know there is at least one topic
that was reverted during the last cycle, but there may be others
that are better replaced with rerolls that have already been posted.
...
Changes since v1.8.5-rc3 are as follows:

...
| **Date** | 2013-05-17T17:15:20-07:00 |
| **Message-ID** | [7vobc9w3c7.fsf@alter.siamese.dyndns.org](https://lore.kernel.org/git/7vobc9w3c7.fsf@alter.siamese.dyndns.org) |

---

**Thread**: [thread](./00-15-20.thread.md#:~:text=2013/05/18/00-15-20)
...
will be delaying the final release by a week.  This is hopefully the
last release candidate.  Knock wood...
...
35c28b1c4a2bdb7ff9a0846d0ca622b216f7d2e9  git-1.8.3.rc3.tar.gz
073c605a3536ed002f3cde7f2591adc4aec7b62e  git-htmldocs-1.8.3.rc3.tar.gz
2abcdaa1e0c116b657bbf299a60c130d57b5658e  git-manpages-1.8.3.rc3.tar.gz

Also the following public repositories all have a copy of the v1.8.3-rc3
...
There also are the tarballs at

    http://www.kernel.org/pub/software/scm/git/testing/

Note that k.org recompresses them to .gz, .bz2 and .xz and what you
download from there would not match what I upload to code.google.com
byte-for-byte.
...
Changes since v1.8.3-rc2 are as follows:

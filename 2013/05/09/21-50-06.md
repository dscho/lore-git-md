...
| **Date** | 2013-05-09T14:50:06-07:00 |
| **Message-ID** | [7v8v3n9629.fsf@alter.siamese.dyndns.org](https://lore.kernel.org/git/7v8v3n9629.fsf@alter.siamese.dyndns.org) |

---

**Thread**: [thread](./21-50-06.thread.md#:~:text=2013/05/09/21-50-06)
...
was found and had to be fixed today.  No new patches, other than
final subsystem updates and regression fixes meant for 1.8.3, will
be queued until the final release.

...
| **Date** | 2013-05-17T17:20:14+08:00 |
| **Message-ID** | [94a88daede2287b31e8460761f23594a7013a894.1368782129.git.worldhello.net@gmail.com](https://lore.kernel.org/git/94a88daede2287b31e8460761f23594a7013a894.1368782129.git.worldhello.net@gmail.com) |

---

**Thread**: [thread](./09-20-04.thread.md#:~:text=2013/05/17/09-20-14)
...
+			if ((*chosen)[i] < 0)
+				(*chosen)[i] = 0;
+			strbuf_addf(&menu, "%s%2d: %s", (*chosen)[i] ? "*" : " ", i+1, string_list_item->string);
+			string_list_append(&menu_list, menu.buf);
+			strbuf_reset(&menu);
+			i++;
+		}

...
| **Date** | 2013-06-14T15:50:30+02:00 |
| **Message-ID** | [1371217839-23017-23-git-send-email-celestin.matte@ensimag.fr](https://lore.kernel.org/git/1371217839-23017-23-git-send-email-celestin.matte@ensimag.fr) |

---

**Thread**: [thread](./13-50-30.thread.md#:~:text=2013/06/14/13-50-30)
...
---
```
 contrib/mw-to-git/git-remote-mediawiki.perl | 239 ++++++++++++++--------------
...
@@ -81,13 +81,13 @@ $shallow_import = ($shallow_import eq "true");
 # Possible values:
...
@@ -107,12 +107,12 @@ my %basetimestamps;
...
+$dumb_push = ($dumb_push eq 'true');
 ...
 my $wiki_name = $url;
 $wiki_name =~ s{[^/]*://}{};
@@ -141,22 +141,22 @@ sub parse_command {
 	if (!defined $cmd[0]) {
 		return 0;
 	}
...
@@ -173,7 +173,7 @@ sub mw_connect_maybe {
 		return;
 	}
...
@@ -245,7 +245,7 @@ sub get_mw_tracked_categories {

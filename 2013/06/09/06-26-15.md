...
| **Date** | 2013-06-09T13:26:15+07:00 |
| **Message-ID** | [1370759178-1709-43-git-send-email-pclouds@gmail.com](https://lore.kernel.org/git/1370759178-1709-43-git-send-email-pclouds@gmail.com) |

---

**Thread**: [thread](./06-25-33.thread.md#:~:text=2013/06/09/06-26-15)
...
+		       PATHSPEC_LITERAL);
 	...
 	if (!ps->nr) {
 		if (!ps->recursive ||
@@ -1290,7 +1296,10 @@ int read_directory(struct dir_struct *dir, const char *path, int len, const stru

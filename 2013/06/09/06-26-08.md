...
| **Date** | 2013-06-09T13:26:08+07:00 |
| **Message-ID** | [1370759178-1709-36-git-send-email-pclouds@gmail.com](https://lore.kernel.org/git/1370759178-1709-36-git-send-email-pclouds@gmail.com) |

---

**Thread**: [thread](./06-25-33.thread.md#:~:text=2013/06/09/06-26-08)
...
--- a/revision.c
+++ b/revision.c
@@ -1905,12 +1905,13 @@ int setup_revisions(int argc, const char **argv, struct rev_info *revs, struct s
 		revs->limited = 1;

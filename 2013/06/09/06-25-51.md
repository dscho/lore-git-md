...
| **Date** | 2013-06-09T13:25:51+07:00 |
| **Message-ID** | [1370759178-1709-19-git-send-email-pclouds@gmail.com](https://lore.kernel.org/git/1370759178-1709-19-git-send-email-pclouds@gmail.com) |

---

**Thread**: [thread](./06-25-33.thread.md#:~:text=2013/06/09/06-25-51)
...
@@ -994,7 +992,7 @@ static int switch_unborn_to_new_branch(const struct checkout_opts *opts)
...
+	if (opts->pathspec.nr)
 	...
 	if (opts->patch_mode)
@@ -1146,9 +1144,19 @@ int cmd_checkout(int argc, const char **argv, const char *prefix)
 	}
...
+		if (!opts.pathspec.nr)
 		...
 		/*
@@ -1180,7 +1188,7 @@ int cmd_checkout(int argc, const char **argv, const char *prefix)
 		strbuf_release(&buf);
 	}

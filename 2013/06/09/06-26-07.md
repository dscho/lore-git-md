...
| **Date** | 2013-06-09T13:26:07+07:00 |
| **Message-ID** | [1370759178-1709-35-git-send-email-pclouds@gmail.com](https://lore.kernel.org/git/1370759178-1709-35-git-send-email-pclouds@gmail.com) |

---

**Thread**: [thread](./06-25-33.thread.md#:~:text=2013/06/09/06-26-07)
...
--- a/builtin/commit.c
+++ b/builtin/commit.c
@@ -194,7 +194,7 @@ static int list_paths(struct string_list *list, const char *with_tree,
...
@@ -544,7 +544,7 @@ int cmd_ls_files(int argc, const char **argv, const char *cmd_prefix)
 		       prefix, argv);

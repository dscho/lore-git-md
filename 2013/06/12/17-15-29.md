# [PATCH 1/3] l10n: de.po: switch from pure German to German+English (part 1)

| Header | Value |
|--------|-------|
| **From** | Ralf Thielow <ralf.thielow@gmail.com> |
| **To** | trast@student.ethz.ch, jk@jk.gs, stimming@tuhh.de |
| **Date** | 2013-06-12T19:15:29+02:00 |
| **Message-ID** | [1371057331-3917-2-git-send-email-ralf.thielow@gmail.com](https://lore.kernel.org/git/1371057331-3917-2-git-send-email-ralf.thielow@gmail.com) |

---

**Thread**: [thread](./17-15-28.thread.md#:~:text=2013/06/12/17-15-29)
...
+msgstr "ignoriert Änderungen in Whitespaces bei der Suche des Kontextes"
...
@@ -2343,7 +2344,7 @@ msgstr "toleriert fehlerhaft erkannten fehlenden Zeilenumbruch am Dateiende"
...
+msgstr "vertraut nicht den Zeilennummern im Kopf des Patch-Blocks"
 ...
 msgid "root"
@@ -2356,18 +2357,18 @@ msgstr "stellt <Wurzelverzeichnis> vor alle Dateinamen"
...
@@ -2379,15 +2380,15 @@ msgstr "kann Patch '%s' nicht öffnen"
 #, c-format
...
+msgstr[1] "%d Zeilen fügen Whitespace-Fehler hinzu."
 ...
 #, c-format
@@ -2434,7 +2435,7 @@ msgstr "führt 'git bisect next' aus"
...
@@ -2450,11 +2451,11 @@ msgstr "Zeigt \"blame\"-Einträge schrittweise, während wir sie generieren"
...
@@ -2479,7 +2480,7 @@ msgstr "Anzeige in einem Format für maschinelle Auswertung"
...
@@ -2491,7 +2492,7 @@ msgstr "Zeigt unbearbeiteten Zeitstempel (Standard: aus)"
...
@@ -2503,7 +2504,7 @@ msgstr "Zeigt anstatt des Namens die Email-Adresse des Autors (Standard: aus)"
...
@@ -2543,15 +2544,15 @@ msgstr "git branch [Optionen] [-r | -a] [--merged | --no-merged]"
...
+msgstr "Branch '%s' zeigt auf keinen Commit"
 ...
 #, c-format
@@ -2677,12 +2678,12 @@ msgstr " **** ungültige Referenz ****"
...
+msgstr "(kein Branch, Rebase begonnen bei %s)"
 ...
 #, c-format
@@ -2691,12 +2692,12 @@ msgstr "(losgelöst von %s)"
...
@@ -2760,7 +2761,7 @@ msgstr "stellt den Übernahmemodus ein (siehe git-pull(1))"
...
@@ -2786,60 +2787,60 @@ msgstr "spezifische Aktionen für \"git-branch\":"
...
@@ -2847,68 +2848,68 @@ msgstr "Die Optionen --column und --verbose sind inkompatibel."
...
@@ -3062,7 +3063,7 @@ msgstr "git checkout-index [Optionen] [--] [<Datei>...]"
...
@@ -3072,7 +3073,7 @@ msgstr "erzwingt das Überschreiben bereits existierender Dateien"
...
+msgstr "git checkout [Optionen] [<Branch>] -- <Datei>..."
 ...
 #, c-format
@@ -3139,7 +3140,7 @@ msgstr "Pfad '%s': kann nicht zusammenführen"
...
@@ -3155,11 +3156,11 @@ msgstr "'%s' kann nicht mit '%s' verwendet werden"
...
+msgstr "beschädigte Staging-Area-Datei"
 ...
 #, c-format
@@ -3168,7 +3169,7 @@ msgstr "Pfad '%s' ist nicht zusammengeführt."
...
+msgstr "Sie müssen zuerst Ihre aktuelle Staging-Area auflösen."
 ...
 #, c-format
@@ -3177,12 +3178,12 @@ msgstr "Konnte \"reflog\" für '%s' nicht durchführen\n"
...
@@ -3270,16 +3271,16 @@ msgstr "Ungültige Referenz: %s"
...
@@ -3290,40 +3291,40 @@ msgstr "'%s' kann nicht mit '%s' verwendet werden"

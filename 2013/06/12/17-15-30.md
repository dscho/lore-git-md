# [PATCH 2/3] l10n: de.po: switch from pure German to German+English (part 2)

| Header | Value |
|--------|-------|
| **From** | Ralf Thielow <ralf.thielow@gmail.com> |
| **To** | trast@student.ethz.ch, jk@jk.gs, stimming@tuhh.de |
| **Date** | 2013-06-12T19:15:30+02:00 |
| **Message-ID** | [1371057331-3917-3-git-send-email-ralf.thielow@gmail.com](https://lore.kernel.org/git/1371057331-3917-3-git-send-email-ralf.thielow@gmail.com) |

---

**Thread**: [thread](./17-15-28.thread.md#:~:text=2013/06/12/17-15-30)
...
@@ -3634,12 +3634,12 @@ msgstr "Fernarchiv hat nicht alle erforderlichen Objekte gesendet."
 #: builtin/clone.c:610

...
| **Date** | 2013-06-12T17:43:43+02:00 |
| **Message-ID** | [1371051828-12866-27-git-send-email-celestin.matte@ensimag.fr](https://lore.kernel.org/git/1371051828-12866-27-git-send-email-celestin.matte@ensimag.fr) |

---

**Thread**: [thread](./15-43-17.thread.md#:~:text=2013/06/12/15-43-43)
...
@@ -223,13 +233,13 @@ sub get_mw_page_list {
 	my $pages = shift;

...
| **Date** | 2021-07-20T17:04:40Z |
| **Message-ID** | [d1d4b2f9e9b59e208bb36bd6050f10884c8be6a1.1626800687.git.gitgitgadget@gmail.com](https://lore.kernel.org/git/d1d4b2f9e9b59e208bb36bd6050f10884c8be6a1.1626800687.git.gitgitgadget@gmail.com) |

---

**Thread**: [thread](./17-04-20.thread.md#:~:text=2021/07/20/17-04-40)
...
```
 ...
 repository.h                                  |    3 +
 setup.c                                       |    6 +
 t/t0031-reftable.sh                           |  291 +++
 t/t1409-avoid-packing-refs.sh                 |    6 +
 t/t1450-fsck.sh                               |    6 +
 t/t3210-pack-refs.sh                          |    6 +
 t/test-lib.sh                                 |    7 +-
 22 files changed, 2129 insertions(+), 28 deletions(-)
...
index c18042929c8..19566c661f1 100644
--- a/Makefile
+++ b/Makefile
@@ -986,6 +986,7 @@ LIB_OBJS += reflog-walk.o
 LIB_OBJS += refs.o
...
index 976bf8ed063..9601ccd5909 100644
...
index ba04ff8bd36..f4472afb3fc 100644
--- a/cache.h
+++ b/cache.h
@@ -647,9 +647,10 @@ int path_inside_repo(const char *prefix, const char *path);
...
+				   const char *ref_storage_format);
 ...
 int daemonize(void);
@@ -1067,6 +1068,7 @@ struct repository_format {
 	int hash_algo;
 	int sparse_index;
 	char *work_tree;
+	char *ref_storage;
...
index 69413fb3dc0..a2b156e338e 100644
--- a/config.mak.uname
+++ b/config.mak.uname
@@ -711,7 +711,7 @@ vcxproj:
...
index eb9367ca5cb..72d27477560 100644
--- a/setup.c
+++ b/setup.c
...
index 9e268605449..c9b06f931b4 100644
--- a/t/test-lib.sh
+++ b/t/test-lib.sh
@@ -1509,7 +1509,12 @@ parisc* | hppa*)
 	;;
 esac

# [PATCH v4 1/3] vimdiff: new implementation with layout support

| Header | Value |
|--------|-------|
| **From** | Fernando Ramos <greenfoo@u92.eu> |
| **To** | git@vger.kernel.org |
| **Date** | 2021-12-04T10:03:49+01:00 |
| **Message-ID** | [20211204090351.42369-2-greenfoo@u92.eu](https://lore.kernel.org/git/20211204090351.42369-2-greenfoo@u92.eu) |

---

**Thread**: [thread](./09-03-48.thread.md#:~:text=2021/12/04/09-03-49)

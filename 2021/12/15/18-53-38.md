# Re: 'Re: What's cooking in git.git (Dec 2021, #03; Fri, 10)'

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | Teng Long <dyroneteng@gmail.com> |
| **Date** | 2021-12-15T10:53:38-08:00 |
| **Message-ID** | [xmqqilvp7l8t.fsf@gitster.g](https://lore.kernel.org/git/xmqqilvp7l8t.fsf@gitster.g) |

---

**Thread**: [thread](./../11/02-52-37.thread.md#:~:text=2021/12/15/18-53-38)

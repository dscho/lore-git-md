# [PATCH v6 6/9] ssh signing: make git log verify key lifetime

| Header | Value |
|--------|-------|
| **From** | Fabian Stelzer <fs@gigacodes.de> |
| **To** | git@vger.kernel.org |
| **Date** | 2021-12-09T09:52:46+01:00 |
| **Message-ID** | [20211209085249.13587-7-fs@gigacodes.de](https://lore.kernel.org/git/20211209085249.13587-7-fs@gigacodes.de) |

---

**Thread**: [thread](./../../10/27/08-06-10.thread.md#:~:text=2021/12/09/08-52-46)

# [PATCH v5.1 7/8] ssh signing: make fmt-merge-msg consider key lifetime

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2021-12-08T15:43:12-08:00 |
| **Message-ID** | [20211208234313.3052303-8-gitster@pobox.com](https://lore.kernel.org/git/20211208234313.3052303-8-gitster@pobox.com) |

---

**Thread**: [thread](./23-43-05.thread.md#:~:text=2021/12/08/23-43-12)
...
@@ -138,6 +158,44 @@ test_expect_success GPGSSH 'message for merging local tag signed by unknown ssh

# [PATCH v5 6/8] ssh signing: make fmt-merge-msg consider key lifetime

| Header | Value |
|--------|-------|
| **From** | Fabian Stelzer <fs@gigacodes.de> |
| **To** | git@vger.kernel.org |
| **Date** | 2021-12-08T17:33:33+01:00 |
| **Message-ID** | [20211208163335.1231795-7-fs@gigacodes.de](https://lore.kernel.org/git/20211208163335.1231795-7-fs@gigacodes.de) |

---

**Thread**: [thread](./../../10/27/08-06-10.thread.md#:~:text=2021/12/08/16-33-33)

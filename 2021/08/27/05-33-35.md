# Re: [PATCH v4 18/28] reftable: implement stack, a mutable database of reftable files.

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | Han-Wen Nienhuys <hanwen@google.com> |
| **Date** | 2021-08-26T22:33:35-07:00 |
| **Message-ID** | [xmqqwno7bgeo.fsf@gitster.g](https://lore.kernel.org/git/xmqqwno7bgeo.fsf@gitster.g) |

---

**Thread**: [thread](./../../07/20/17-04-20.thread.md#:~:text=2021/08/27/05-33-35)

...
| **Date** | 2021-08-19T13:39:41+08:00 |
| **Message-ID** | [CAOLTT8SxHuH2EbiSwQX6pyJJs5KyVuKx6ZOPxpzWLH+Tbz5F+A@mail.gmail.com](https://lore.kernel.org/git/CAOLTT8SxHuH2EbiSwQX6pyJJs5KyVuKx6ZOPxpzWLH+Tbz5F+A@mail.gmail.com) |

---

**Thread**: [thread](./05-39-41.thread.md#:~:text=2021/08/19/05-39-41)
...
[link](https://github.com/gitgitgadget/git/pulls?q=adlternative+closed%3A%3C2021-05-18+label%3Amaster).
...
you can view them here:
[link](https://github.com/gitgitgadget/git/pulls?q=adlternative+closed%3A%3E%3D2021-05-18+label%3Amaster+).
...
[link](https://github.com/adlternative/git/commits/cat-file-reuse-ref-filter-logic)
...
and atom attribute(e.g. `%(objectname:short=1)`).
...
--batch-all-objects
    Time (mean ± σ):     596.2 ms ±   5.7 ms    [User: 563.0 ms,
System: 32.5 ms]
```
...
--batch-all-objects
    Time (mean ± σ):     601.3 ms ±   5.8 ms    [User: 566.9 ms,
System: 33.9 ms]
```
...
```
  After participating in GSOC this time, I realized that open source is actually

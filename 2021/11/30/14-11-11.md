# [PATCH v4 6/7] ssh signing: make fmt-merge-msg consider key lifetime

| Header | Value |
|--------|-------|
| **From** | Fabian Stelzer <fs@gigacodes.de> |
| **To** | git@vger.kernel.org |
| **Date** | 2021-11-30T15:11:11+01:00 |
| **Message-ID** | [20211130141112.78193-7-fs@gigacodes.de](https://lore.kernel.org/git/20211130141112.78193-7-fs@gigacodes.de) |

---

**Thread**: [thread](./../../10/27/08-06-10.thread.md#:~:text=2021/11/30/14-11-11)

# Re: [ANNOUNCE] Git for Windows 2.34.0

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | Johannes Schindelin <johannes.schindelin@gmx.de> |
| **Date** | 2021-11-15T13:32:27-08:00 |
| **Message-ID** | [xmqqo86lcdg4.fsf@gitster.g](https://lore.kernel.org/git/xmqqo86lcdg4.fsf@gitster.g) |

---

**Thread**: [thread](./21-32-27.thread.md#:~:text=2021/11/15/21-32-27)

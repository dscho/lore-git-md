# Re: [bug] git svn fetch: defect history - missing merges and wrong tag ancestors - third-party tool found

| Header | Value |
|--------|-------|
| **From** | M. Buecher <maddes+git@maddes.net> |
| **To** | git@vger.kernel.org |
| **Date** | 2021-02-07T21:24:31+01:00 |
| **Message-ID** | [483432d14bc272cf362fd8b722a09ede@mailbox.org](https://lore.kernel.org/git/483432d14bc272cf362fd8b722a09ede@mailbox.org) |

---

**Thread**: [thread](./../../../2020/12/25/22-24-21.thread.md#:~:text=2021/02/07/20-24-31)

# [PATCH v3] Make ident dynamic, not just a hardcoded value of "$Id".

| Header | Value |
|--------|-------|
| **From** | Maksym Sobolyev via GitGitGadget <gitgitgadget@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2021-09-01T02:13:05Z |
| **Message-ID** | [pull.1074.v3.git.git.1630462385587.gitgitgadget@gmail.com](https://lore.kernel.org/git/pull.1074.v3.git.git.1630462385587.gitgitgadget@gmail.com) |

---

**Thread**: [thread](./../../08/23/16-41-58.thread.md#:~:text=2021/09/01/02-13-05)

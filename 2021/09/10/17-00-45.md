# Re: [PATCH v2 6/8] http: correct curl version check for CURLOPT_PINNEDPUBLICKEY

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | Ævar Arnfjörð Bjarmason <avarab@gmail.com> |
| **Date** | 2021-09-10T10:00:45-07:00 |
| **Message-ID** | [xmqqfsuctlfm.fsf@gitster.g](https://lore.kernel.org/git/xmqqfsuctlfm.fsf@gitster.g) |

---

**Thread**: [thread](./../../../2017/08/09/12-00-25.thread.md#:~:text=2021/09/10/17-00-45)

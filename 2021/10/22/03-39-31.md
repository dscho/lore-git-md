# Re: [PATCH v3 09/10] various *.c: use isatty(1|2), not isatty(STDIN_FILENO|STDERR_FILENO)

| Header | Value |
|--------|-------|
| **From** | Emily Shaffer <emilyshaffer@google.com> |
| **To** | Ævar Arnfjörð Bjarmason <avarab@gmail.com> |
| **Date** | 2021-10-21T20:39:31-07:00 |
| **Message-ID** | [YXIyc7+ipDVxj7Ff@google.com](https://lore.kernel.org/git/YXIyc7+ipDVxj7Ff@google.com) |

---

**Thread**: [thread](./../../06/20/20-02-56.thread.md#:~:text=2021/10/22/03-39-31)

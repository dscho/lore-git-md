# [PATCH v2] stash: implement '--staged' option for 'push' and 'save'

| Header | Value |
|--------|-------|
| **From** | Sergey Organov <sorganov@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2021-10-15T18:04:13+03:00 |
| **Message-ID** | [87fst2gwia.fsf_-_@osv.gnss.ru](https://lore.kernel.org/git/87fst2gwia.fsf_-_@osv.gnss.ru) |

---

**Thread**: [thread](./../01/22-12-14.thread.md#:~:text=2021/10/15/15-04-13)

# [PATCH RFC v1] stash: implement '--staged' option for 'push' and 'save'

| Header | Value |
|--------|-------|
| **From** | Sergey Organov <sorganov@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2021-10-11T23:16:11+03:00 |
| **Message-ID** | [87lf2zz59w.fsf@osv.gnss.ru](https://lore.kernel.org/git/87lf2zz59w.fsf@osv.gnss.ru) |

---

**Thread**: [thread](./../01/22-12-14.thread.md#:~:text=2021/10/11/20-16-11)

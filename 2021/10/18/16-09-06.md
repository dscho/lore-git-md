# [PATCH v3] stash: implement '--staged' option for 'push' and 'save'

| Header | Value |
|--------|-------|
| **From** | Sergey Organov <sorganov@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2021-10-18T19:09:06+03:00 |
| **Message-ID** | [87pms2mi1p.fsf_-_@osv.gnss.ru](https://lore.kernel.org/git/87pms2mi1p.fsf_-_@osv.gnss.ru) |

---

**Thread**: [thread](./../01/22-12-14.thread.md#:~:text=2021/10/18/16-09-06)

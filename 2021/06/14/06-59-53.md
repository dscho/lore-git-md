# Re: still using `git pack-redundant` - alternatives?

| Header | Value |
|--------|-------|
| **From** | Jeff King <peff@peff.net> |
| **To** | Mathijs Kwik <mathijs@bluescreen303.nl> |
| **Date** | 2021-06-14T02:59:53-04:00 |
| **Message-ID** | [YMb+aXglvXel3Caa@coredump.intra.peff.net](https://lore.kernel.org/git/YMb+aXglvXel3Caa@coredump.intra.peff.net) |

---

**Thread**: [thread](./../11/11-10-58.thread.md#:~:text=2021/06/14/06-59-53)

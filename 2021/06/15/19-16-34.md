# Re: [PATCH v2] test: fix for TEST_OUTPUT_DIRECTORY

| Header | Value |
|--------|-------|
| **From** | Ævar Arnfjörð Bjarmason <avarab@gmail.com> |
| **To** | Felipe Contreras <felipe.contreras@gmail.com> |
| **Date** | 2021-06-15T21:16:34+02:00 |
| **Message-ID** | [87y2bbx7cq.fsf@evledraar.gmail.com](https://lore.kernel.org/git/87y2bbx7cq.fsf@evledraar.gmail.com) |

---

**Thread**: [thread](./18-31-57.thread.md#:~:text=2021/06/15/19-16-34)

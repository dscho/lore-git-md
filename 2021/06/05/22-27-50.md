# RE: [Patch 1/3] connect.c: add nonstopssh variant to the sshVariant set. (correction)

| Header | Value |
|--------|-------|
| **From** | Randall S. Becker <rsbecker@nexbridge.com> |
| **To** | 'Junio C Hamano' <gitster@pobox.com> |
| **Date** | 2021-06-05T18:27:50-04:00 |
| **Message-ID** | [011c01d75a5a$0874d570$195e8050$@nexbridge.com](https://lore.kernel.org/git/011c01d75a5a$0874d570$195e8050$@nexbridge.com) |

---

**Thread**: [thread](./22-27-50.thread.md#:~:text=2021/06/05/22-27-50)

# Re: [Bug] 'git submodule update --single-branch' still fetching master

| Header | Value |
|--------|-------|
| **From** | - - <sven@nichtgerade.de> |
| **To** | Philippe Blain <levraiphilippeblain@gmail.com>, git@vger.kernel.org <git@vger.kernel.org> |
| **Date** | 2021-01-08T15:27:12+01:00 |
| **Message-ID** | [1441960943.306435.1610116032985@email.ionos.de](https://lore.kernel.org/git/1441960943.306435.1610116032985@email.ionos.de) |

---

**Thread**: [thread](./../06/00-19-07.thread.md#:~:text=2021/01/08/14-27-12)

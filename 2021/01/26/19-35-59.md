# Re: [PATCH] grep/log: remove hidden --debug and --grep-debug options

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | Ævar Arnfjörð Bjarmason <avarab@gmail.com> |
| **Date** | 2021-01-26T11:35:59-08:00 |
| **Message-ID** | [xmqqv9bj1of4.fsf@gitster.c.googlers.com](https://lore.kernel.org/git/xmqqv9bj1of4.fsf@gitster.c.googlers.com) |

---

**Thread**: [thread](./../25/23-36-51.thread.md#:~:text=2021/01/26/19-35-59)

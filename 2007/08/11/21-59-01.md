# [PATCH] git-add: Add support for --refresh option.

| Header | Value |
|--------|-------|
| **From** | Alexandre Julliard <julliard@winehq.org> |
| **To** | git@vger.kernel.org |
| **Date** | 2007-08-11T23:59:01+02:00 |
| **Message-ID** | [874pj5wx5m.fsf@wine.dyndns.org](https://lore.kernel.org/git/874pj5wx5m.fsf@wine.dyndns.org) |

---

**Thread**: [thread](./21-59-01.thread.md#:~:text=2007/08/11/21-59-01)

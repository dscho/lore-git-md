# [PATCH] git-add: Add a --refresh option.

| Header | Value |
|--------|-------|
| **From** | Alexandre Julliard <julliard@winehq.org> |
| **To** | git@vger.kernel.org |
| **Date** | 2007-08-11T12:32:15+02:00 |
| **Message-ID** | [87bqdeweds.fsf@wine.dyndns.org](https://lore.kernel.org/git/87bqdeweds.fsf@wine.dyndns.org) |

---

**Thread**: [thread](./10-32-15.thread.md#:~:text=2007/08/11/10-32-15)

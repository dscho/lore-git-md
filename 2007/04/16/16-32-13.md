# [PATCH 9/9] pack-objects: better check_object() performances

| Header | Value |
|--------|-------|
| **From** | Nicolas Pitre <nico@cam.org> |
| **To** | Junio C Hamano <junkio@cox.net> |
| **Date** | 2007-04-16T12:32:13-04:00 |
| **Message-ID** | [alpine.LFD.0.98.0704161231580.4504@xanadu.home](https://lore.kernel.org/git/alpine.LFD.0.98.0704161231580.4504@xanadu.home) |

---

**Thread**: [thread](./16-32-13.thread.md#:~:text=2007/04/16/16-32-13)

# [PATCH 3/9] pack-objects: rework check_delta_limit usage

| Header | Value |
|--------|-------|
| **From** | Nicolas Pitre <nico@cam.org> |
| **To** | Junio C Hamano <junkio@cox.net> |
| **Date** | 2007-04-16T12:29:16-04:00 |
| **Message-ID** | [alpine.LFD.0.98.0704161228570.4504@xanadu.home](https://lore.kernel.org/git/alpine.LFD.0.98.0704161228570.4504@xanadu.home) |

---

**Thread**: [thread](./16-29-16.thread.md#:~:text=2007/04/16/16-29-16)

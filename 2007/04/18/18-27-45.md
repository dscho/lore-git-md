# [PATCH] common progress display support

| Header | Value |
|--------|-------|
| **From** | Nicolas Pitre <nico@cam.org> |
| **To** | Junio C Hamano <junkio@cox.net> |
| **Date** | 2007-04-18T14:27:45-04:00 |
| **Message-ID** | [alpine.LFD.0.98.0704181422050.4504@xanadu.home](https://lore.kernel.org/git/alpine.LFD.0.98.0704181422050.4504@xanadu.home) |

---

**Thread**: [thread](./18-27-45.thread.md#:~:text=2007/04/18/18-27-45)

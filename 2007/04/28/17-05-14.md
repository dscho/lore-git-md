# [PATCH 3/5] Use remote functions in git-push

| Header | Value |
|--------|-------|
| **From** | Daniel Barkalow <barkalow@iabervon.org> |
| **To** | git@vger.kernel.org |
| **Date** | 2007-04-28T13:05:14-04:00 |
| **Message-ID** | [Pine.LNX.4.64.0704281304190.28708@iabervon.org](https://lore.kernel.org/git/Pine.LNX.4.64.0704281304190.28708@iabervon.org) |

---

**Thread**: [thread](./17-05-14.thread.md#:~:text=2007/04/28/17-05-14)

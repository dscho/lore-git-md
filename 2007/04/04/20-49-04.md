# [PATCH] clean up and optimize nth_packed_object_sha1() usage

| Header | Value |
|--------|-------|
| **From** | Nicolas Pitre <nico@cam.org> |
| **To** | Junio C Hamano <junkio@cox.net> |
| **Date** | 2007-04-04T16:49:04-04:00 |
| **Message-ID** | [alpine.LFD.0.98.0704041639070.28181@xanadu.home](https://lore.kernel.org/git/alpine.LFD.0.98.0704041639070.28181@xanadu.home) |

---

**Thread**: [thread](./20-49-04.thread.md#:~:text=2007/04/04/20-49-04)

# [PATCH 4/6] formalize typename(), and add its reverse type_from_string()

| Header | Value |
|--------|-------|
| **From** | Nicolas Pitre <nico@cam.org> |
| **To** | Junio C Hamano <junkio@cox.net> |
| **Date** | 2007-02-26T14:55:58-05:00 |
| **Message-ID** | [11725197633144-git-send-email-nico@cam.org](https://lore.kernel.org/git/11725197633144-git-send-email-nico@cam.org) |

---

**Thread**: [thread](./19-55-54.thread.md#:~:text=2007/02/26/19-55-58)

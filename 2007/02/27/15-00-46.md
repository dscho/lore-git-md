# [PATCH 2/2] Use OBJ_NONE to mean we don't have an object.

| Header | Value |
|--------|-------|
| **From** | Shawn O. Pearce <spearce@spearce.org> |
| **To** | Junio C Hamano <junkio@cox.net> |
| **Date** | 2007-02-27T10:00:46-05:00 |
| **Message-ID** | [20070227150046.GB3242@spearce.org](https://lore.kernel.org/git/20070227150046.GB3242@spearce.org) |

---

**Thread**: [thread](./15-00-46.thread.md#:~:text=2007/02/27/15-00-46)

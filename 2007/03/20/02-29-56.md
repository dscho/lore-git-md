# [PATCH] Add a HOWTO for setting up a standalone git daemon

| Header | Value |
|--------|-------|
| **From** | Johannes Schindelin <Johannes.Schindelin@gmx.de> |
| **To** | git@vger.kernel.org, junkio@cox.net |
| **Date** | 2007-03-20T03:29:56+01:00 |
| **Message-ID** | [Pine.LNX.4.63.0703200329350.22628@wbgn013.biozentrum.uni-wuerzburg.de](https://lore.kernel.org/git/Pine.LNX.4.63.0703200329350.22628@wbgn013.biozentrum.uni-wuerzburg.de) |

---

**Thread**: [thread](./02-29-56.thread.md#:~:text=2007/03/20/02-29-56)

# [PATCH 1/2] pathattr: path based configuration of various attributes.

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <junkio@cox.net> |
| **To** | git@vger.kernel.org |
| **Date** | 2007-02-28T23:18:01-08:00 |
| **Message-ID** | [7vps7txwie.fsf@assigned-by-dhcp.cox.net](https://lore.kernel.org/git/7vps7txwie.fsf@assigned-by-dhcp.cox.net) |

---

**Thread**: [thread](./07-18-01.thread.md#:~:text=2007/03/01/07-18-01)

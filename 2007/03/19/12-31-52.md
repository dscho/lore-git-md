# [PATCH] cvsserver: Don't lie about binary mode in asciidoc documentation

| Header | Value |
|--------|-------|
| **From** | Frank Lichtenheld <frank@lichtenheld.de> |
| **To** | git@vger.kernel.org |
| **Date** | 2007-03-19T13:31:52+01:00 |
| **Message-ID** | [11743075123989-git-send-email-frank@lichtenheld.de](https://lore.kernel.org/git/11743075123989-git-send-email-frank@lichtenheld.de) |

---

**Thread**: [thread](./12-31-52.thread.md#:~:text=2007/03/19/12-31-52)

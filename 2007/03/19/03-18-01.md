# [PATCH] user-manual: introduce "branch" and "branch head" differently

| Header | Value |
|--------|-------|
| **From** | J. Bruce Fields <bfields@citi.umich.edu> |
| **To** | Junio C Hamano <junkio@cox.net> |
| **Date** | 2007-03-18T23:18:01-04:00 |
| **Message-ID** | [32944.991978775$1174274339@news.gmane.org](https://lore.kernel.org/git/32944.991978775$1174274339@news.gmane.org) |

---

**Thread**: [thread](./03-18-01.thread.md#:~:text=2007/03/19/03-18-01)

# [PATCH 8/8] Change {pre,post}-receive hooks to use stdin

| Header | Value |
|--------|-------|
| **From** | Shawn O. Pearce <spearce@spearce.org> |
| **To** | Junio C Hamano <junkio@cox.net> |
| **Date** | 2007-03-10T03:28:16-05:00 |
| **Message-ID** | [20070310082816.GH4133@spearce.org](https://lore.kernel.org/git/20070310082816.GH4133@spearce.org) |

---

**Thread**: [thread](./08-28-16.thread.md#:~:text=2007/03/10/08-28-16)

# [PATCH] git.el: Add support for commit hooks.

| Header | Value |
|--------|-------|
| **From** | Alexandre Julliard <julliard@winehq.org> |
| **To** | git@vger.kernel.org |
| **Date** | 2007-03-17T20:40:12+01:00 |
| **Message-ID** | [87mz2by7z7.fsf@wine.dyndns.org](https://lore.kernel.org/git/87mz2by7z7.fsf@wine.dyndns.org) |

---

**Thread**: [thread](./19-40-12.thread.md#:~:text=2007/03/17/19-40-12)

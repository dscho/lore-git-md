# [PATCH] Bisect: implement "git bisect run <cmd>..." to automatically bisect.

| Header | Value |
|--------|-------|
| **From** | Christian Couder <chriscool@tuxfamily.org> |
| **To** | Junio Hamano <junkio@cox.net> |
| **Date** | 2007-03-23T08:49:59+01:00 |
| **Message-ID** | [20070323084959.d6321f53.chriscool@tuxfamily.org](https://lore.kernel.org/git/20070323084959.d6321f53.chriscool@tuxfamily.org) |

---

**Thread**: [thread](./07-49-59.thread.md#:~:text=2007/03/23/07-49-59)

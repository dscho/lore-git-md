# [PATCH 08/22] unpack-trees.c: assume submodules are clean

| Header | Value |
|--------|-------|
| **From** | skimo@liacs.nl |
| **To** | git@vger.kernel.org, Junio C Hamano <junkio@cox.net> |
| **Date** | 2007-05-24T00:22:57+02:00 |
| **Message-ID** | [11799589922975-git-send-email-skimo@liacs.nl](https://lore.kernel.org/git/11799589922975-git-send-email-skimo@liacs.nl) |

---

**Thread**: [thread](./22-22-49.thread.md#:~:text=2007/05/23/22-22-57)

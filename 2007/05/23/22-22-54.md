# [PATCH 05/22] git-config: read remote config files over HTTP

| Header | Value |
|--------|-------|
| **From** | skimo@liacs.nl |
| **To** | git@vger.kernel.org, Junio C Hamano <junkio@cox.net> |
| **Date** | 2007-05-24T00:22:54+02:00 |
| **Message-ID** | [11799589912956-git-send-email-skimo@liacs.nl](https://lore.kernel.org/git/11799589912956-git-send-email-skimo@liacs.nl) |

---

**Thread**: [thread](./22-22-54.thread.md#:~:text=2007/05/23/22-22-54)

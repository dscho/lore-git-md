# [PATCH 06/22] unpack-trees.c: pass cache_entry * to verify_absent rather than just the name

| Header | Value |
|--------|-------|
| **From** | skimo@liacs.nl |
| **To** | git@vger.kernel.org, Junio C Hamano <junkio@cox.net> |
| **Date** | 2007-05-24T00:22:55+02:00 |
| **Message-ID** | [11799589912377-git-send-email-skimo@liacs.nl](https://lore.kernel.org/git/11799589912377-git-send-email-skimo@liacs.nl) |

---

**Thread**: [thread](./22-22-49.thread.md#:~:text=2007/05/23/22-22-55)

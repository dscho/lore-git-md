# [PATCH 16/22] unpack-trees.c: optionally clone submodules for later checkout

| Header | Value |
|--------|-------|
| **From** | skimo@liacs.nl |
| **To** | git@vger.kernel.org, Junio C Hamano <junkio@cox.net> |
| **Date** | 2007-05-24T00:23:05+02:00 |
| **Message-ID** | [11799589931789-git-send-email-skimo@liacs.nl](https://lore.kernel.org/git/11799589931789-git-send-email-skimo@liacs.nl) |

---

**Thread**: [thread](./22-23-05.thread.md#:~:text=2007/05/23/22-23-05)

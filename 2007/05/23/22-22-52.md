# [PATCH 03/22] git-config: add --remote option for reading config from remote repo

| Header | Value |
|--------|-------|
| **From** | skimo@liacs.nl |
| **To** | git@vger.kernel.org, Junio C Hamano <junkio@cox.net> |
| **Date** | 2007-05-24T00:22:52+02:00 |
| **Message-ID** | [11799589913274-git-send-email-skimo@liacs.nl](https://lore.kernel.org/git/11799589913274-git-send-email-skimo@liacs.nl) |

---

**Thread**: [thread](./22-22-52.thread.md#:~:text=2007/05/23/22-22-52)

# [PATCH 12/22] git-checkout: pass --submodules option to git-read-tree

| Header | Value |
|--------|-------|
| **From** | skimo@liacs.nl |
| **To** | git@vger.kernel.org, Junio C Hamano <junkio@cox.net> |
| **Date** | 2007-05-24T00:23:01+02:00 |
| **Message-ID** | [11799589921780-git-send-email-skimo@liacs.nl](https://lore.kernel.org/git/11799589921780-git-send-email-skimo@liacs.nl) |

---

**Thread**: [thread](./22-22-49.thread.md#:~:text=2007/05/23/22-23-01)

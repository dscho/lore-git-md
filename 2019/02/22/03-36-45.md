...
| **Date** | 2019-02-22T03:36:45Z |
| **Message-ID** | [SN6PR03MB3647F1CDFD95F29C86F54FF8BA7F0@SN6PR03MB3647.namprd03.prod.outlook.com](https://lore.kernel.org/git/SN6PR03MB3647F1CDFD95F29C86F54FF8BA7F0@SN6PR03MB3647.namprd03.prod.outlook.com) |

---

**Thread**: [thread](./03-36-45.thread.md#:~:text=2019/02/22/03-36-45)
...
----------------------------------------------------------------------------
Issue:
When running from Git-bash (not even inside a repo), git commands from built-in are OK, but if I use the exe that is located at C:\Program Files\Git\bin\git.exe, the process takes long to execute and then exits with error "error launching git: The filename or extension is too long.":

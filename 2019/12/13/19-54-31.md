# Re: [PATCH 3/3] doc: indent multi-line items in list

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | Jean-Noël Avila <jn.avila@free.fr> |
| **Date** | 2019-12-13T11:54:31-08:00 |
| **Message-ID** | [xmqqfthoj91k.fsf@gitster-ct.c.googlers.com](https://lore.kernel.org/git/xmqqfthoj91k.fsf@gitster-ct.c.googlers.com) |

---

**Thread**: [thread](./../12/20-46-53.thread.md#:~:text=2019/12/13/19-54-31)

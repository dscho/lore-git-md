# Re: [PATCH 1/1] unpack-trees: skip stat on fsmonitor-valid files

| Header | Value |
|--------|-------|
| **From** | Utsav Shah <utsav@dropbox.com> |
| **To** | Utsav Shah via GitGitGadget <gitgitgadget@gmail.com> |
| **Date** | 2019-11-05T07:29:40-08:00 |
| **Message-ID** | [CAPYzU3Pk=vwsAre4hydBaqErRuQLZmtUzqM0PCPYwKD1Aw_UWQ@mail.gmail.com](https://lore.kernel.org/git/CAPYzU3Pk=vwsAre4hydBaqErRuQLZmtUzqM0PCPYwKD1Aw_UWQ@mail.gmail.com) |

---

**Thread**: [thread](./../04/23-41-24.thread.md#:~:text=2019/11/05/15-29-40)

# [BUG] commit-graph path normalization reads uninitialized bytes

| Header | Value |
|--------|-------|
| **From** | Jeff King <peff@peff.net> |
| **To** | Derrick Stolee <dstolee@microsoft.com> |
| **Date** | 2019-10-27T00:21:16-04:00 |
| **Message-ID** | [20191027042116.GA5801@sigill.intra.peff.net](https://lore.kernel.org/git/20191027042116.GA5801@sigill.intra.peff.net) |

---

**Thread**: [thread](./04-21-16.thread.md#:~:text=2019/10/27/04-21-16)

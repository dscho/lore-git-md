...
| **Date** | 2019-01-12T09:13:32+07:00 |
| **Message-ID** | [20190112021332.11066-12-pclouds@gmail.com](https://lore.kernel.org/git/20190112021332.11066-12-pclouds@gmail.com) |

---

**Thread**: [thread](./../05/05-51-43.thread.md#:~:text=2019/01/12/02-13-32)
...
```
 ...
 tree.c                               | 1 -
 unpack-trees.c                       | 1 -
 55 files changed, 53 insertions(+), 24 deletions(-)
...
index 9411c4baee..a92550ade2 100644
--- a/repository.c
+++ b/repository.c
@@ -9,6 +9,7 @@
 /* The main repository */

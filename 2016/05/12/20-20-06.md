...
| **Date** | 2016-05-12T16:20:06-04:00 |
| **Message-ID** | [1463084415-19826-12-git-send-email-dturner@twopensource.com](https://lore.kernel.org/git/1463084415-19826-12-git-send-email-dturner@twopensource.com) |

---

**Thread**: [thread](./20-20-06.thread.md#:~:text=2016/05/12/20-20-06)
...
@@ -1645,29 +1723,92 @@ static void post_read_index_from(struct index_state *istate)
...
+
 ...
 {
@@ -1856,7 +2065,7 @@ int read_index_from(struct index_state *istate, const char *path)
...
+		goto done;
 	...
 	if (split_index->base)
@@ -1877,6 +2086,10 @@ int read_index_from(struct index_state *istate, const char *path)

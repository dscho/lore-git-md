...
| **Date** | 2016-05-12T16:20:14-04:00 |
| **Message-ID** | [1463084415-19826-20-git-send-email-dturner@twopensource.com](https://lore.kernel.org/git/1463084415-19826-20-git-send-email-dturner@twopensource.com) |

---

**Thread**: [thread](./20-20-14.thread.md#:~:text=2016/05/12/20-20-14)
...
@@ -2088,12 +2090,15 @@ int read_index_from(struct index_state *istate, const char *path)
 {
...
@@ -2108,6 +2113,7 @@ int read_index_from(struct index_state *istate, const char *path)
...
@@ -2119,6 +2125,9 @@ int read_index_from(struct index_state *istate, const char *path)
...
@@ -2464,6 +2473,7 @@ static int do_write_index(struct index_state *istate, int newfd,
 	struct stat st;
...
@@ -2584,6 +2594,7 @@ static int do_write_index(struct index_state *istate, int newfd,
 		return -1;

...
| **Date** | 2016-05-05T17:47:02-04:00 |
| **Message-ID** | [1462484831-13643-11-git-send-email-dturner@twopensource.com](https://lore.kernel.org/git/1462484831-13643-11-git-send-email-dturner@twopensource.com) |

---

**Thread**: [thread](./21-46-52.thread.md#:~:text=2016/05/05/21-47-02)
...
+			if (really || cache_errno == EINVAL) {
 				 ...
 				 */
@@ -1375,11 +1375,76 @@ static int verify_hdr(const struct cache_header *hdr, unsigned long size)
 	return 0;
 }
...
@@ -1409,10 +1474,24 @@ static int read_watchman_ext(struct index_state *istate, const void *data,
...
@@ -1645,29 +1724,90 @@ static void post_read_index_from(struct index_state *istate)
...
+
 ...
 {
@@ -1856,7 +2064,7 @@ int read_index_from(struct index_state *istate, const char *path)
...
+		goto done;
 	...
 	if (split_index->base)
@@ -1877,6 +2085,10 @@ int read_index_from(struct index_state *istate, const char *path)

...
| **Date** | 2016-05-05T17:47:10-04:00 |
| **Message-ID** | [1462484831-13643-19-git-send-email-dturner@twopensource.com](https://lore.kernel.org/git/1462484831-13643-19-git-send-email-dturner@twopensource.com) |

---

**Thread**: [thread](./21-46-52.thread.md#:~:text=2016/05/05/21-47-10)
...
@@ -2087,12 +2089,15 @@ int read_index_from(struct index_state *istate, const char *path)
 {
...
@@ -2107,6 +2112,7 @@ int read_index_from(struct index_state *istate, const char *path)
...
@@ -2118,6 +2124,9 @@ int read_index_from(struct index_state *istate, const char *path)
...
@@ -2463,6 +2472,7 @@ static int do_write_index(struct index_state *istate, int newfd,
 	struct stat st;
...
@@ -2583,6 +2593,7 @@ static int do_write_index(struct index_state *istate, int newfd,
 		return -1;

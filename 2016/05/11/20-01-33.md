...
| **Date** | 2016-05-11T20:01:33Z |
| **Message-ID** | [1462996893-24341-1-git-send-email-vascomalmeida@sapo.pt](https://lore.kernel.org/git/1462996893-24341-1-git-send-email-vascomalmeida@sapo.pt) |

---

**Thread**: [thread](./../../04/16/19-29-59.thread.md#:~:text=2016/05/11/20-01-33)
...
```
 Oops, fix typo.
  ...
  msgstr [-"<%s-Baixo>\tDescolar-]{+"<%s-Baixo>\tDeslocar+} a lista de commits uma linha para baixo"

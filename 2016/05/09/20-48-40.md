...
| **Date** | 2016-05-09T16:48:40-04:00 |
| **Message-ID** | [1462826929-7567-11-git-send-email-dturner@twopensource.com](https://lore.kernel.org/git/1462826929-7567-11-git-send-email-dturner@twopensource.com) |

---

**Thread**: [thread](./20-48-30.thread.md#:~:text=2016/05/09/20-48-40)
...
@@ -1645,29 +1723,90 @@ static void post_read_index_from(struct index_state *istate)
...
+
 ...
 {
@@ -1856,7 +2063,7 @@ int read_index_from(struct index_state *istate, const char *path)
...
+		goto done;
 	...
 	if (split_index->base)
@@ -1877,6 +2084,10 @@ int read_index_from(struct index_state *istate, const char *path)

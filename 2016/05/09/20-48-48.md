...
| **Date** | 2016-05-09T16:48:48-04:00 |
| **Message-ID** | [1462826929-7567-19-git-send-email-dturner@twopensource.com](https://lore.kernel.org/git/1462826929-7567-19-git-send-email-dturner@twopensource.com) |

---

**Thread**: [thread](./20-48-48.thread.md#:~:text=2016/05/09/20-48-48)
...
@@ -2086,12 +2088,15 @@ int read_index_from(struct index_state *istate, const char *path)
 {
...
@@ -2106,6 +2111,7 @@ int read_index_from(struct index_state *istate, const char *path)
...
@@ -2117,6 +2123,9 @@ int read_index_from(struct index_state *istate, const char *path)
...
@@ -2462,6 +2471,7 @@ static int do_write_index(struct index_state *istate, int newfd,
 	struct stat st;
...
@@ -2582,6 +2592,7 @@ static int do_write_index(struct index_state *istate, int newfd,
 		return -1;

...
| **Date** | 2016-03-25T10:02:20+01:00 |
| **Message-ID** | [CAP8UFD0muBUEp9XknmcTWqg==ChzWP3m-p-v6vXyC09OC88U7w@mail.gmail.com](https://lore.kernel.org/git/CAP8UFD0muBUEp9XknmcTWqg==ChzWP3m-p-v6vXyC09OC88U7w@mail.gmail.com) |

---

**Thread**: [thread](./../23/23-27-12.thread.md#:~:text=2016/03/25/09-02-20)
...
The link cannot be seen in text mode but it looks ok on the pdf proposal.
...
Fixing the bugs introduced by the conversion should be done as soon as
you know about them.

# [PATCH v2 03/16] ref-filter: implement %(if:equals=<string>) and %(if:notequals=<string>)

| Header | Value |
|--------|-------|
| **From** | Karthik Nayak <karthik.188@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2016-03-15T22:17:03+05:30 |
| **Message-ID** | [1458060436-1215-4-git-send-email-Karthik.188@gmail.com](https://lore.kernel.org/git/1458060436-1215-4-git-send-email-Karthik.188@gmail.com) |

---

**Thread**: [thread](./16-47-00.thread.md#:~:text=2016/03/15/16-47-03)

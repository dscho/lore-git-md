...
| **Date** | 2016-02-23T20:44:51+07:00 |
| **Message-ID** | [1456235103-26317-14-git-send-email-pclouds@gmail.com](https://lore.kernel.org/git/1456235103-26317-14-git-send-email-pclouds@gmail.com) |

---

**Thread**: [thread](./13-44-38.thread.md#:~:text=2016/02/23/13-44-51)
...
@@ -137,6 +139,81 @@ struct commit_list *get_shallow_commits(struct object_array *heads, int depth,
 	return result;
 }

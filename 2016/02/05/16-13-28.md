...
| **Date** | 2016-02-05T17:13:28+01:00 |
| **Message-ID** | [1454688808-20910-1-git-send-email-tboegi@web.de](https://lore.kernel.org/git/1454688808-20910-1-git-send-email-tboegi@web.de) |

---

**Thread**: [thread](./16-13-28.thread.md#:~:text=2016/02/05/16-13-28)
...
@@ -1383,11 +1396,13 @@ struct stream_filter *get_stream_filter(const char *path, const unsigned char *s

...
| **Date** | 2016-02-25T23:50:50+01:00 |
| **Message-ID** | [1456440650-32623-22-git-send-email-szeder@ira.uka.de](https://lore.kernel.org/git/1456440650-32623-22-git-send-email-szeder@ira.uka.de) |

---

**Thread**: [thread](./22-50-29.thread.md#:~:text=2016/02/25/22-50-50)
...
@@ -915,8 +924,8 @@ __git_whitespacelist="nowarn warn error error-all fix"
...
@@ -1486,10 +1496,10 @@ __git_log_date_formats="relative iso8601 rfc2822 short local default raw"
 _git_log ()
 {
...
@@ -345,21 +348,57 @@ test_expect_success SYMLINKS '__gitdir - resulting path avoids symlinks' '

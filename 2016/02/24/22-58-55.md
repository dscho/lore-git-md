...
| **Date** | 2016-02-24T17:58:55-05:00 |
| **Message-ID** | [1456354744-8022-24-git-send-email-dturner@twopensource.com](https://lore.kernel.org/git/1456354744-8022-24-git-send-email-dturner@twopensource.com) |

---

**Thread**: [thread](./22-58-32.thread.md#:~:text=2016/02/24/22-58-55)
...
--- a/refs.h
+++ b/refs.h
@@ -511,6 +511,11 @@ extern int reflog_expire(const char *refname, const unsigned char *sha1,
 			 void *policy_cb_data);

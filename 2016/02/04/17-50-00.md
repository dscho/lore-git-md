...
| **Date** | 2016-02-04T18:50:00+01:00 |
| **Message-ID** | [1454608200-5535-1-git-send-email-tboegi@web.de](https://lore.kernel.org/git/1454608200-5535-1-git-send-email-tboegi@web.de) |

---

**Thread**: [thread](./17-50-00.thread.md#:~:text=2016/02/04/17-50-00)
...
@@ -338,7 +334,7 @@ static int crlf_to_worktree(const char *path, const char *src, size_t len,
 	if (src == buf->buf)

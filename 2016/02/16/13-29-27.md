...
| **Date** | 2016-02-16T20:29:27+07:00 |
| **Message-ID** | [1455629367-26193-27-git-send-email-pclouds@gmail.com](https://lore.kernel.org/git/1455629367-26193-27-git-send-email-pclouds@gmail.com) |

---

**Thread**: [thread](./../03/09-35-30.thread.md#:~:text=2016/02/16/13-29-27)
...
@@ -588,6 +589,84 @@ static int move_worktree(int ac, const char **av, const char *prefix)
...
+
 ...
 {
 	struct option options[] = {
@@ -610,5 +689,7 @@ int cmd_worktree(int ac, const char **av, const char *prefix)

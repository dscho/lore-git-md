...
| **Date** | 2016-02-16T20:29:24+07:00 |
| **Message-ID** | [1455629367-26193-24-git-send-email-pclouds@gmail.com](https://lore.kernel.org/git/1455629367-26193-24-git-send-email-pclouds@gmail.com) |

---

**Thread**: [thread](./../03/09-35-30.thread.md#:~:text=2016/02/16/13-29-24)
...
@@ -484,6 +485,34 @@ static int lock_worktree(int ac, const char **av, const char *prefix)
 	return 0;
 }
...
+
 ...
 {
 	struct option options[] = {
@@ -502,5 +531,7 @@ int cmd_worktree(int ac, const char **av, const char *prefix)

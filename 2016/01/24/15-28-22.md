...
| **Date** | 2016-01-24T16:28:22+01:00 |
| **Message-ID** | [1453649304-18121-10-git-send-email-chriscool@tuxfamily.org](https://lore.kernel.org/git/1453649304-18121-10-git-send-email-chriscool@tuxfamily.org) |

---

**Thread**: [thread](./15-28-13.thread.md#:~:text=2016/01/24/15-28-22)
...
@@ -1622,9 +1635,10 @@ int read_index_from(struct index_state *istate, const char *path)
...
@@ -1642,7 +1656,7 @@ int read_index_from(struct index_state *istate, const char *path)

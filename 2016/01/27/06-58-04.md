...
| **Date** | 2016-01-27T07:58:04+01:00 |
| **Message-ID** | [1453877887-11586-9-git-send-email-chriscool@tuxfamily.org](https://lore.kernel.org/git/1453877887-11586-9-git-send-email-chriscool@tuxfamily.org) |

---

**Thread**: [thread](./06-57-56.thread.md#:~:text=2016/01/27/06-58-04)
...
@@ -1871,15 +1874,21 @@ static void new_untracked_cache(struct index_state *istate)
...
@@ -1948,7 +1957,7 @@ static struct untracked_cache_dir *validate_untracked_cache(struct dir_struct *d
 		return NULL;

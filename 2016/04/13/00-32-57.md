...
| **Date** | 2016-04-12T20:32:57-04:00 |
| **Message-ID** | [1460507589-25525-5-git-send-email-dturner@twopensource.com](https://lore.kernel.org/git/1460507589-25525-5-git-send-email-dturner@twopensource.com) |

---

**Thread**: [thread](./00-32-57.thread.md#:~:text=2016/04/13/00-32-57)
...
@@ -178,11 +179,56 @@ static void share_index(struct index_state *istate, struct shm *is)
...
--- a/read-cache.c
+++ b/read-cache.c
@@ -1721,9 +1721,12 @@ int do_read_index(struct index_state *istate, const char *path, int must_exist)

...
| **Date** | 2016-04-12T20:33:00-04:00 |
| **Message-ID** | [1460507589-25525-8-git-send-email-dturner@twopensource.com](https://lore.kernel.org/git/1460507589-25525-8-git-send-email-dturner@twopensource.com) |

---

**Thread**: [thread](./00-33-00.thread.md#:~:text=2016/04/13/00-33-00)
...
@@ -2261,6 +2364,16 @@ static int do_write_index(struct index_state *istate, int newfd,
 		if (err)
 			return -1;
 	}

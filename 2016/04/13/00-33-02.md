...
| **Date** | 2016-04-12T20:33:02-04:00 |
| **Message-ID** | [1460507589-25525-10-git-send-email-dturner@twopensource.com](https://lore.kernel.org/git/1460507589-25525-10-git-send-email-dturner@twopensource.com) |

---

**Thread**: [thread](./00-32-53.thread.md#:~:text=2016/04/13/00-33-02)
...
@@ -53,6 +53,12 @@ command. The following commands are used to control the daemon:
...
@@ -1644,7 +1723,6 @@ static void post_read_index_from(struct index_state *istate)
...
-
 ...
 {
 	int len;
@@ -1689,6 +1767,7 @@ static const char *index_helper_path(const char *format, ...)
...
@@ -1697,26 +1776,77 @@ static const char *index_helper_path(const char *format, ...)
 	return sb.buf;
 }
...
+
 ...
 {
@@ -1903,7 +2101,7 @@ int read_index_from(struct index_state *istate, const char *path)
...
+		goto done;
 	...
 	if (split_index->base)
@@ -1924,6 +2122,10 @@ int read_index_from(struct index_state *istate, const char *path)

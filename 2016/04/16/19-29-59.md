...
| **Date** | 2016-04-16T19:29:59Z |
| **Message-ID** | [1460834999-13544-1-git-send-email-vascomalmeida@sapo.pt](https://lore.kernel.org/git/1460834999-13544-1-git-send-email-vascomalmeida@sapo.pt) |

---

**Thread**: [thread](./19-29-59.thread.md#:~:text=2016/04/16/19-29-59)
...
+msgstr "<Shift-Up>\tProcurar para trás (para cima, commits posteriores)"
+
+#: gitk:3085
+msgid "<Shift-Down>\tFind forwards (downwards, earlier commits)"
+msgstr "<Shift-Down>\tProcurar para a frente (para baixo, commits anteriores)"
+
+#: gitk:3086
...
+msgstr "<Backspace>\tDeslocar vista diff uma página para cima"
+
+#: gitk:3088
+msgid "<Space>\t\tScroll diff view down one page"
+msgstr "<Space>\t\tDeslocar vista diff uma página para baixo"
+
+#: gitk:3089
...
+msgstr "Não foi possível ler a cabeça de merge: %s"
+
+#: gitk:3856
+#, tcl-format
...
+msgstr "Alterações locais preparadas no índice mas não incluídas num commit"
+
+#: gitk:5379
+msgid "Local uncommitted changes, not checked in to index"
+msgstr "Alterações locais pendentes para commit, não preparadas no índice"
+
+#: gitk:7153
+msgid "and many more"
...
+"Faça commit, stash ou reset das alterações e tente de novo."
+
+#: gitk:9583
+msgid ""
...
+msgstr "Não foi efetuado commit de nenhum alteração"
+
+#: gitk:9626
+#, tcl-format
...
+msgstr "Não é possível eliminar o ramo extraído"
+
+#: gitk:9835
+#, tcl-format
+msgid ""
...
+msgstr ""
+"Os commits no ramo %s não estão em mais nenhum ramo.\n"
...
+msgstr "Tipo de letra para mostrar as diferenças"
+
+#: gitk:11496

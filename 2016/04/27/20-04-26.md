...
| **Date** | 2016-04-27T16:04:26-04:00 |
| **Message-ID** | [1461787481-877-5-git-send-email-dturner@twopensource.com](https://lore.kernel.org/git/1461787481-877-5-git-send-email-dturner@twopensource.com) |

---

**Thread**: [thread](./20-04-22.thread.md#:~:text=2016/04/27/20-04-26)
...
+static int to_verify = 1;
 ...
 {
@@ -111,11 +112,56 @@ static void share_index(struct index_state *istate, struct shm *is)

...
| **Date** | 2016-04-29T21:02:04-04:00 |
| **Message-ID** | [1461978133-13966-11-git-send-email-dturner@twopensource.com](https://lore.kernel.org/git/1461978133-13966-11-git-send-email-dturner@twopensource.com) |

---

**Thread**: [thread](./01-01-54.thread.md#:~:text=2016/04/30/01-02-04)
...
@@ -1644,28 +1723,89 @@ static void post_read_index_from(struct index_state *istate)
...
+
 ...
 {
@@ -1853,7 +2061,7 @@ int read_index_from(struct index_state *istate, const char *path)
...
+		goto done;
 	...
 	if (split_index->base)
@@ -1874,6 +2082,10 @@ int read_index_from(struct index_state *istate, const char *path)

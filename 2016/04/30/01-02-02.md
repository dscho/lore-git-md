...
| **Date** | 2016-04-29T21:02:02-04:00 |
| **Message-ID** | [1461978133-13966-9-git-send-email-dturner@twopensource.com](https://lore.kernel.org/git/1461978133-13966-9-git-send-email-dturner@twopensource.com) |

---

**Thread**: [thread](./01-01-54.thread.md#:~:text=2016/04/30/01-02-02)
...
@@ -42,11 +43,13 @@ static struct cache_entry *refresh_cache_entry(struct cache_entry *ce,
...
@@ -1221,8 +1224,13 @@ int refresh_index(struct index_state *istate, unsigned int flags,
 			continue;
...
@@ -1366,6 +1374,94 @@ static int verify_hdr(const struct cache_header *hdr, unsigned long size)
 	return 0;
 }
...
+
 ...
 {
@@ -1383,6 +1479,11 @@ static int read_index_extension(struct index_state *istate,
...
@@ -2211,6 +2314,16 @@ static int do_write_index(struct index_state *istate, int newfd,
 		if (err)
 			return -1;
 	}

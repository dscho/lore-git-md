# [PATCH] Make Documentation (somehwat more) consistent

| Header | Value |
|--------|-------|
| **From** | Horst H. von Brand <vonbrand@inf.utfsm.cl> |
| **To** | Junio C Hamano <junkio@cox.net> |
| **Date** | 2006-06-11T16:37:48-04:00 |
| **Message-ID** | [11500582752231-git-send-email-vonbrand@inf.utfsm.cl](https://lore.kernel.org/git/11500582752231-git-send-email-vonbrand@inf.utfsm.cl) |

---

**Thread**: [thread](./20-37-47.thread.md#:~:text=2006/06/11/20-37-48)

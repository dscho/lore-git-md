# [PATCH 3/4] use detachable filepairs and an attempt to cleanup

| Header | Value |
|--------|-------|
| **From** | Alex Riesen <fork0@t-online.de> |
| **To** | git@vger.kernel.org |
| **Date** | 2006-06-30T02:27:50+02:00 |
| **Message-ID** | [20060630002750.GC22618@steel.home](https://lore.kernel.org/git/20060630002750.GC22618@steel.home) |

---

**Thread**: [thread](./00-27-50.thread.md#:~:text=2006/06/30/00-27-50)

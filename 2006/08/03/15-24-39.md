...
| **To** | junkio@cox.net |
| **Date** | 2006-08-03T17:24:39+02:00 |
| **Message-ID** | [11546186802823-git-send-email-matthias@spinlock.ch](https://lore.kernel.org/git/11546186802823-git-send-email-matthias@spinlock.ch) |

---

**Thread**: [thread](./15-24-39.thread.md#:~:text=2006/08/03/15-24-39)

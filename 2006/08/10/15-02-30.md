...
| **Date** | 2006-08-10T17:02:30+02:00 |
| **Message-ID** | [11552221581171-git-send-email-rene.scharfe@lsrfire.ath.cx](https://lore.kernel.org/git/11552221581171-git-send-email-rene.scharfe@lsrfire.ath.cx) |

---

**Thread**: [thread](./15-02-30.thread.md#:~:text=2006/08/10/15-02-30)

# [PATCH] git-grep --relative: show pathnames relative to the current directory

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <junkio@cox.net> |
| **To** | git@vger.kernel.org |
| **Date** | 2006-08-11T00:50:12-07:00 |
| **Message-ID** | [7vpsf7u2x7.fsf@assigned-by-dhcp.cox.net](https://lore.kernel.org/git/7vpsf7u2x7.fsf@assigned-by-dhcp.cox.net) |

---

**Thread**: [thread](./07-50-12.thread.md#:~:text=2006/08/11/07-50-12)

...
| **Date** | 2017-07-25T15:53:40+02:00 |
| **Message-ID** | [alpine.DEB.2.21.1.1706281259170.84669@virtualbox](https://lore.kernel.org/git/alpine.DEB.2.21.1.1706281259170.84669@virtualbox) |

---

**Thread**: [thread](./13-53-40.thread.md#:~:text=2017/07/25/13-53-40)
...
- [winerr2errno.h](winerr2errno.h) (text)

...
| **Date** | 2017-03-29T11:53:29-04:00 |
| **Message-ID** | [20170329155330.12860-8-benpeart@microsoft.com](https://lore.kernel.org/git/20170329155330.12860-8-benpeart@microsoft.com) |

---

**Thread**: [thread](./15-53-22.thread.md#:~:text=2017/03/29/15-53-29)
...
@@ -496,85 +497,11 @@ static int apply_single_file_filter(const char *path, const char *src, size_t le
...
-
 ...
 {
 	int err;
@@ -638,49 +565,6 @@ static int start_multi_file_filter_fn(struct subprocess_entry *subprocess)
 	return err;
 }

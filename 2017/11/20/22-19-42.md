...
| **Date** | 2017-11-20T14:19:42-08:00 |
| **Message-ID** | [20171120221944.15431-8-newren@gmail.com](https://lore.kernel.org/git/20171120221944.15431-8-newren@gmail.com) |

---

**Thread**: [thread](./22-19-35.thread.md#:~:text=2017/11/20/22-19-42)
...
index d818830098..e2d3b0fb4a 100644
--- a/merge-recursive.c
+++ b/merge-recursive.c
@@ -3051,11 +3051,26 @@ static int process_entry(struct merge_options *o,
 				clean_merge = -1;
 		}
 	} else if (a_oid && b_oid) {
...
index f1538087ca..50506d951b 100755
--- a/t/t6043-merge-rename-directories.sh
+++ b/t/t6043-merge-rename-directories.sh
@@ -961,7 +961,7 @@ test_expect_success '5b-check: Rename/delete in order to get add/add/add conflic
...
@@ -970,7 +970,9 @@ test_expect_success '5b-check: Rename/delete in order to get add/add/add conflic
...
@@ -1039,7 +1041,7 @@ test_expect_success '5c-check: Transitive rename would cause rename/rename/renam
...
+		test 5 -eq $(git ls-files -o | wc -l) &&
 		...
 		git rev-parse >actual \
 			:0:y/b :0:y/c :0:y/e &&
@@ -1055,13 +1057,12 @@ test_expect_success '5c-check: Transitive rename would cause rename/rename/renam
 		test_cmp expect actual &&
 
 		git hash-object >actual \
-			w/d~HEAD w/d~B^0 &&
+			w/d~HEAD w/d~B^0 y/d~HEAD y/d~B^0 &&
 		git rev-parse >expect \
-			O:x/d B:w/d &&
+			O:x/d B:w/d A:y/d B:y/d &&
 		test_cmp expect actual &&
 		test ! -f x/d &&
-		test -f y/d &&

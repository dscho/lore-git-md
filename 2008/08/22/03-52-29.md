# [PATCH 2/2 v3] bisect: only check merge bases when needed

| Header | Value |
|--------|-------|
| **From** | Christian Couder <chriscool@tuxfamily.org> |
| **To** | Junio C Hamano <gitster@pobox.com>, Johannes Schindelin <Johannes.Schindelin@gmx.de> |
| **Date** | 2008-08-22T05:52:29+02:00 |
| **Message-ID** | [20080822055229.95f9b944.chriscool@tuxfamily.org](https://lore.kernel.org/git/20080822055229.95f9b944.chriscool@tuxfamily.org) |

---

**Thread**: [thread](./03-52-29.thread.md#:~:text=2008/08/22/03-52-29)

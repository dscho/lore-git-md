# [PATCH 1/2 v3] bisect: test merge base if good rev is not an ancestor of bad rev

| Header | Value |
|--------|-------|
| **From** | Christian Couder <chriscool@tuxfamily.org> |
| **To** | Junio C Hamano <gitster@pobox.com>, Johannes Schindelin <Johannes.Schindelin@gmx.de> |
| **Date** | 2008-08-22T05:52:22+02:00 |
| **Message-ID** | [20080822055222.69a740f1.chriscool@tuxfamily.org](https://lore.kernel.org/git/20080822055222.69a740f1.chriscool@tuxfamily.org) |

---

**Thread**: [thread](./03-52-22.thread.md#:~:text=2008/08/22/03-52-22)

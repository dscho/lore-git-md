# [GIT-GUI PATCH] Teach git gui about file type changes

| Header | Value |
|--------|-------|
| **From** | Gustaf Hendeby <hendeby@isy.liu.se> |
| **To** | git@vger.kernel.org |
| **Date** | 2008-08-22T22:10:27+02:00 |
| **Message-ID** | [1219435827-11122-1-git-send-email-hendeby@isy.liu.se](https://lore.kernel.org/git/1219435827-11122-1-git-send-email-hendeby@isy.liu.se) |

---

**Thread**: [thread](./20-10-27.thread.md#:~:text=2008/08/22/20-10-27)

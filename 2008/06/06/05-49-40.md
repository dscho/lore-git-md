# [JGIT PATCH] Change the POM file to take all the sources from the original location

| Header | Value |
|--------|-------|
| **From** | imyousuf@gmail.com |
| **To** | git@vger.kernel.org |
| **Date** | 2008-06-06T11:49:40+06:00 |
| **Message-ID** | [1212731380-13221-1-git-send-email-imyousuf@gmail.com](https://lore.kernel.org/git/1212731380-13221-1-git-send-email-imyousuf@gmail.com) |

---

**Thread**: [thread](./05-49-40.thread.md#:~:text=2008/06/06/05-49-40)

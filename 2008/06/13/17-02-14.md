# Re: [PATCH v3] git-instaweb: Enhanced auto-discovery of httpd and call conventions. Removed backticks.

| Header | Value |
|--------|-------|
| **From** | Eric Wong <normalperson@yhbt.net> |
| **To** | Flavio Poletti <flavio@polettix.it> |
| **Date** | 2008-06-13T10:02:14-07:00 |
| **Message-ID** | [20080613170214.GF5966@yp-box.dyndns.org](https://lore.kernel.org/git/20080613170214.GF5966@yp-box.dyndns.org) |

---

**Thread**: [thread](./../12/01-51-20.thread.md#:~:text=2008/06/13/17-02-14)

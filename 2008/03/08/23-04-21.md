# [PATCH 09/11] Provide API access to init_db()

| Header | Value |
|--------|-------|
| **From** | Daniel Barkalow <barkalow@iabervon.org> |
| **To** | Junio C Hamano <gitster@pobox.com> |
| **Date** | 2008-03-08T18:04:21-05:00 |
| **Message-ID** | [alpine.LNX.1.00.0803081804200.19665@iabervon.org](https://lore.kernel.org/git/alpine.LNX.1.00.0803081804200.19665@iabervon.org) |

---

**Thread**: [thread](./23-04-21.thread.md#:~:text=2008/03/08/23-04-21)

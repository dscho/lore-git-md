# [PATCH 04/11] Mark the list of refs to fetch as const

| Header | Value |
|--------|-------|
| **From** | Daniel Barkalow <barkalow@iabervon.org> |
| **To** | Junio C Hamano <gitster@pobox.com> |
| **Date** | 2008-03-08T18:04:06-05:00 |
| **Message-ID** | [alpine.LNX.1.00.0803081804050.19665@iabervon.org](https://lore.kernel.org/git/alpine.LNX.1.00.0803081804050.19665@iabervon.org) |

---

**Thread**: [thread](./23-04-06.thread.md#:~:text=2008/03/08/23-04-06)

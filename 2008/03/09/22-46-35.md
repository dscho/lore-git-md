# [PATCH 1/2] Add a lockfile function to append to a file

| Header | Value |
|--------|-------|
| **From** | Daniel Barkalow <barkalow@iabervon.org> |
| **To** | Junio C Hamano <gitster@pobox.com> |
| **Date** | 2008-03-09T18:46:35-04:00 |
| **Message-ID** | [alpine.LNX.1.00.0803091842030.19665@iabervon.org](https://lore.kernel.org/git/alpine.LNX.1.00.0803091842030.19665@iabervon.org) |

---

**Thread**: [thread](./22-46-35.thread.md#:~:text=2008/03/09/22-46-35)

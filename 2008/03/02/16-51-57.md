# Re* [PATCH] git-submodule: Don't blame when git-describe fails

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | Ping Yin <pkufranky@gmail.com> |
| **Date** | 2008-03-02T08:51:57-08:00 |
| **Message-ID** | [7vy791oyqa.fsf@gitster.siamese.dyndns.org](https://lore.kernel.org/git/7vy791oyqa.fsf@gitster.siamese.dyndns.org) |

---

**Thread**: [thread](./14-45-52.thread.md#:~:text=2008/03/02/16-51-57)

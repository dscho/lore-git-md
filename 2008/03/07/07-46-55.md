# [PATCH 2/2 resend] Documentation: help: describe 'man.viewer' config variable

| Header | Value |
|--------|-------|
| **From** | Christian Couder <chriscool@tuxfamily.org> |
| **To** | Junio Hamano <junkio@cox.net>, Pascal Obry <pascal@obry.net>, Xavier Maillard <xma@gnu.org>, しらいしななこ <> |
| **Date** | 2008-03-07T08:46:55+01:00 |
| **Message-ID** | [20080307084655.36bedec3.chriscool@tuxfamily.org](https://lore.kernel.org/git/20080307084655.36bedec3.chriscool@tuxfamily.org) |

---

**Thread**: [thread](./07-46-55.thread.md#:~:text=2008/03/07/07-46-55)

# [PATCH] Add new git-graph command

| Header | Value |
|--------|-------|
| **From** | Adam Simpkins <adam@adamsimpkins.net> |
| **To** | git@vger.kernel.org |
| **Date** | 2008-03-30T12:58:41-07:00 |
| **Message-ID** | [20080330195840.GA8695@adamsimpkins.net](https://lore.kernel.org/git/20080330195840.GA8695@adamsimpkins.net) |

---

**Thread**: [thread](./19-58-41.thread.md#:~:text=2008/03/30/19-58-41)

# [EGIT PATCH 3/4] Change the find toolbar find-in prefs into radio rotating options.

| Header | Value |
|--------|-------|
| **From** | Roger C. Soares <rogersoares@intelinet.com.br> |
| **To** | git@vger.kernel.org |
| **Date** | 2008-03-30T11:18:59-04:00 |
| **Message-ID** | [1206890339-3752-1-git-send-email-rogersoares@intelinet.com.br](https://lore.kernel.org/git/1206890339-3752-1-git-send-email-rogersoares@intelinet.com.br) |

---

**Thread**: [thread](./15-18-59.thread.md#:~:text=2008/03/30/15-18-59)

# [PATCH v2 6/7] Make git-fetch follow tags we already have objects for sooner

| Header | Value |
|--------|-------|
| **From** | Shawn O. Pearce <spearce@spearce.org> |
| **To** | Junio C Hamano <gitster@pobox.com> |
| **Date** | 2008-03-01T00:25:29-05:00 |
| **Message-ID** | [20080301052529.GF27300@spearce.org](https://lore.kernel.org/git/20080301052529.GF27300@spearce.org) |

---

**Thread**: [thread](./05-25-29.thread.md#:~:text=2008/03/01/05-25-29)

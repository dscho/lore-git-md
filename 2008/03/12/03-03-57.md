# speed of fetch for stable linux tree

| Header | Value |
|--------|-------|
| **From** | kenneth johansson <ken@kenjo.org> |
| **To** | git@vger.kernel.org |
| **Date** | 2008-03-12T03:03:57Z |
| **Message-ID** | [fr7h6t$rji$1@ger.gmane.org](https://lore.kernel.org/git/fr7h6t$rji$1@ger.gmane.org) |

---

**Thread**: [thread](./03-03-57.thread.md#:~:text=2008/03/12/03-03-57)

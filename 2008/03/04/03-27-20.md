# [PATCH v2 1/3] git-pack-objects: Automatically pack annotated tags if object was packed

| Header | Value |
|--------|-------|
| **From** | Shawn O. Pearce <spearce@spearce.org> |
| **To** | Junio C Hamano <gitster@pobox.com> |
| **Date** | 2008-03-03T22:27:20-05:00 |
| **Message-ID** | [20080304032720.GA16462@spearce.org](https://lore.kernel.org/git/20080304032720.GA16462@spearce.org) |

---

**Thread**: [thread](./03-27-20.thread.md#:~:text=2008/03/04/03-27-20)

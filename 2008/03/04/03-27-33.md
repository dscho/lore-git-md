# [PATCH v2 2/3] Teach fetch-pack/upload-pack about --auto-include-tag

| Header | Value |
|--------|-------|
| **From** | Shawn O. Pearce <spearce@spearce.org> |
| **To** | Junio C Hamano <gitster@pobox.com> |
| **Date** | 2008-03-03T22:27:33-05:00 |
| **Message-ID** | [20080304032733.GB16462@spearce.org](https://lore.kernel.org/git/20080304032733.GB16462@spearce.org) |

---

**Thread**: [thread](./03-27-33.thread.md#:~:text=2008/03/04/03-27-33)

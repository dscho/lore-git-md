# [PATCH] Write diff output to a file in struct diff_options

| Header | Value |
|--------|-------|
| **From** | Daniel Barkalow <barkalow@iabervon.org> |
| **To** | Junio C Hamano <gitster@pobox.com> |
| **Date** | 2008-03-09T22:43:39-04:00 |
| **Message-ID** | [alpine.LNX.1.00.0803092235150.19665@iabervon.org](https://lore.kernel.org/git/alpine.LNX.1.00.0803092235150.19665@iabervon.org) |

---

**Thread**: [thread](./02-43-39.thread.md#:~:text=2008/03/10/02-43-39)

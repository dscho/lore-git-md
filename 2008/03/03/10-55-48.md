# [PATCH] git-p4: Fix import of changesets with file deletions

| Header | Value |
|--------|-------|
| **From** | Simon Hausmann <simon@lst.de> |
| **To** | Junio C Hamano <gitster@pobox.com> |
| **Date** | 2008-03-03T11:55:48+01:00 |
| **Message-ID** | [200803031155.51015.simon@lst.de](https://lore.kernel.org/git/200803031155.51015.simon@lst.de) |

---

**Thread**: [thread](./10-55-48.thread.md#:~:text=2008/03/03/10-55-48)

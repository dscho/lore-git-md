# [PATCH] git-fetch test: test tracking fetch results, not just FETCH_HEAD

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | Daniel Barkalow <barkalow@iabervon.org> |
| **Date** | 2008-03-26T01:33:31-07:00 |
| **Message-ID** | [7vwsnpevfo.fsf@gitster.siamese.dyndns.org](https://lore.kernel.org/git/7vwsnpevfo.fsf@gitster.siamese.dyndns.org) |

---

**Thread**: [thread](./../25/23-35-28.thread.md#:~:text=2008/03/26/08-33-31)

# [PATCH 3/4] Teach git mergetool to use custom commands defined at config time

| Header | Value |
|--------|-------|
| **From** | Charles Bailey <charles@hashpling.org> |
| **To** | Junio C Hamano <gitster@pobox.com> |
| **Date** | 2008-02-21T23:31:12Z |
| **Message-ID** | [0e0179231be0e23cc83fb72269def2f3de3ba420.1203636096.git.charles@hashpling.org](https://lore.kernel.org/git/0e0179231be0e23cc83fb72269def2f3de3ba420.1203636096.git.charles@hashpling.org) |

---

**Thread**: [thread](./23-30-02.thread.md#:~:text=2008/02/21/23-31-12)

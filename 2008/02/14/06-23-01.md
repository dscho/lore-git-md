# [PATCH 5/6] Add side-band-64k extension to send-pack/receive-pack for hook output

| Header | Value |
|--------|-------|
| **From** | Shawn O. Pearce <spearce@spearce.org> |
| **To** | git@vger.kernel.org |
| **Date** | 2008-02-14T01:23:01-05:00 |
| **Message-ID** | [20080214062301.GE30516@spearce.org](https://lore.kernel.org/git/20080214062301.GE30516@spearce.org) |

---

**Thread**: [thread](./06-23-01.thread.md#:~:text=2008/02/14/06-23-01)

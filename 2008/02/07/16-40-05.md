# [PATCH v2 06/11] Build-in merge-recursive

| Header | Value |
|--------|-------|
| **From** | Daniel Barkalow <barkalow@iabervon.org> |
| **To** | Junio C Hamano <junkio@cox.net> |
| **Date** | 2008-02-07T11:40:05-05:00 |
| **Message-ID** | [alpine.LNX.1.00.0802071130180.13593@iabervon.org](https://lore.kernel.org/git/alpine.LNX.1.00.0802071130180.13593@iabervon.org) |

---

**Thread**: [thread](./16-40-05.thread.md#:~:text=2008/02/07/16-40-05)

# [PATCH v2 02/11] Add flag to make unpack_trees() not print errors.

| Header | Value |
|--------|-------|
| **From** | Daniel Barkalow <barkalow@iabervon.org> |
| **To** | Junio C Hamano <junkio@cox.net> |
| **Date** | 2008-02-07T11:39:52-05:00 |
| **Message-ID** | [alpine.LNX.1.00.0802071118090.13593@iabervon.org](https://lore.kernel.org/git/alpine.LNX.1.00.0802071118090.13593@iabervon.org) |

---

**Thread**: [thread](./16-39-52.thread.md#:~:text=2008/02/07/16-39-52)

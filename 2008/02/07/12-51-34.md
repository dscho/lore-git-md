# [PATCH 4/4] git.el: Better handling of subprocess errors.

| Header | Value |
|--------|-------|
| **From** | Alexandre Julliard <julliard@winehq.org> |
| **To** | git@vger.kernel.org |
| **Date** | 2008-02-07T13:51:34+01:00 |
| **Message-ID** | [87myqdorop.fsf@wine.dyndns.org](https://lore.kernel.org/git/87myqdorop.fsf@wine.dyndns.org) |

---

**Thread**: [thread](./12-51-34.thread.md#:~:text=2008/02/07/12-51-34)

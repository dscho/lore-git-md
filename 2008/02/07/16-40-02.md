# [PATCH v2 05/11] Add "skip_unmerged" option to unpack_trees.

| Header | Value |
|--------|-------|
| **From** | Daniel Barkalow <barkalow@iabervon.org> |
| **To** | Junio C Hamano <junkio@cox.net> |
| **Date** | 2008-02-07T11:40:02-05:00 |
| **Message-ID** | [alpine.LNX.1.00.0802071129130.13593@iabervon.org](https://lore.kernel.org/git/alpine.LNX.1.00.0802071129130.13593@iabervon.org) |

---

**Thread**: [thread](./16-40-02.thread.md#:~:text=2008/02/07/16-40-02)

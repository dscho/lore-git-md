# [PATCH v2 03/11] Send unpack-trees debugging output to stderr

| Header | Value |
|--------|-------|
| **From** | Daniel Barkalow <barkalow@iabervon.org> |
| **To** | Junio C Hamano <junkio@cox.net> |
| **Date** | 2008-02-07T11:39:56-05:00 |
| **Message-ID** | [alpine.LNX.1.00.0802071127560.13593@iabervon.org](https://lore.kernel.org/git/alpine.LNX.1.00.0802071127560.13593@iabervon.org) |

---

**Thread**: [thread](./16-39-56.thread.md#:~:text=2008/02/07/16-39-56)

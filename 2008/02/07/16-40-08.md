# [PATCH v2 07/11] Move create_branch into a library file

| Header | Value |
|--------|-------|
| **From** | Daniel Barkalow <barkalow@iabervon.org> |
| **To** | Junio C Hamano <junkio@cox.net> |
| **Date** | 2008-02-07T11:40:08-05:00 |
| **Message-ID** | [alpine.LNX.1.00.0802071131100.13593@iabervon.org](https://lore.kernel.org/git/alpine.LNX.1.00.0802071131100.13593@iabervon.org) |

---

**Thread**: [thread](./16-40-08.thread.md#:~:text=2008/02/07/16-40-08)

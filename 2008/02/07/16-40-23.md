# [PATCH v2 11/11] Build in checkout

| Header | Value |
|--------|-------|
| **From** | Daniel Barkalow <barkalow@iabervon.org> |
| **To** | Junio C Hamano <junkio@cox.net> |
| **Date** | 2008-02-07T11:40:23-05:00 |
| **Message-ID** | [alpine.LNX.1.00.0802071137490.13593@iabervon.org](https://lore.kernel.org/git/alpine.LNX.1.00.0802071137490.13593@iabervon.org) |

---

**Thread**: [thread](./16-40-23.thread.md#:~:text=2008/02/07/16-40-23)

# [PATCH v2] git-gui: Automatically spell check commit messages as the user types

| Header | Value |
|--------|-------|
| **From** | Shawn O. Pearce <spearce@spearce.org> |
| **To** | git@vger.kernel.org |
| **Date** | 2008-02-07T02:52:50-05:00 |
| **Message-ID** | [20080207075250.GA24709@spearce.org](https://lore.kernel.org/git/20080207075250.GA24709@spearce.org) |

---

**Thread**: [thread](./07-52-50.thread.md#:~:text=2008/02/07/07-52-50)

# Re: [PATCH v2.5] Make git prune remove temporary packs that look like write failures

| Header | Value |
|--------|-------|
| **From** | Nicolas Pitre <nico@cam.org> |
| **To** | David Steven Tweed <d.s.tweed@reading.ac.uk> |
| **Date** | 2008-02-11T11:10:36-05:00 |
| **Message-ID** | [alpine.LFD.1.00.0802111109500.2732@xanadu.home](https://lore.kernel.org/git/alpine.LFD.1.00.0802111109500.2732@xanadu.home) |

---

**Thread**: [thread](./../07/02-55-14.thread.md#:~:text=2008/02/11/16-10-36)

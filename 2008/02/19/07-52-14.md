# [PATCH] Clean up reporting differences on branch switch

| Header | Value |
|--------|-------|
| **From** | Daniel Barkalow <barkalow@iabervon.org> |
| **To** | Junio C Hamano <gitster@pobox.com> |
| **Date** | 2008-02-19T02:52:14-05:00 |
| **Message-ID** | [alpine.LNX.1.00.0802190249540.5816@iabervon.org](https://lore.kernel.org/git/alpine.LNX.1.00.0802190249540.5816@iabervon.org) |

---

**Thread**: [thread](./07-52-14.thread.md#:~:text=2008/02/19/07-52-14)

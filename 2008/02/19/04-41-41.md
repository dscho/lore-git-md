# [PATCH 1/2] Use ALLOC_GROW in remote.{c,h}

| Header | Value |
|--------|-------|
| **From** | Daniel Barkalow <barkalow@iabervon.org> |
| **To** | Junio C Hamano <gitster@pobox.com> |
| **Date** | 2008-02-18T23:41:41-05:00 |
| **Message-ID** | [alpine.LNX.1.00.0802182316500.5816@iabervon.org](https://lore.kernel.org/git/alpine.LNX.1.00.0802182316500.5816@iabervon.org) |

---

**Thread**: [thread](./04-41-41.thread.md#:~:text=2008/02/19/04-41-41)

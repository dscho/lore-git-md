# [PATCH 1/3] tests: do not use implicit "git diff --no-index"

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <junio@pobox.com> |
| **To** | Johannes Schindelin <Johannes.Schindelin@gmx.de> |
| **Date** | 2008-05-24T00:25:45-07:00 |
| **Message-ID** | [7vmymgmadi.fsf@gitster.siamese.dyndns.org](https://lore.kernel.org/git/7vmymgmadi.fsf@gitster.siamese.dyndns.org) |

---

**Thread**: [thread](./../23/14-20-47.thread.md#:~:text=2008/05/24/07-25-45)

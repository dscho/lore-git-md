# Re: [PATCH] git-fast-import: rename cmd_*() functions to parse_*()

| Header | Value |
|--------|-------|
| **From** | Shawn O. Pearce <spearce@spearce.org> |
| **To** | Miklos Vajna <vmiklos@frugalware.org> |
| **Date** | 2008-05-15T18:59:18-04:00 |
| **Message-ID** | [20080515225918.GP29038@spearce.org](https://lore.kernel.org/git/20080515225918.GP29038@spearce.org) |

---

**Thread**: [thread](./22-35-56.thread.md#:~:text=2008/05/15/22-59-18)

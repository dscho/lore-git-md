# [PATCH] make verify-pack a bit more useful with bad packs

| Header | Value |
|--------|-------|
| **From** | Nicolas Pitre <nico@cam.org> |
| **To** | Junio C Hamano <gitster@pobox.com> |
| **Date** | 2008-05-29T17:34:50-04:00 |
| **Message-ID** | [alpine.LFD.1.10.0805291716470.23581@xanadu.home](https://lore.kernel.org/git/alpine.LFD.1.10.0805291716470.23581@xanadu.home) |

---

**Thread**: [thread](./21-34-50.thread.md#:~:text=2008/05/29/21-34-50)

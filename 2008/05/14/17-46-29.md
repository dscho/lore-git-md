# [PATCH 1/2] Rename path_list to string_list

| Header | Value |
|--------|-------|
| **From** | Johannes Schindelin <Johannes.Schindelin@gmx.de> |
| **To** | git@vger.kernel.org, gitster@pobox.com |
| **Date** | 2008-05-14T18:46:29+01:00 |
| **Message-ID** | [alpine.DEB.1.00.0805141846170.30431@racer](https://lore.kernel.org/git/alpine.DEB.1.00.0805141846170.30431@racer) |

---

**Thread**: [thread](./17-46-02.thread.md#:~:text=2008/05/14/17-46-29)

...
| **Date** | 2008-05-27T10:48:29+02:00 |
| **Message-ID** | [m3mymc2kv6.fsf@localhost.localdomain](https://lore.kernel.org/git/m3mymc2kv6.fsf@localhost.localdomain) |

---

**Thread**: [thread](./08-04-17.thread.md#:~:text=2008/05/27/08-48-29)

# [EGIT PATCH 1/3] FindToolbar port to the new history page.

| Header | Value |
|--------|-------|
| **From** | Roger C. Soares <rogersoares@intelinet.com.br> |
| **To** | git@vger.kernel.org |
| **Date** | 2008-04-06T17:41:49-04:00 |
| **Message-ID** | [1207518109-4174-1-git-send-email-rogersoares@intelinet.com.br](https://lore.kernel.org/git/1207518109-4174-1-git-send-email-rogersoares@intelinet.com.br) |

---

**Thread**: [thread](./21-41-49.thread.md#:~:text=2008/04/06/21-41-49)

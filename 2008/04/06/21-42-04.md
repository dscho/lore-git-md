# [EGIT PATCH 2/3] Change the find toolbar find-in prefs into radio rotating options.

| Header | Value |
|--------|-------|
| **From** | Roger C. Soares <rogersoares@intelinet.com.br> |
| **To** | git@vger.kernel.org |
| **Date** | 2008-04-06T17:42:04-04:00 |
| **Message-ID** | [1207518124-4194-1-git-send-email-rogersoares@intelinet.com.br](https://lore.kernel.org/git/1207518124-4194-1-git-send-email-rogersoares@intelinet.com.br) |

---

**Thread**: [thread](./21-42-04.thread.md#:~:text=2008/04/06/21-42-04)

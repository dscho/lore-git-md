# [PATCH 1/2] Make walker.fetch_ref() take a struct ref.

| Header | Value |
|--------|-------|
| **From** | Daniel Barkalow <barkalow@iabervon.org> |
| **To** | Junio C Hamano <gitster@pobox.com> |
| **Date** | 2008-04-26T15:53:09-04:00 |
| **Message-ID** | [alpine.LNX.1.00.0804261547200.19665@iabervon.org](https://lore.kernel.org/git/alpine.LNX.1.00.0804261547200.19665@iabervon.org) |

---

**Thread**: [thread](./19-53-09.thread.md#:~:text=2008/04/26/19-53-09)

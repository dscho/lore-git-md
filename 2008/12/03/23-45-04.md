# [PATCHv3 2/3 (resend)] gitweb: Split git_project_list_body in two functions

| Header | Value |
|--------|-------|
| **From** | Sebastien Cevey <seb@cine7.net> |
| **To** | git@vger.kernel.org |
| **Date** | 2008-12-04T00:45:04+01:00 |
| **Message-ID** | [87y6whp56g.wl%seb@cine7.net](https://lore.kernel.org/git/87y6whp56g.wl%seb@cine7.net) |

---

**Thread**: [thread](./23-45-04.thread.md#:~:text=2008/12/03/23-45-04)

# [PATCH v5] safecrlf: Add mechanism to warn about irreversible crlf conversions

| Header | Value |
|--------|-------|
| **From** | Steffen Prohaska <prohaska@zib.de> |
| **To** | Johannes.Schindelin@gmx.de, dpotapov@gmail.com, git@vger.kernel.org |
| **Date** | 2008-01-19T18:52:31+01:00 |
| **Message-ID** | [12007651514111-git-send-email-prohaska@zib.de](https://lore.kernel.org/git/12007651514111-git-send-email-prohaska@zib.de) |

---

**Thread**: [thread](./17-52-31.thread.md#:~:text=2008/01/19/17-52-31)

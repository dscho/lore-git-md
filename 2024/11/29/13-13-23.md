# [PATCH 02/10] compat/regex: explicitly ignore "-Wsign-compare" warnings

| Header | Value |
|--------|-------|
| **From** | Patrick Steinhardt <ps@pks.im> |
| **To** | git@vger.kernel.org |
| **Date** | 2024-11-29T14:13:23+01:00 |
| **Message-ID** | [20241129-pks-sign-compare-v1-2-fc406b984bc9@pks.im](https://lore.kernel.org/git/20241129-pks-sign-compare-v1-2-fc406b984bc9@pks.im) |

---

**Thread**: [thread](./13-13-21.thread.md#:~:text=2024/11/29/13-13-23)

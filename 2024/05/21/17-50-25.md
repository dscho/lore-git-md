...
| **To** | tboegi@web.de |
| **Date** | 2024-05-21T10:50:25-07:00 |
| **Message-ID** | [xmqqttir9hr2.fsf@gitster.g](https://lore.kernel.org/git/xmqqttir9hr2.fsf@gitster.g) |

---

**Thread**: [thread](./14-14-52.thread.md#:~:text=2024/05/21/17-50-25)

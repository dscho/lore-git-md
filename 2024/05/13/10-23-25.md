# [PATCH v2 17/21] builtin/config: convert `key_regexp` to a local variable

| Header | Value |
|--------|-------|
| **From** | Patrick Steinhardt <ps@pks.im> |
| **To** | git@vger.kernel.org |
| **Date** | 2024-05-13T12:23:25+02:00 |
| **Message-ID** | [323cb051205fdde86eb3e996d0a9fc089780eaee.1715595550.git.ps@pks.im](https://lore.kernel.org/git/323cb051205fdde86eb3e996d0a9fc089780eaee.1715595550.git.ps@pks.im) |

---

**Thread**: [thread](./../10/11-24-23.thread.md#:~:text=2024/05/13/10-23-25)

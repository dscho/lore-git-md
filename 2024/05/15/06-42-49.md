# [PATCH v3 16/21] builtin/config: convert `regexp` to a local variable

| Header | Value |
|--------|-------|
| **From** | Patrick Steinhardt <ps@pks.im> |
| **To** | git@vger.kernel.org |
| **Date** | 2024-05-15T08:42:49+02:00 |
| **Message-ID** | [bac242caf0ed8167ee84dccc183e825652f65f0c.1715755055.git.ps@pks.im](https://lore.kernel.org/git/bac242caf0ed8167ee84dccc183e825652f65f0c.1715755055.git.ps@pks.im) |

---

**Thread**: [thread](./../10/11-24-23.thread.md#:~:text=2024/05/15/06-42-49)

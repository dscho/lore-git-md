# Re: [PATCH v2 1/3] rev-list: refactor --missing=<missing-action>

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | Christian Couder <christian.couder@gmail.com> |
| **Date** | 2024-05-15T09:16:04-07:00 |
| **Message-ID** | [xmqq4jaz1263.fsf@gitster.g](https://lore.kernel.org/git/xmqq4jaz1263.fsf@gitster.g) |

---

**Thread**: [thread](./../../../2022/10/12/13-51-11.thread.md#:~:text=2024/05/15/16-16-04)

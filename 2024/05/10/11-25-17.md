...
| **Date** | 2024-05-10T13:25:17+02:00 |
| **Message-ID** | [96108976627fbb4b650156538441e2f3f5a8a490.1715339393.git.ps@pks.im](https://lore.kernel.org/git/96108976627fbb4b650156538441e2f3f5a8a490.1715339393.git.ps@pks.im) |

---

**Thread**: [thread](./11-24-23.thread.md#:~:text=2024/05/10/11-25-17)
...
@@ -1242,7 +1240,7 @@ static int cmd_config_actions(int argc, const char **argv, const char *prefix)
...
@@ -1251,7 +1249,7 @@ static int cmd_config_actions(int argc, const char **argv, const char *prefix)
...
+		value = normalize_value(argv[0], argv[1], display_opts.type, &default_kvi);
 		ret = git_config_set_multivar_in_file_gently(location_opts.source.file,
 							     argv[0], value, argv[2],
 							     comment, flags);
@@ -1259,7 +1257,7 @@ static int cmd_config_actions(int argc, const char **argv, const char *prefix)
...
+		value = normalize_value(argv[0], argv[1], display_opts.type, &default_kvi);
 		ret = git_config_set_multivar_in_file_gently(location_opts.source.file,
 							     argv[0], value,
 							     CONFIG_REGEX_NONE,
@@ -1268,7 +1266,7 @@ static int cmd_config_actions(int argc, const char **argv, const char *prefix)

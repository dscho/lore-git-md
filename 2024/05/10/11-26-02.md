...
| **Date** | 2024-05-10T13:26:02+02:00 |
| **Message-ID** | [05254d512b890b4422a72f0fa17794a237a5bf8f.1715339393.git.ps@pks.im](https://lore.kernel.org/git/05254d512b890b4422a72f0fa17794a237a5bf8f.1715339393.git.ps@pks.im) |

---

**Thread**: [thread](./11-24-23.thread.md#:~:text=2024/05/10/11-26-02)
...
+				get_value_flags, flags);
 	...
 	return ret;
@@ -1284,19 +1294,19 @@ static int cmd_config_actions(int argc, const char **argv, const char *prefix)
 	}

# [PATCH 18/21] builtin/config: convert `key` to a local variable

| Header | Value |
|--------|-------|
| **From** | Patrick Steinhardt <ps@pks.im> |
| **To** | git@vger.kernel.org |
| **Date** | 2024-05-10T13:25:51+02:00 |
| **Message-ID** | [2aee7ec5d8dcd301decec75c6d0fd49da700ac3a.1715339393.git.ps@pks.im](https://lore.kernel.org/git/2aee7ec5d8dcd301decec75c6d0fd49da700ac3a.1715339393.git.ps@pks.im) |

---

**Thread**: [thread](./11-24-23.thread.md#:~:text=2024/05/10/11-25-51)

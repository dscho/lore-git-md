# [PATCH 10/21] builtin/config: move display options into local variables

| Header | Value |
|--------|-------|
| **From** | Patrick Steinhardt <ps@pks.im> |
| **To** | git@vger.kernel.org |
| **Date** | 2024-05-10T13:25:12+02:00 |
| **Message-ID** | [06c1e08fc49ff5fbf5346ae9b20df045bdb5e7ff.1715339393.git.ps@pks.im](https://lore.kernel.org/git/06c1e08fc49ff5fbf5346ae9b20df045bdb5e7ff.1715339393.git.ps@pks.im) |

---

**Thread**: [thread](./11-24-23.thread.md#:~:text=2024/05/10/11-25-12)
...
+	if (display_opts.show_origin && !(actions &
 		...
 		error(_("--show-origin is only applicable to --get, --get-all, "
 			"--get-regexp, and --list"));
@@ -1195,7 +1226,7 @@ static int cmd_config_actions(int argc, const char **argv, const char *prefix)
...
+		if (config_with_options(show_all_config, &display_opts,
 					...
 					&location_opts.options) < 0) {
 			if (location_opts.source.file)
@@ -1244,23 +1275,23 @@ static int cmd_config_actions(int argc, const char **argv, const char *prefix)
 	}

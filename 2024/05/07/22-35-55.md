# Re: [PATCH] Documentation/git-merge-tree.txt: document -X

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | Victoria Dye via GitGitGadget <gitgitgadget@gmail.com> |
| **Date** | 2024-05-07T15:35:55-07:00 |
| **Message-ID** | [xmqqh6f9ntbo.fsf@gitster.g](https://lore.kernel.org/git/xmqqh6f9ntbo.fsf@gitster.g) |

---

**Thread**: [thread](./21-36-29.thread.md#:~:text=2024/05/07/22-35-55)

...
| **Date** | 2024-05-07T06:52:56+02:00 |
| **Message-ID** | [1a0859eaf118090b4d172792e63ee9a6ba752b71.1715057362.git.ps@pks.im](https://lore.kernel.org/git/1a0859eaf118090b4d172792e63ee9a6ba752b71.1715057362.git.ps@pks.im) |

---

**Thread**: [thread](./../../04/19/09-51-03.thread.md#:~:text=2024/05/07/04-52-56)
...
@@ -28,9 +29,9 @@ int parse_opt_abbrev_cb(const struct option *opt, const char *arg, int unset)

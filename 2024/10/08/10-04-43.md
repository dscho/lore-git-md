# [ANNOUNCE] Git for Windows 2.47.0

| Header | Value |
|--------|-------|
| **From** | Johannes Schindelin <johannes.schindelin@gmx.de> |
| **To** | git-for-windows@googlegroups.com, git@vger.kernel.org, git-packagers@googlegroups.com |
| **Date** | 2024-10-08T10:04:43Z |
| **Message-ID** | [20241008100443.3377-1-johannes.schindelin@gmx.de](https://lore.kernel.org/git/20241008100443.3377-1-johannes.schindelin@gmx.de) |

---

**Thread**: [thread](./10-04-43.thread.md#:~:text=2024/10/08/10-04-43)

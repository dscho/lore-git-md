# [PATCH v4] doc: fix the max number of git show-branches shown

| Header | Value |
|--------|-------|
| **From** | Rikita Ishikawa via GitGitGadget <gitgitgadget@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2024-07-07T02:28:31Z |
| **Message-ID** | [pull.1757.v4.git.1720319311301.gitgitgadget@gmail.com](https://lore.kernel.org/git/pull.1757.v4.git.1720319311301.gitgitgadget@gmail.com) |

---

**Thread**: [thread](./../03/22-36-25.thread.md#:~:text=2024/07/07/02-28-31)

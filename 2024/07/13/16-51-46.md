# [PATCH v3] merge-recursive: honor diff.algorithm

| Header | Value |
|--------|-------|
| **From** | Antonin Delpeuch via GitGitGadget <gitgitgadget@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2024-07-13T16:51:46Z |
| **Message-ID** | [pull.1743.v3.git.git.1720889507066.gitgitgadget@gmail.com](https://lore.kernel.org/git/pull.1743.v3.git.git.1720889507066.gitgitgadget@gmail.com) |

---

**Thread**: [thread](./../08/09-34-48.thread.md#:~:text=2024/07/13/16-51-46)

# [PATCH v2] merge-recursive: honor diff.algorithm

| Header | Value |
|--------|-------|
| **From** | Antonin Delpeuch via GitGitGadget <gitgitgadget@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2024-07-09T19:01:41Z |
| **Message-ID** | [pull.1743.v2.git.git.1720551701648.gitgitgadget@gmail.com](https://lore.kernel.org/git/pull.1743.v2.git.git.1720551701648.gitgitgadget@gmail.com) |

---

**Thread**: [thread](./../08/09-34-48.thread.md#:~:text=2024/07/09/19-01-41)

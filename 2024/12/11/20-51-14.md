# [PATCH v3] bundle: remove unneeded code

| Header | Value |
|--------|-------|
| **From** | Toon Claes <toon@iotcl.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2024-12-11T21:51:14+01:00 |
| **Message-ID** | [20241211-fix-bundle-create-race-v3-1-0587f6f9db1b@iotcl.com](https://lore.kernel.org/git/20241211-fix-bundle-create-race-v3-1-0587f6f9db1b@iotcl.com) |

---

**Thread**: [thread](./09-28-15.thread.md#:~:text=2024/12/11/20-51-14)

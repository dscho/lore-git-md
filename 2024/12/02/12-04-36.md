...
| **Date** | 2024-12-02T13:04:36+01:00 |
| **Message-ID** | [20241202-pks-sign-compare-v2-4-e7f0ad92a749@pks.im](https://lore.kernel.org/git/20241202-pks-sign-compare-v2-4-e7f0ad92a749@pks.im) |

---

**Thread**: [thread](./../../11/29/13-13-21.thread.md#:~:text=2024/12/02/12-04-36)
...
```
 ...
 xdiff/xdiffi.c                       | 1 +
 xdiff/xinclude.h                     | 2 ++
 264 files changed, 438 insertions(+), 2 deletions(-)

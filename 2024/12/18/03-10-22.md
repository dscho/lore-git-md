# [PATCH v3] git: use signed loop counters when comparing with signed vars

| Header | Value |
|--------|-------|
| **From** | AreaZR via GitGitGadget <gitgitgadget@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2024-12-18T03:10:22Z |
| **Message-ID** | [pull.1843.v3.git.git.1734491422385.gitgitgadget@gmail.com](https://lore.kernel.org/git/pull.1843.v3.git.git.1734491422385.gitgitgadget@gmail.com) |

---

**Thread**: [thread](./00-15-52.thread.md#:~:text=2024/12/18/03-10-22)

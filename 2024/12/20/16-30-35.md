# [PATCH v2] meson: skip gitweb build when Perl is disabled

| Header | Value |
|--------|-------|
| **From** | Patrick Steinhardt <ps@pks.im> |
| **To** | git@vger.kernel.org |
| **Date** | 2024-12-20T17:30:35+01:00 |
| **Message-ID** | [20241220-b4-pks-meson-fix-gitweb-wo-perl-v2-1-18ab23dd6446@pks.im](https://lore.kernel.org/git/20241220-b4-pks-meson-fix-gitweb-wo-perl-v2-1-18ab23dd6446@pks.im) |

---

**Thread**: [thread](./07-26-30.thread.md#:~:text=2024/12/20/16-30-35)

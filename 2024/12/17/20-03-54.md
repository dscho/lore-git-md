# Re: [ANNOUNCE] Git for Windows 2.48.0-rc0

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | Johannes Schindelin <johannes.schindelin@gmx.de> |
| **Date** | 2024-12-17T12:03:54-08:00 |
| **Message-ID** | [xmqq34im13h1.fsf@gitster.g](https://lore.kernel.org/git/xmqq34im13h1.fsf@gitster.g) |

---

**Thread**: [thread](./12-48-19.thread.md#:~:text=2024/12/17/20-03-54)

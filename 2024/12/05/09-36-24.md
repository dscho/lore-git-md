# [PATCH v3 02/15] compat/regex: explicitly ignore "-Wsign-compare" warnings

| Header | Value |
|--------|-------|
| **From** | Patrick Steinhardt <ps@pks.im> |
| **To** | git@vger.kernel.org |
| **Date** | 2024-12-05T10:36:24+01:00 |
| **Message-ID** | [20241205-pks-sign-compare-v3-2-e211ee089717@pks.im](https://lore.kernel.org/git/20241205-pks-sign-compare-v3-2-e211ee089717@pks.im) |

---

**Thread**: [thread](./../../11/29/13-13-21.thread.md#:~:text=2024/12/05/09-36-24)

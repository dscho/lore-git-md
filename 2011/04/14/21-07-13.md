...
| **Date** | 2011-04-15T00:07:13+03:00 |
| **Message-ID** | [bff33bffb02487b123d280a0f3fe9ac0cdd9cda6.1302815124.git.jari.aalto@cante.net](https://lore.kernel.org/git/bff33bffb02487b123d280a0f3fe9ac0cdd9cda6.1302815124.git.jari.aalto@cante.net) |

---

**Thread**: [thread](./../../03/22/13-30-51.thread.md#:~:text=2011/04/14/21-07-13)
...
```
  ...
  ** no need to refresh the status files on push or fetch
  ...
  [v4]
  ** Parse remotes from .git/config and offer them as completions (push/pull)
...
-;;  - fetch/pull
 ...
 ;;
@@ -384,6 +388,25 @@ the process output as a string, or nil if the git command failed."
   (git-get-string-sha1

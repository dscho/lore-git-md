# Re: Weird behaviour when importing from a subversion repository (empty dir/ambiguous argument)

| Header | Value |
|--------|-------|
| **From** | Michael J Gruber <git@drmicha.warpmail.net> |
| **To** | HH-developing@heigl-online.at |
| **Date** | 2011-04-11T09:01:54+02:00 |
| **Message-ID** | [4DA2A762.1020203@drmicha.warpmail.net](https://lore.kernel.org/git/4DA2A762.1020203@drmicha.warpmail.net) |

---

**Thread**: [thread](./../10/10-28-19.thread.md#:~:text=2011/04/11/07-01-54)
...
In several places, "git svn" assumes that "A^ B" makes sense, particular
...
You could first clone up to and including r157, and then fetch from r160

# Re: [PATCH v2] submodule: Add --force option for git submodule update

| Header | Value |
|--------|-------|
| **From** | Jens Lehmann <Jens.Lehmann@web.de> |
| **To** | Nicolas Morey-Chaisemartin <nmorey@kalray.eu> |
| **Date** | 2011-04-03T21:21:58+02:00 |
| **Message-ID** | [4D98C8D6.3050406@web.de](https://lore.kernel.org/git/4D98C8D6.3050406@web.de) |

---

**Thread**: [thread](./../01/09-42-03.thread.md#:~:text=2011/04/03/19-21-58)

# [PATCH v3] contrib/emacs/git.el: Add user functions for push, pull, fetch

| Header | Value |
|--------|-------|
| **From** | jari.aalto@cante.net |
| **To** | git@vger.kernel.org |
| **Date** | 2011-04-03T20:48:00+03:00 |
| **Message-ID** | [ae4f9adf62502f58a870a322cd30a62e23aba747.1301852577.git.jari.aalto@cante.net](https://lore.kernel.org/git/ae4f9adf62502f58a870a322cd30a62e23aba747.1301852577.git.jari.aalto@cante.net) |

---

**Thread**: [thread](./../../03/22/13-30-51.thread.md#:~:text=2011/04/03/17-48-00)

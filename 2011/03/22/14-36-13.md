# [PATCH v2] contrib/emacs/git.el: Add user functions for push, pull, fetch

| Header | Value |
|--------|-------|
| **From** | jari.aalto@cante.net |
| **To** | git@vger.kernel.org |
| **Date** | 2011-03-22T16:36:13+02:00 |
| **Message-ID** | [d40ef57d7e6d75c41a4d1f8e51bdd892351f3aee.1300804459.git.jari.aalto@cante.net](https://lore.kernel.org/git/d40ef57d7e6d75c41a4d1f8e51bdd892351f3aee.1300804459.git.jari.aalto@cante.net) |

---

**Thread**: [thread](./13-30-51.thread.md#:~:text=2011/03/22/14-36-13)

# [PATCH v3 6/7] submodule update: Don't fetch when the submodule commit is already present

| Header | Value |
|--------|-------|
| **From** | Jens Lehmann <Jens.Lehmann@web.de> |
| **To** | Git Mailing List <git@vger.kernel.org> |
| **Date** | 2011-03-06T23:13:36+01:00 |
| **Message-ID** | [4D740710.8080407@web.de](https://lore.kernel.org/git/4D740710.8080407@web.de) |

---

**Thread**: [thread](./22-09-32.thread.md#:~:text=2011/03/06/22-13-36)

...
| **Date** | 2011-03-02T00:01:06+01:00 |
| **Message-ID** | [4D6D7AB2.4010509@web.de](https://lore.kernel.org/git/4D6D7AB2.4010509@web.de) |

---

**Thread**: [thread](./22-59-28.thread.md#:~:text=2011/03/01/23-01-06)
...
+			int arg = parse_fetch_recurse_submodules_arg("--submodule-default", submodule_default);

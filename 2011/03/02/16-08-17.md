# Re: [PATCH v2 5/7] fetch/pull: Don't recurse into a submodule when commits are already present

| Header | Value |
|--------|-------|
| **From** | Marc Branchaud <marcnarc@xiplink.com> |
| **To** | Jens Lehmann <Jens.Lehmann@web.de> |
| **Date** | 2011-03-02T11:08:17-05:00 |
| **Message-ID** | [4D6E6B71.2030800@xiplink.com](https://lore.kernel.org/git/4D6E6B71.2030800@xiplink.com) |

---

**Thread**: [thread](./../01/22-59-28.thread.md#:~:text=2011/03/02/16-08-17)

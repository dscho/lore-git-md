...
| **Date** | 2011-12-04T06:20:26+02:00 |
| **Message-ID** | [1322972426-7591-1-git-send-email-kirill@shutemov.name](https://lore.kernel.org/git/1322972426-7591-1-git-send-email-kirill@shutemov.name) |

---

**Thread**: [thread](./04-20-26.thread.md#:~:text=2011/12/04/04-20-26)

...
| **Date** | 2011-02-17T00:50:50-05:00 |
| **Message-ID** | [1297921850-94962-1-git-send-email-jaysoffian@gmail.com](https://lore.kernel.org/git/1297921850-94962-1-git-send-email-jaysoffian@gmail.com) |

---

**Thread**: [thread](./04-18-41.thread.md#:~:text=2011/02/17/05-50-50)
...
---
On Thu, Feb 17, 2011 at 12:19 AM, Jonathan Nieder <jrnieder@gmail.com> wrote:
...
+
 ...
 {
 	switch (commit_style) {
@@ -378,8 +421,8 @@ static char *prepare_index(int argc, const char **argv, const char *prefix, int
 	 */
...
@@ -469,18 +512,18 @@ static void determine_author_info(struct strbuf *author_ident)
...
@@ -641,11 +684,15 @@ static int prepare_to_commit(const char *index_file, const char *prefix,
 	}
...
+	}
 	...
 	if (squash_message) {
 		/*
@@ -694,16 +741,18 @@ static int prepare_to_commit(const char *index_file, const char *prefix,
...
@@ -766,11 +815,19 @@ static int prepare_to_commit(const char *index_file, const char *prefix,

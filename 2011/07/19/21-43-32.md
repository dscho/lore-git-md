# [PATCH v2] tests: cleanup binary test vector files

| Header | Value |
|--------|-------|
| **From** | Vitaliy Ivanov <vitalivanov@gmail.com> |
| **To** | Junio C Hamano <gitster@pobox.com> |
| **Date** | 2011-07-20T00:43:32+03:00 |
| **Message-ID** | [1311111812.1659.4.camel@vitaliy-Vostro-1400](https://lore.kernel.org/git/1311111812.1659.4.camel@vitaliy-Vostro-1400) |

---

**Thread**: [thread](./17-21-47.thread.md#:~:text=2011/07/19/21-43-32)
...
```
 ...
 t/{test4012.png => test-binary-1.png}  |  Bin 5660 -> 5660 bytes
 t/{test9200b.png => test-binary-2.png} |  Bin 275 -> 275 bytes
 t/test9200a.png                        |  Bin 5660 -> 0 bytes
 8 files changed, 13 insertions(+), 13 deletions(-)
 rename t/{test4012.png => test-binary-1.png} (100%)
 rename t/{test9200b.png => test-binary-2.png} (100%)

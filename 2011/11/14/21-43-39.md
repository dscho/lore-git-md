...
| **Date** | 2011-11-14T23:43:39+02:00 |
| **Message-ID** | [1321307019-5557-1-git-send-email-kirill@shutemov.name](https://lore.kernel.org/git/1321307019-5557-1-git-send-email-kirill@shutemov.name) |

---

**Thread**: [thread](./21-43-39.thread.md#:~:text=2011/11/14/21-43-39)

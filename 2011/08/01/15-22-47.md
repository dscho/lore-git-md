# Possibly solved invalid free() in git-remote-http from Git 1.7.2.1

| Header | Value |
|--------|-------|
| **From** | Ævar Arnfjörð Bjarmason <avarab@gmail.com> |
| **To** | Git Mailing List <git@vger.kernel.org> |
| **Date** | 2011-08-01T17:22:47+02:00 |
| **Message-ID** | [CACBZZX7s+NeH2jLC9Ym65_rMQkgVmfbCAkqZbBFhTiY9U8uP2A@mail.gmail.com](https://lore.kernel.org/git/CACBZZX7s+NeH2jLC9Ym65_rMQkgVmfbCAkqZbBFhTiY9U8uP2A@mail.gmail.com) |

---

**Thread**: [thread](./15-22-47.thread.md#:~:text=2011/08/01/15-22-47)

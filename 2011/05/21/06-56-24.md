# [PATCH v3 01/12] packed_object_info_detail(): do not return a string

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2011-05-20T23:56:24-07:00 |
| **Message-ID** | [1305960995-25738-2-git-send-email-gitster@pobox.com](https://lore.kernel.org/git/1305960995-25738-2-git-send-email-gitster@pobox.com) |

---

**Thread**: [thread](./06-56-23.thread.md#:~:text=2011/05/21/06-56-24)

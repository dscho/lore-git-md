# [PATCH] git-p4: warn if git authorship won't be retained

| Header | Value |
|--------|-------|
| **From** | Luke Diamand <luke@diamand.org> |
| **To** | git@vger.kernel.org |
| **Date** | 2011-05-10T20:27:33+01:00 |
| **Message-ID** | [1305055653-5133-2-git-send-email-luke@diamand.org](https://lore.kernel.org/git/1305055653-5133-2-git-send-email-luke@diamand.org) |

---

**Thread**: [thread](./19-27-32.thread.md#:~:text=2011/05/10/19-27-33)

# [PATCH] Modify git stash tests to show failure with sparse checkouts

| Header | Value |
|--------|-------|
| **From** | Christof Krüger <git@christof-krueger.de> |
| **To** | git@vger.kernel.org |
| **Date** | 2011-06-30T21:06:38+02:00 |
| **Message-ID** | [1309460798-17526-1-git-send-email-git@christof-krueger.de](https://lore.kernel.org/git/1309460798-17526-1-git-send-email-git@christof-krueger.de) |

---

**Thread**: [thread](./19-06-38.thread.md#:~:text=2011/06/30/19-06-38)

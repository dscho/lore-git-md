# [PATCHv6 1/4] Fix prefix handling in ref iteration functions

| Header | Value |
|--------|-------|
| **From** | Jamey Sharp <jamey@minilop.net> |
| **To** | Junio C Hamano <gitster@pobox.com> |
| **Date** | 2011-06-03T17:11:40-07:00 |
| **Message-ID** | [1307146303-4524-2-git-send-email-jamey@minilop.net](https://lore.kernel.org/git/1307146303-4524-2-git-send-email-jamey@minilop.net) |

---

**Thread**: [thread](./00-11-39.thread.md#:~:text=2011/06/04/00-11-40)

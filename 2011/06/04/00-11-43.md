# [PATCHv6 4/4] Add documentation for ref namespaces

| Header | Value |
|--------|-------|
| **From** | Jamey Sharp <jamey@minilop.net> |
| **To** | Junio C Hamano <gitster@pobox.com> |
| **Date** | 2011-06-03T17:11:43-07:00 |
| **Message-ID** | [1307146303-4524-5-git-send-email-jamey@minilop.net](https://lore.kernel.org/git/1307146303-4524-5-git-send-email-jamey@minilop.net) |

---

**Thread**: [thread](./00-11-39.thread.md#:~:text=2011/06/04/00-11-43)

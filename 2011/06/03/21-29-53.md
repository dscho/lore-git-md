# [PATCHv5 4/4] Add documentation for ref namespaces

| Header | Value |
|--------|-------|
| **From** | Jamey Sharp <jamey@minilop.net> |
| **To** | Junio C Hamano <gitster@pobox.com> |
| **Date** | 2011-06-03T14:29:53-07:00 |
| **Message-ID** | [1307136593-16306-5-git-send-email-jamey@minilop.net](https://lore.kernel.org/git/1307136593-16306-5-git-send-email-jamey@minilop.net) |

---

**Thread**: [thread](./21-29-49.thread.md#:~:text=2011/06/03/21-29-53)

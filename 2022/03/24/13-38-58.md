# Re: [PATCH] test-lib: have --immediate emit valid TAP on failure

| Header | Value |
|--------|-------|
| **From** | Johannes Schindelin <Johannes.Schindelin@gmx.de> |
| **To** | Ævar Arnfjörð Bjarmason <avarab@gmail.com> |
| **Date** | 2022-03-24T14:38:58+01:00 |
| **Message-ID** | [nycvar.QRO.7.76.6.2203241434360.388@tvgsbejvaqbjf.bet](https://lore.kernel.org/git/nycvar.QRO.7.76.6.2203241434360.388@tvgsbejvaqbjf.bet) |

---

**Thread**: [thread](./../23/20-51-31.thread.md#:~:text=2022/03/24/13-38-58)

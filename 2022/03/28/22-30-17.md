# [PATCH v7 2/4] vimdiff: integrate layout tests in the unit tests framework ('t' folder)

| Header | Value |
|--------|-------|
| **From** | Fernando Ramos <greenfoo@u92.eu> |
| **To** | git@vger.kernel.org |
| **Date** | 2022-03-29T00:30:17+02:00 |
| **Message-ID** | [20220328223019.271270-3-greenfoo@u92.eu](https://lore.kernel.org/git/20220328223019.271270-3-greenfoo@u92.eu) |

---

**Thread**: [thread](./22-30-15.thread.md#:~:text=2022/03/28/22-30-17)

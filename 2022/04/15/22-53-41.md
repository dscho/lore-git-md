# RE: What's cooking in git.git (Apr 2022, #04; Thu, 14)

| Header | Value |
|--------|-------|
| **From** | rsbecker@nexbridge.com |
| **To** | 'Emily Shaffer' <emilyshaffer@google.com>, 'Junio C Hamano' <gitster@pobox.com> |
| **Date** | 2022-04-15T18:53:41-04:00 |
| **Message-ID** | [00a001d8511b$aa547c20$fefd7460$@nexbridge.com](https://lore.kernel.org/git/00a001d8511b$aa547c20$fefd7460$@nexbridge.com) |

---

**Thread**: [thread](./00-06-26.thread.md#:~:text=2022/04/15/22-53-41)

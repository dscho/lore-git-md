# Re: Setting up `send-email` for SSL, and then using GCM (Git Credential Manager)

| Header | Value |
|--------|-------|
| **From** | Philip Oakley <philipoakley@iee.email> |
| **To** | Ævar Arnfjörð Bjarmason <avarab@gmail.com>, Git List <git@vger.kernel.org> |
| **Date** | 2022-04-16T16:14:17+01:00 |
| **Message-ID** | [2f8567f7-6d9c-e79b-9a05-7dd55cb40224@iee.email](https://lore.kernel.org/git/2f8567f7-6d9c-e79b-9a05-7dd55cb40224@iee.email) |

---

**Thread**: [thread](./11-38-06.thread.md#:~:text=2022/04/16/15-14-17)

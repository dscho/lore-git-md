...
| **Date** | 2022-08-05T14:09:08-07:00 |
| **Message-ID** | [xmqqedxuz9cb.fsf@gitster.g](https://lore.kernel.org/git/xmqqedxuz9cb.fsf@gitster.g) |

---

**Thread**: [thread](./14-15-33.thread.md#:~:text=2022/08/05/21-09-08)
...
Ævar, thanks for a quick fix.  This will have to go on top of

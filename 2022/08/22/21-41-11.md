# Re: [PATCH v2 1/1] pathspec: fix memleak

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | Anthony Delannoy <anthony.2lannoy@gmail.com> |
| **Date** | 2022-08-22T14:41:11-07:00 |
| **Message-ID** | [xmqq4jy4ard4.fsf@gitster.g](https://lore.kernel.org/git/xmqq4jy4ard4.fsf@gitster.g) |

---

**Thread**: [thread](./21-15-06.thread.md#:~:text=2022/08/22/21-41-11)

...
| **To** | Eric DeCosta via GitGitGadget <gitgitgadget@gmail.com>, Jeff Hostetler <jeffhost@microsoft.com> |
| **Date** | 2022-08-10T09:49:31-07:00 |
| **Message-ID** | [xmqqmtccniw4.fsf@gitster.g](https://lore.kernel.org/git/xmqqmtccniw4.fsf@gitster.g) |

---

**Thread**: [thread](./../09/17-44-09.thread.md#:~:text=2022/08/10/16-49-31)

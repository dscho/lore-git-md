...
| **Date** | 2022-12-29T16:11:50Z |
| **Message-ID** | [pull.1399.v12.git.git.1672330310586.gitgitgadget@gmail.com](https://lore.kernel.org/git/pull.1399.v12.git.git.1672330310586.gitgitgadget@gmail.com) |

---

**Thread**: [thread](./../16/02-29-25.thread.md#:~:text=2022/12/29/16-11-50)
...
Published-As: https://github.com/gitgitgadget/git/releases/tag/pr-git-1399%2FAtariDreams%2Ffix-type-v12
Fetch-It-Via: git fetch https://github.com/gitgitgadget/git pr-git-1399/AtariDreams/fix-type-v12
Pull-Request: https://github.com/git/git/pull/1399

Range-diff vs v11:

```
 1:  ba551274887 ! 1:  7bcc1e37099 git: edit variable types to match what is assigned to them
...
```
 ...
 strbuf.c                      |  2 +-
 xdiff-interface.c             |  6 ++---
 24 files changed, 112 insertions(+), 96 deletions(-)

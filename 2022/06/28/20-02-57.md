...
| **Date** | 2022-06-28T20:02:57Z |
| **Message-ID** | [pull.1270.v2.git.1656446577611.gitgitgadget@gmail.com](https://lore.kernel.org/git/pull.1270.v2.git.1656446577611.gitgitgadget@gmail.com) |

---

**Thread**: [thread](./../27/21-21-01.thread.md#:~:text=2022/06/28/20-02-57)
...
Published-As: https://github.com/gitgitgadget/git/releases/tag/pr-1270%2Fderrickstolee%2Frebase-docs-v2
Fetch-It-Via: git fetch https://github.com/gitgitgadget/git pr-1270/derrickstolee/rebase-docs-v2
Pull-Request: https://github.com/gitgitgadget/git/pull/1270

Range-diff vs v1:

```
 1:  71520dc1b71 ! 1:  02983cdb79d git-rebase.txt: use back-ticks consistently
     @@ Commit message
          adding back-ticks as appropriate. Some are adding back-ticks where there
          was no punctuation. Others are replacing single quotes.
     ...
     @@ Documentation/git-rebase.txt: SYNOPSIS
     ...
     + have different committer information):
      @@ Documentation/git-rebase.txt: would result in the removal of commits F and G:
       ------------
       
     @@ Documentation/git-rebase.txt: flag exists as a convenient shortcut, such as for
       +
     ...
     @@ Documentation/git-rebase.txt: See also INCOMPATIBLE OPTIONS below.
      ...
      @@ Documentation/git-rebase.txt: See also REBASING MERGES and INCOMPATIBLE OPTIONS below.
     - 
       -x <cmd>::
       --exec <cmd>::
     ...
     @@ Documentation/git-rebase.txt: subtle differences in how these two backends behav
       ~~~~~~~~~~~~~
     ...
     @@ Documentation/git-rebase.txt: Directory rename detection
     ...
     @@ Documentation/git-rebase.txt: order to apply the changes to the right lines.  Ho
     ...
     @@ Documentation/git-rebase.txt: Labelling of conflicts markers
     ...
     @@ Documentation/git-rebase.txt: calling either of these hooks in the future.
       ~~~~~~~~~~~~~~~~
     ...
     ++subsequent `git rebase --abort`.  The 'merge' backend does not appear to
       ...
       details.)
     @@ Documentation/git-rebase.txt: When a conflict occurs while rebasing, rebase stop
     ...
     ++the 'apply' backend blindly applies the original commit message.
       ...
       ~~~~~~~~~~~~~~~~~~~~~~~~~
     @@ Documentation/git-rebase.txt: completeness:
       below.
...
```
 Documentation/git-rebase.txt | 244 ++++++++++++++++++-----------------
...
index 262fb01aec0..f4fdfa16f57 100644

...
| **Date** | 2022-01-07T11:53:39+01:00 |
| **Message-ID** | [c46f42a3a3cbf8e1fc523093f733846d52bf59d3.1641551066.git.ps@pks.im](https://lore.kernel.org/git/c46f42a3a3cbf8e1fc523093f733846d52bf59d3.1641551066.git.ps@pks.im) |

---

**Thread**: [thread](./10-53-39.thread.md#:~:text=2022/01/07/10-53-39)
...
--- a/transport.c
+++ b/transport.c
@@ -1456,13 +1456,14 @@ int transport_fetch_refs(struct transport *transport, struct ref *refs)
 	return rc;
 }
...
+	if ((flags & TRANSPORT_UNLOCK_PACK_SKIP_FREE) == 0)
+		string_list_clear(&transport->pack_lockfiles, 0);
 }

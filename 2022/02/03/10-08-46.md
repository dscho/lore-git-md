# Re: [PATCH] doc: check-ignore: code-quote an exclamation mark

| Header | Value |
|--------|-------|
| **From** | Philip Oakley <philipoakley@iee.email> |
| **To** | Git List <git@vger.kernel.org> |
| **Date** | 2022-02-03T10:08:46Z |
| **Message-ID** | [a6eb7dae-f362-6027-0f96-1bb276618e5e@iee.email](https://lore.kernel.org/git/a6eb7dae-f362-6027-0f96-1bb276618e5e@iee.email) |

---

**Thread**: [thread](./09-58-18.thread.md#:~:text=2022/02/03/10-08-46)

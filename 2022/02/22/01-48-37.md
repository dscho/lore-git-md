# Re: [PATCH v2 2/2] clean: avoid traversing into untracked dirs when unnecessary

| Header | Value |
|--------|-------|
| **From** | Elijah Newren <newren@gmail.com> |
| **To** | Patrick Marlier <patrick.marlier@gmail.com> |
| **Date** | 2022-02-21T17:48:37-08:00 |
| **Message-ID** | [CABPp-BGdkgaRC+wBobhzyge=di8uE3kzHiO8v26bi2v0kTXerw@mail.gmail.com](https://lore.kernel.org/git/CABPp-BGdkgaRC+wBobhzyge=di8uE3kzHiO8v26bi2v0kTXerw@mail.gmail.com) |

---

**Thread**: [thread](./../21/09-00-33.thread.md#:~:text=2022/02/22/01-48-37)

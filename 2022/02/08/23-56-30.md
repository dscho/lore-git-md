...
| **Date** | 2022-02-08T23:56:30Z |
| **Message-ID** | [20220208235631.732466-1-calvinwan@google.com](https://lore.kernel.org/git/20220208235631.732466-1-calvinwan@google.com) |

---

**Thread**: [thread](./23-19-10.thread.md#:~:text=2022/02/08/23-56-30)
...
--- a/transport.c
+++ b/transport.c
@@ -445,6 +445,59 @@ static int fetch_refs_via_pack(struct transport *transport,
 	return ret;
 }

...
| **Date** | 2015-07-06T22:56:03+02:00 |
| **Message-ID** | [1436216164-7949-4-git-send-email-Matthieu.Moy@imag.fr](https://lore.kernel.org/git/1436216164-7949-4-git-send-email-Matthieu.Moy@imag.fr) |

---

**Thread**: [thread](./20-56-00.thread.md#:~:text=2015/07/06/20-56-03)
...
--- a/wt-status.c
+++ b/wt-status.c
@@ -1027,6 +1027,119 @@ static int split_commit_in_progress(struct wt_status *s)
...
+
 static void print_rebase_state(struct wt_status *s,
 				struct wt_status_state *state,
 				const char *color)
@@ -1047,6 +1160,7 @@ static void show_rebase_in_progress(struct wt_status *s,
 {
 	struct stat st;

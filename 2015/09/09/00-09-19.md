...
| **Date** | 2015-09-08T17:09:19-07:00 |
| **Message-ID** | [xmqqio7k78sw.fsf@gitster.mtv.corp.google.com](https://lore.kernel.org/git/xmqqio7k78sw.fsf@gitster.mtv.corp.google.com) |

---

**Thread**: [thread](./00-09-19.thread.md#:~:text=2015/09/09/00-09-19)
...
```
  ...
  Lars Schneider, Michael Rappazzo, Simon A. Eugster, and Zoë
  Blade.

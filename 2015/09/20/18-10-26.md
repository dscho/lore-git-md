...
| **Date** | 2015-09-20T23:40:26+05:30 |
| **Message-ID** | [1442772627-25421-8-git-send-email-Karthik.188@gmail.com](https://lore.kernel.org/git/1442772627-25421-8-git-send-email-Karthik.188@gmail.com) |

---

**Thread**: [thread](./18-10-19.thread.md#:~:text=2015/09/20/18-10-26)
...
@@ -606,54 +490,23 @@ static void print_ref_list(struct ref_filter *filter)
...
@@ -755,6 +608,7 @@ int cmd_branch(int argc, const char **argv, const char *prefix)
...
@@ -789,6 +643,8 @@ int cmd_branch(int argc, const char **argv, const char *prefix)
...
@@ -847,7 +703,7 @@ int cmd_branch(int argc, const char **argv, const char *prefix)

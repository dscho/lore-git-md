...
| **Date** | 2015-09-11T17:17:48+02:00 |
| **Message-ID** | [1441984668-28783-1-git-send-email-ralf.thielow@gmail.com](https://lore.kernel.org/git/1441984668-28783-1-git-send-email-ralf.thielow@gmail.com) |

---

**Thread**: [thread](./15-17-48.thread.md#:~:text=2015/09/11/15-17-48)
...
+#, c-format
 ...
 #, c-format
@@ -1886,44 +1885,41 @@ msgstr "  (benutzen Sie \"git am --skip\", um diesen Patch auszulassen)"
...
+msgstr "interaktives Rebase im Gange; auf "
 ...
 #: wt-status.c:1452
@@ -2336,127 +2331,123 @@ msgstr "Index-Datei beschädigt"
...
+msgstr "Konnte Commit '%s' nicht parsen."
 ...
 "zurückzufallen."
@@ -2494,15 +2485,15 @@ msgstr "auf leere Historie anwenden"
...
@@ -2513,41 +2504,39 @@ msgstr "Commit-Beschreibung ist:"
...
+msgstr "erlaube, falls notwendig, das Zurückfallen auf einen 3-Wege-Merge"
 ...
 #: builtin/am.c:2211 builtin/init-db.c:509 builtin/prune-packed.c:57
...
+msgstr "alles vor einer Scheren-Zeile entfernen"
 ...
 #: builtin/am.c:2231 builtin/apply.c:4563
 msgid "action"
 msgstr "Aktion"
 
 #: builtin/am.c:2232 builtin/am.c:2235 builtin/am.c:2238 builtin/am.c:2241
 #: builtin/am.c:2244 builtin/am.c:2247 builtin/am.c:2250 builtin/am.c:2253
 #: builtin/am.c:2259
 msgid "pass it through git-apply"
-msgstr ""
+msgstr "an git-apply übergeben"
 
 #: builtin/am.c:2240 builtin/apply.c:4587
 msgid "root"
 msgstr "Wurzelverzeichnis"
 
 #: builtin/am.c:2243 builtin/am.c:2246 builtin/apply.c:4525
@@ -2691,84 +2669,81 @@ msgstr "Anzahl"
 #: builtin/am.c:2255 builtin/for-each-ref.c:34 builtin/replace.c:438
 msgid "format"
 msgstr "Format"
...
+msgstr "aktuellen Zeitstempel als Autor-Datum verwenden"
 ...
 #: builtin/am.c:2281 builtin/commit.c:1590 builtin/merge.c:225
...
@@ -3910,13 +3885,13 @@ msgstr "eine Textkonvertierung auf den Inhalt von Blob-Objekten ausführen"
...
@@ -4131,15 +4103,15 @@ msgstr "Pfad '%s' ist nicht zusammengeführt."
...
@@ -5614,15 +5586,14 @@ msgstr "Sonstiges"
...
@@ -6259,15 +6230,14 @@ msgstr "Reflogs in Erreichbarkeitsprüfung einbeziehen (Standard)"
...
+msgstr "nur Konnektivität prüfen"
 ...
 #: builtin/fsck.c:647
@@ -8520,13 +8490,13 @@ msgstr "Konfliktauflösung beim Merge von Notizen abbrechen"
...
@@ -8549,24 +8519,24 @@ msgstr "Notizen von <Notiz-Referenz> verwenden"
...
@@ -8777,164 +8747,176 @@ msgstr "gelöschte Objekte melden"
...
+msgstr "Kann Rebase nicht auf mehrere Branches ausführen."
 ...
 #: builtin/push.c:86
@@ -9279,19 +9261,18 @@ msgstr "Die Option --delete ist inkompatibel mit --all, --mirror und --tags."
...
@@ -9355,15 +9336,15 @@ msgstr "Anwendung des Filters für spärliches Auschecken überspringen"
...
@@ -10160,15 +10141,14 @@ msgstr "Konnte Index-Datei nicht zu Commit '%s' setzen."
...
@@ -10396,30 +10376,33 @@ msgstr "git rm: konnte %s nicht löschen"
 msgid ""
...
@@ -10764,15 +10747,14 @@ msgstr "einen anderen Schlüssel verwenden, um das Tag zu signieren"
...
+msgstr "create_reflog"
 ...
 #: builtin/tag.c:612
@@ -11082,13 +11064,13 @@ msgstr "git verify-commit [-v | --verbose] <Commit>..."
...
@@ -11153,15 +11135,15 @@ msgstr "'%s' existiert bereits"
...
@@ -11176,15 +11158,14 @@ msgstr "Branch erstellen oder umsetzen"
...
@@ -11236,16 +11217,15 @@ msgstr "mit anderen zusammenarbeiten (siehe auch: git help workflows)"
...
+"verursacht hat"
 ...
 #: common-cmds.h:20
@@ -11412,49 +11392,50 @@ msgstr "Bitte rufen Sie 'bisect_state' mit mindestens einem Argument auf."
 #: git-bisect.sh:267
 #, sh-format
...
@@ -12070,13 +12052,13 @@ msgstr "Merge von '$sha1' in Submodul-Pfad '$displaypath' fehlgeschlagen"

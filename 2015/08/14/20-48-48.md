...
| **Date** | 2015-08-14T13:48:48-07:00 |
| **Message-ID** | [1439585329-10542-4-git-send-email-jacob.e.keller@intel.com](https://lore.kernel.org/git/1439585329-10542-4-git-send-email-jacob.e.keller@intel.com) |

---

**Thread**: [thread](./20-48-45.thread.md#:~:text=2015/08/14/20-48-48)
...
@@ -797,20 +832,12 @@ static int merge(int argc, const char **argv, const char *prefix)

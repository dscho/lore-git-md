...
| **Date** | 2015-12-02T14:34:19-05:00 |
| **Message-ID** | [jwva8psr6vr.fsf-monnier+gmane.comp.version-control.git@gnu.org](https://lore.kernel.org/git/jwva8psr6vr.fsf-monnier+gmane.comp.version-control.git@gnu.org) |

---

**Thread**: [thread](./19-34-19.thread.md#:~:text=2015/12/02/19-34-19)

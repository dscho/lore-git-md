...
| **Date** | 2015-12-28T16:00:13-08:00 |
| **Message-ID** | [xmqqsi2mi0oi.fsf@gitster.mtv.corp.google.com](https://lore.kernel.org/git/xmqqsi2mi0oi.fsf@gitster.mtv.corp.google.com) |

---

**Thread**: [thread](./00-00-13.thread.md#:~:text=2015/12/29/00-00-13)
...
'v2.7.0-rc3' tag and the 'master' branch that the tag points at:
...
Changes since v2.7.0-rc2 are as follows:

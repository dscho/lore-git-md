...
| **Date** | 2015-11-28T16:07:24+01:00 |
| **Message-ID** | [5659C32C.50007@web.de](https://lore.kernel.org/git/5659C32C.50007@web.de) |

---

**Thread**: [thread](./15-07-24.thread.md#:~:text=2015/11/28/15-07-24)
...
+
 ...
 {
 	switch (crlf_action) {
@@ -777,6 +839,30 @@ int would_convert_to_git_filter_fd(const char *path)

...
| **Date** | 2015-03-08T17:12:46+07:00 |
| **Message-ID** | [1425809567-25518-24-git-send-email-pclouds@gmail.com](https://lore.kernel.org/git/1425809567-25518-24-git-send-email-pclouds@gmail.com) |

---

**Thread**: [thread](./10-12-23.thread.md#:~:text=2015/03/08/10-12-46)
...
@@ -2264,6 +2303,11 @@ void write_untracked_extension(struct strbuf *out, struct untracked_cache *untra
...
+
 	...
 	free(ouc);
 	ouc = NULL;
@@ -2449,17 +2493,26 @@ struct untracked_cache *read_untracked_extension(const void *data, unsigned long
 	struct untracked_cache *uc;
 	struct read_data rd;

...
| **Date** | 2015-03-08T17:12:25+07:00 |
| **Message-ID** | [1425809567-25518-3-git-send-email-pclouds@gmail.com](https://lore.kernel.org/git/1425809567-25518-3-git-send-email-pclouds@gmail.com) |

---

**Thread**: [thread](./10-12-23.thread.md#:~:text=2015/03/08/10-12-25)
...
@@ -865,9 +920,15 @@ static void prep_exclude(struct dir_struct *dir, const char *base, int baselen)
...
@@ -1667,9 +1769,11 @@ void setup_standard_excludes(struct dir_struct *dir)

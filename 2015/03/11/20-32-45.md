...
| **Date** | 2015-03-11T16:32:45-04:00 |
| **Message-ID** | [20150311203245.GA20243@flurp.local](https://lore.kernel.org/git/20150311203245.GA20243@flurp.local) |

---

**Thread**: [thread](./../10/10-39-41.thread.md#:~:text=2015/03/11/20-32-45)
...
@@ -310,7 +310,7 @@ configuration variable documented in linkgit:git-config[1].
 	GPG-sign commit.

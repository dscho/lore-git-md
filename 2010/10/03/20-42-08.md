# [PATCH v4 3/4] Allow hiding renames of individual files involved in a directory rename.

| Header | Value |
|--------|-------|
| **From** | Yann Dirson <ydirson@altern.org> |
| **To** | git@vger.kernel.org |
| **Date** | 2010-10-03T22:42:08+02:00 |
| **Message-ID** | [1286138529-6780-4-git-send-email-ydirson@altern.org](https://lore.kernel.org/git/1286138529-6780-4-git-send-email-ydirson@altern.org) |

---

**Thread**: [thread](./20-42-05.thread.md#:~:text=2010/10/03/20-42-08)

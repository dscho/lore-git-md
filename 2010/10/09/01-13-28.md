...
| **Date** | 2010-10-09T03:13:28+02:00 |
| **Message-ID** | [1286586819-3636-11-git-send-email-johan@herland.net](https://lore.kernel.org/git/1286586819-3636-11-git-send-email-johan@herland.net) |

---

**Thread**: [thread](./01-13-28.thread.md#:~:text=2010/10/09/01-13-28)
...
+{
+	return (o->verbosity >= v) || o->verbosity >= NOTES_MERGE_VERBOSITY_MAX;
+}
+
+#define OUTPUT(o, v, ...) \

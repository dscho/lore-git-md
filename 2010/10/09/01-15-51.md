...
| **Date** | 2010-10-09T03:15:51+02:00 |
| **Message-ID** | [1286586956-3714-17-git-send-email-johan@herland.net](https://lore.kernel.org/git/1286586956-3714-17-git-send-email-johan@herland.net) |

---

**Thread**: [thread](./01-15-51.thread.md#:~:text=2010/10/09/01-15-51)
...
index 283e7b2..e0702b5 100644
--- a/notes-merge.h
+++ b/notes-merge.h
@@ -70,4 +70,27 @@ int notes_merge(struct notes_merge_options *o,

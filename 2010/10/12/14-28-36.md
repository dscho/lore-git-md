...
| **Date** | 2010-10-12T23:28:36+09:00 |
| **Message-ID** | [87bp6z8oyz.fsf@catnip.gol.com](https://lore.kernel.org/git/87bp6z8oyz.fsf@catnip.gol.com) |

---

**Thread**: [thread](./14-28-36.thread.md#:~:text=2010/10/12/14-28-36)
...
and a subsequent "git fsck" gives no output, so I guess it thinks things
...
error: packfile .git/objects/pack/pack-b396592f312710251577eae8e43eb6d25d5e5e87.pack cannot be accessed
...
```
 ...
 lisp/{emacs-lisp => obsolete}/cl-compat.el |    9 +-
 lisp/{emacs-lisp => obsolete}/lmenu.el     |    8 +-
 lisp/play/5x5.el                           |   10 +-
 ...
 rename lisp/{emacs-lisp => obsolete}/cl-compat.el (97%)
 rename lisp/{emacs-lisp => obsolete}/lmenu.el (99%)
```

$ ls -l .git/objects/pack/pack-b396592f312710251577eae8e43eb6d25d5e5e87.pack
ls: cannot access .git/objects/pack/pack-b396592f312710251577eae8e43eb6d25d5e5e87.pack: そのようなファイルやディレクトリはありません
$ ls -l .git/objects/pack/
合計 342816
-r--r--r-- 1 miles staff  24556680 2010-10-12 22:31 pack-13ddf27a64f8dc0237787f463d603e13d7a8deb5.idx
-r--r--r-- 1 miles staff 326131222 2010-10-12 22:31 pack-13ddf27a64f8dc0237787f463d603e13d7a8deb5.pack
$ git fsck

# [PATCHv11 06/20] Notes API: remove_note(): Remove note objects from the notes tree structure

| Header | Value |
|--------|-------|
| **From** | Johan Herland <johan@herland.net> |
| **To** | gitster@pobox.com |
| **Date** | 2010-01-17T22:04:23+01:00 |
| **Message-ID** | [1263762277-31419-7-git-send-email-johan@herland.net](https://lore.kernel.org/git/1263762277-31419-7-git-send-email-johan@herland.net) |

---

**Thread**: [thread](./21-04-17.thread.md#:~:text=2010/01/17/21-04-23)

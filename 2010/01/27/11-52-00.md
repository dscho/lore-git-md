# [PATCHv12 23/23] builtin-notes: Add "add" subcommand for appending to note objects
...
| **Message-ID** | [1264593120-4428-24-git-send-email-johan@herland.net](https://lore.kernel.org/git/1264593120-4428-24-git-send-email-johan@herland.net) |

---

**Thread**: [thread](./11-52-00.thread.md#:~:text=2010/01/27/11-52-00)

...
| **Date** | 2010-12-01T17:25:54+02:00 |
| **Message-ID** | [31def5a4a6256e6fdef8a03372cda98460f61c47.1291217124.git.jari.aalto@cante.net](https://lore.kernel.org/git/31def5a4a6256e6fdef8a03372cda98460f61c47.1291217124.git.jari.aalto@cante.net) |

---

**Thread**: [thread](./12-48-56.thread.md#:~:text=2010/12/01/15-25-54)
...
@@ -540,261 +455,347 @@ On some file system/operating system combinations, this is unreliable.
...
@@ -1451,20 +1453,6 @@ This setting can be overridden with the `GIT_NOTES_REWRITE_REF`
...
@@ -1478,6 +1466,12 @@ Note that changing the compression level will not automatically recompress

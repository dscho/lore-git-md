# [PATCHv6.1 06/23] notes.h/c: Propagate combine_notes_fn return value to add_note() and beyond

| Header | Value |
|--------|-------|
| **From** | Johan Herland <johan@herland.net> |
| **To** | git@vger.kernel.org |
| **Date** | 2010-11-15T00:52:26+01:00 |
| **Message-ID** | [201011150052.26964.johan@herland.net](https://lore.kernel.org/git/201011150052.26964.johan@herland.net) |

---

**Thread**: [thread](./../09/21-49-36.thread.md#:~:text=2010/11/14/23-52-26)

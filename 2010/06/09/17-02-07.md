...
| **Date** | 2010-06-09T19:02:07+02:00 |
| **Message-ID** | [1276102929-31712-3-git-send-email-clement.poulain@ensimag.imag.fr](https://lore.kernel.org/git/1276102929-31712-3-git-send-email-clement.poulain@ensimag.imag.fr) |

---

**Thread**: [thread](./17-02-05.thread.md#:~:text=2010/06/09/17-02-07)
...
+extern int textconv_object(const char *path, const unsigned char *sha1, char **buf, size_t *buf_size);
+
...
+			    obj_name);
+
+		if(!textconv_object(obj_context.path, sha1, (char **) &buf, (size_t *) &size))
...
+
 ...
 {
 	int opt = 0, batch = 0;
@@ -218,6 +243,8 @@ int cmd_cat_file(int argc, const char **argv, const char *prefix)
...
+				"for blob objects, run textconv on object's content", 'c'),
 		OPT_SET_INT(0, "batch", &batch,
 			    ...
 			    BATCH),
@@ -227,7 +254,7 @@ int cmd_cat_file(int argc, const char **argv, const char *prefix)
 		OPT_END()
 	};

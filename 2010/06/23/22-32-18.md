...
| **Date** | 2010-06-23T22:32:18Z |
| **Message-ID** | [1277332338-8486-1-git-send-email-avarab@gmail.com](https://lore.kernel.org/git/1277332338-8486-1-git-send-email-avarab@gmail.com) |

---

**Thread**: [thread](./22-32-18.thread.md#:~:text=2010/06/23/22-32-18)
...
Here's another version of the Gettext series for git. This time I've
omitted the "Add initial C, Shell and Perl gettext translations" patch
due to its conflict with other topics. That part can be submitted once
this is in and Git stops moving under our feet.

This applies cleanly to master/next/pu. The conflicts were in Makefile
with a recent gitweb series.

# [PATCH 2/4] revision: introduce setup_revision_opt

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2010-03-09T01:42:53-08:00 |
| **Message-ID** | [1268127775-9998-2-git-send-email-gitster@pobox.com](https://lore.kernel.org/git/1268127775-9998-2-git-send-email-gitster@pobox.com) |

---

**Thread**: [thread](./09-42-52.thread.md#:~:text=2010/03/09/09-42-53)

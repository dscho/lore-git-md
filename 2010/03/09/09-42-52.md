# [PATCH 1/4] t4013: add tests for log -p -m --first-parent

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2010-03-09T01:42:52-08:00 |
| **Message-ID** | [1268127775-9998-1-git-send-email-gitster@pobox.com](https://lore.kernel.org/git/1268127775-9998-1-git-send-email-gitster@pobox.com) |

---

**Thread**: [thread](./09-42-52.thread.md#:~:text=2010/03/09/09-42-52)

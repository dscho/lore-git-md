# [PATCH v2] git status: Fix false positive "new commits" output for dirty submodules

| Header | Value |
|--------|-------|
| **From** | Jens Lehmann <Jens.Lehmann@web.de> |
| **To** | Junio C Hamano <gitster@pobox.com> |
| **Date** | 2010-03-12T22:23:52+01:00 |
| **Message-ID** | [4B9AB0E8.90902@web.de](https://lore.kernel.org/git/4B9AB0E8.90902@web.de) |

---

**Thread**: [thread](./../11/15-19-18.thread.md#:~:text=2010/03/12/21-23-52)

# [PATCH] Correct references to /usr/bin/python which may ont exist on certain systems

| Header | Value |
|--------|-------|
| **From** | R. Tyler Ballance <tyler@monkeypox.org> |
| **To** | git@vger.kernel.org |
| **Date** | 2010-03-20T16:02:37-07:00 |
| **Message-ID** | [20100320230230.GA29738@kiwi.sharlinx.com](https://lore.kernel.org/git/20100320230230.GA29738@kiwi.sharlinx.com) |

---

**Thread**: [thread](./23-02-37.thread.md#:~:text=2010/03/20/23-02-37)

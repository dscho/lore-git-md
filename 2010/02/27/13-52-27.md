# [PATCH v3 3/5] apply: Allow blank context lines to match beyond EOF

| Header | Value |
|--------|-------|
| **From** | Björn Gustavsson <bgustavsson@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2010-02-27T14:52:27+01:00 |
| **Message-ID** | [4B89239B.8040503@gmail.com](https://lore.kernel.org/git/4B89239B.8040503@gmail.com) |

---

**Thread**: [thread](./13-52-27.thread.md#:~:text=2010/02/27/13-52-27)
...
+			(img->nr - (applied_pos + preimage_limit)) *
 	...
 	memcpy(img->line + applied_pos,
 	       postimage->line,
@@ -2318,7 +2423,7 @@ static int apply_one_fragment(struct image *img, struct fragment *frag,

...
| **Date** | 2010-09-14T16:00:18Z |
| **Message-ID** | [1284480018-20874-1-git-send-email-avarab@gmail.com](https://lore.kernel.org/git/1284480018-20874-1-git-send-email-avarab@gmail.com) |

---

**Thread**: [thread](./16-00-18.thread.md#:~:text=2010/09/14/16-00-18)
...
```
  * Included the "Makefile: only add gettext tests on
    XGETTEXT_INCLUDE_TESTS=YesPlease" patch previously sent to list,

...
| **Date** | 2010-09-29T13:40:32Z |
| **Message-ID** | [1285767632-24852-1-git-send-email-avarab@gmail.com](https://lore.kernel.org/git/1285767632-24852-1-git-send-email-avarab@gmail.com) |

---

**Thread**: [thread](./../28/16-05-26.thread.md#:~:text=2010/09/29/13-40-32)
...
@@ -268,7 +274,7 @@ uname_P := $(shell sh -c 'uname -p 2>/dev/null || echo not')

...
| **Date** | 2010-09-25T13:07:06-06:00 |
| **Message-ID** | [1285441627-28233-16-git-send-email-newren@gmail.com](https://lore.kernel.org/git/1285441627-28233-16-git-send-email-newren@gmail.com) |

---

**Thread**: [thread](./19-06-51.thread.md#:~:text=2010/09/25/19-07-06)
...
```
 ...
 80 files changed, 187 insertions(+), 188 deletions(-)
...
@@ -96,7 +95,7 @@ test_expect_success 'setup bare' '
...
@@ -110,7 +109,7 @@ test_expect_success 'bare repository: check that .gitattribute is ignored' '

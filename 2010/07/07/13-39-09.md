...
| **Date** | 2010-07-07T15:39:09+02:00 |
| **Message-ID** | [cover.1278508352.git.hvoigt@hvoigt.net](https://lore.kernel.org/git/cover.1278508352.git.hvoigt@hvoigt.net) |

---

**Thread**: [thread](./13-39-09.thread.md#:~:text=2010/07/07/13-39-09)

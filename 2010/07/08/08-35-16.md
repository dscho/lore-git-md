...
| **Date** | 2010-07-08T10:35:16+02:00 |
| **Message-ID** | [20100708083516.GD29267@debian](https://lore.kernel.org/git/20100708083516.GD29267@debian) |

---

**Thread**: [thread](./08-35-16.thread.md#:~:text=2010/07/08/08-35-16)
...
+  SVN_ERR(dump_props(pb->eb, &dump_props_pending, TRUE, pool));
+
...
+
+  hb->temp_filepath = apr_psprintf(eb->pool, "%s/svn-fe-XXXXXX", tempdir);
...
===================================================================
```diff
--- subversion/svnrdump/dump_editor.h	(revision 0)
...
===================================================================
```diff
--- subversion/svnrdump/svnrdump.c	(revision 0)
...
===================================================================
```diff
--- subversion/svnrdump/svnrdump.h	(revision 0)
...
===================================================================
```diff
--- subversion/svnrdump/util.c	(revision 0)

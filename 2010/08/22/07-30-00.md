...
| **Date** | 2010-08-22T00:30:00-07:00 |
| **Message-ID** | [7v4oen5clj.fsf@alter.siamese.dyndns.org](https://lore.kernel.org/git/7v4oen5clj.fsf@alter.siamese.dyndns.org) |

---

**Thread**: [thread](./07-30-00.thread.md#:~:text=2010/08/22/07-30-00)
...
I'm very tempted to propose for us to start slowing down and release 1.7.3
mid-September with a polished version of what is in 'next'.  Please expect

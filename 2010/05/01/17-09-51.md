# [PATCH 3/3] git over TLS (gits://) support (part 3)

| Header | Value |
|--------|-------|
| **From** | Ilari Liusvaara <ilari.liusvaara@elisanet.fi> |
| **To** | git@vger.kernel.org |
| **Date** | 2010-05-01T20:09:51+03:00 |
| **Message-ID** | [1272733791-11341-4-git-send-email-ilari.liusvaara@elisanet.fi](https://lore.kernel.org/git/1272733791-11341-4-git-send-email-ilari.liusvaara@elisanet.fi) |

---

**Thread**: [thread](./17-09-48.thread.md#:~:text=2010/05/01/17-09-51)

# [PATCH v2] gitk: Add options --select-file and --select-line

| Header | Value |
|--------|-------|
| **From** | Stefan Haller <stefan@haller-berlin.de> |
| **To** | paulus@ozlabs.org |
| **Date** | 2020-10-15T09:31:38+02:00 |
| **Message-ID** | [20201015073138.50899-1-stefan@haller-berlin.de](https://lore.kernel.org/git/20201015073138.50899-1-stefan@haller-berlin.de) |

---

**Thread**: [thread](./../14/14-55-06.thread.md#:~:text=2020/10/15/07-31-38)

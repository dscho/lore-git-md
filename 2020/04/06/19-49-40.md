# [PATCH v2] fast-import: replace custom hash with hashmap.c

| Header | Value |
|--------|-------|
| **From** | Jeff King <peff@peff.net> |
| **To** | git@vger.kernel.org |
| **Date** | 2020-04-06T15:49:40-04:00 |
| **Message-ID** | [20200406194940.GA1242833@coredump.intra.peff.net](https://lore.kernel.org/git/20200406194940.GA1242833@coredump.intra.peff.net) |

---

**Thread**: [thread](./../03/12-15-08.thread.md#:~:text=2020/04/06/19-49-40)

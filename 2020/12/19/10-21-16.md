# Re: [PATCH v2] gitk: Add options --select-file and --select-line

| Header | Value |
|--------|-------|
| **From** | Stefan Haller <stefan@haller-berlin.de> |
| **To** | paulus@ozlabs.org |
| **Date** | 2020-12-19T11:21:16+01:00 |
| **Message-ID** | [bd940f73-ca2f-fe21-ea0a-fcd5f40af683@haller-berlin.de](https://lore.kernel.org/git/bd940f73-ca2f-fe21-ea0a-fcd5f40af683@haller-berlin.de) |

---

**Thread**: [thread](./../../10/14/14-55-06.thread.md#:~:text=2020/12/19/10-21-16)

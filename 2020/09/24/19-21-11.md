# [PATCH 1/2] bswap.h: drop unaligned loads

| Header | Value |
|--------|-------|
| **From** | Jeff King <peff@peff.net> |
| **To** | Junio C Hamano <gitster@pobox.com> |
| **Date** | 2020-09-24T15:21:11-04:00 |
| **Message-ID** | [20200924192111.GA2528225@coredump.intra.peff.net](https://lore.kernel.org/git/20200924192111.GA2528225@coredump.intra.peff.net) |

---

**Thread**: [thread](./19-16-38.thread.md#:~:text=2020/09/24/19-21-11)

...
| **Date** | 2020-09-10T01:27:41-07:00 |
| **Message-ID** | [c59cec1c669b26fc2271067f4970d0ecbf816a89.1599726439.git.liu.denton@gmail.com](https://lore.kernel.org/git/c59cec1c669b26fc2271067f4970d0ecbf816a89.1599726439.git.liu.denton@gmail.com) |

---

**Thread**: [thread](./08-27-40.thread.md#:~:text=2020/09/10/08-27-41)
...
index da84e22dd4..7efb106e52 100755
--- a/gitk
+++ b/gitk
@@ -10,37 +10,37 @@ exec wish "$0" -- "$@"
 package require Tk
...
@@ -49,1942 +49,1942 @@ proc gitworktree {} {
...
@@ -1996,8235 +1996,8235 @@ proc setttkstyle {} {
...
@@ -10243,472 +10243,472 @@ proc getallcommits {} {
...
@@ -10723,1043 +10723,1043 @@ proc anc_or_desc {a b} {
...
@@ -11768,483 +11768,483 @@ proc setselbg {c} {
...
@@ -12256,23 +12256,23 @@ namespace import ::msgcat::mc
...
+	unset ::env(GIT_TRACE)
 ...
 # defaults...
@@ -12280,50 +12280,50 @@ set wrcomcmd "git diff-tree --stdin -p --pretty=email"
...
@@ -12350,32 +12350,32 @@ set perfile_attrs 0
 set want_ttk 1
...
+	}
 ...
 set diffcontext 3
@@ -12408,52 +12408,52 @@ set currentsearchhitbgcolor orange
...
+	exit 1
 ...
 set selecthead {}
@@ -12485,56 +12485,56 @@ set cmdline_files {}
 set i 0
 set revtreeargscmd {}
 foreach arg $argv {
-    switch -glob -- $arg {
...
@@ -12543,20 +12543,20 @@ set nullfile "/dev/null"
...
+	set show_notes "--show-notes"
 ...
 set appname "gitk"
@@ -12601,33 +12601,33 @@ set lserial 0
 set hasworktree [hasworktree]
 set cdup {}

# Re: [PATCH] config: complain about --worktree outside of a git repo

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | Matheus Tavares <matheus.bernardino@usp.br> |
| **Date** | 2020-09-09T12:47:30-07:00 |
| **Message-ID** | [xmqqeenavijx.fsf@gitster.c.googlers.com](https://lore.kernel.org/git/xmqqeenavijx.fsf@gitster.c.googlers.com) |

---

**Thread**: [thread](./13-16-08.thread.md#:~:text=2020/09/09/19-47-30)

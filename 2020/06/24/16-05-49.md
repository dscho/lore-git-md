...
| **Date** | 2020-06-24T16:05:49Z |
| **Message-ID** | [BY5PR09MB4504AD01DDA757120DCC79ABFF950@BY5PR09MB4504.namprd09.prod.outlook.com](https://lore.kernel.org/git/BY5PR09MB4504AD01DDA757120DCC79ABFF950@BY5PR09MB4504.namprd09.prod.outlook.com) |

---

**Thread**: [thread](./15-42-34-1.thread.md#:~:text=2020/06/24/16-05-49)

Thanks, but I was referring to if there was a Manufacturing Part Number or a Stock Keeping Unit number for this product. I believe we already have the unique ID entered in another field, so that part should be good. 
...
> there even is one as I assume this is open-sourced, but I figured I'd reach out to get confirmation before I make an internal SKU for our records. Thanks.
>
>
> Jesse Earles
> Desktop Support Specialist

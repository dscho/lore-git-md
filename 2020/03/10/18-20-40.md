# [PATCH 2/8] convert: permit passing additional metadata to filter processes

| Header | Value |
|--------|-------|
| **From** | brian m. carlson <sandals@crustytoothpaste.net> |
| **To** | git@vger.kernel.org |
| **Date** | 2020-03-10T18:20:40Z |
| **Message-ID** | [20200310182046.748959-3-sandals@crustytoothpaste.net](https://lore.kernel.org/git/20200310182046.748959-3-sandals@crustytoothpaste.net) |

---

**Thread**: [thread](./18-20-38.thread.md#:~:text=2020/03/10/18-20-40)

# [PATCH v4 24/39] t9350: make hash size independent

| Header | Value |
|--------|-------|
| **From** | brian m. carlson <sandals@crustytoothpaste.net> |
| **To** | git@vger.kernel.org |
| **Date** | 2020-07-26T19:54:09Z |
| **Message-ID** | [20200726195424.626969-25-sandals@crustytoothpaste.net](https://lore.kernel.org/git/20200726195424.626969-25-sandals@crustytoothpaste.net) |

---

**Thread**: [thread](./19-53-45.thread.md#:~:text=2020/07/26/19-54-09)

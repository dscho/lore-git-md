# [PATCH 06/11] strvec: convert more callers away from argv_array name

| Header | Value |
|--------|-------|
| **From** | Jeff King <peff@peff.net> |
| **To** | git@vger.kernel.org |
| **Date** | 2020-07-28T16:24:53-04:00 |
| **Message-ID** | [20200728202453.GF1021513@coredump.intra.peff.net](https://lore.kernel.org/git/20200728202453.GF1021513@coredump.intra.peff.net) |

---

**Thread**: [thread](./20-21-24.thread.md#:~:text=2020/07/28/20-24-53)

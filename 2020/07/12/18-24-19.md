# [PATCH v2] gitweb: Replace <base> tag with full URLs (when using PATH_INFO)

| Header | Value |
|--------|-------|
| **From** | Tobias Girstmair <tobi@isticktoit.net> |
| **To** | git@vger.kernel.org |
| **Date** | 2020-07-12T20:24:19+02:00 |
| **Message-ID** | [20200712182418.1696-1-tobi@isticktoit.net](https://lore.kernel.org/git/20200712182418.1696-1-tobi@isticktoit.net) |

---

**Thread**: [thread](./../11/20-39-48.thread.md#:~:text=2020/07/12/18-24-19)

# [PATCH v2] doc:clarify which remotes can be used when contributing

| Header | Value |
|--------|-------|
| **From** | Daniele Sassoli via GitGitGadget <gitgitgadget@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2025-08-23T09:12:11Z |
| **Message-ID** | [pull.2034.v2.git.git.1755940331248.gitgitgadget@gmail.com](https://lore.kernel.org/git/pull.2034.v2.git.git.1755940331248.gitgitgadget@gmail.com) |

---

**Thread**: [thread](./../19/19-14-42.thread.md#:~:text=2025/08/23/09-12-11)

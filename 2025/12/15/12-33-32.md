# Re: [PATCH v3 5/5] scalar: document config settings

| Header | Value |
|--------|-------|
| **From** | Henrique Ferreiro <hferreiro@igalia.com> |
| **To** | Derrick Stolee via GitGitGadget <gitgitgadget@gmail.com>, git@vger.kernel.org |
| **Date** | 2025-12-15T13:33:32+01:00 |
| **Message-ID** | [9b770540-6791-41e2-9548-48b42c7f644b@igalia.com](https://lore.kernel.org/git/9b770540-6791-41e2-9548-48b42c7f644b@igalia.com) |

---

**Thread**: [thread](./../../11/26/22-18-31.thread.md#:~:text=2025/12/15/12-33-32)

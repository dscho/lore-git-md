...
| **Date** | 2025-10-15T22:56:09+01:00 |
| **Message-ID** | [CAD=f0L_Jb8Fx9k8fU70qJKMw4oQh23f5H-BbQg-WrnSfsCTfAQ@mail.gmail.com](https://lore.kernel.org/git/CAD=f0L_Jb8Fx9k8fU70qJKMw4oQh23f5H-BbQg-WrnSfsCTfAQ@mail.gmail.com) |

---

**Thread**: [thread](./02-19-41.thread.md#:~:text=2025/10/15/21-56-09)
...
I agree that < 3or != 3 is a better approach.
Thank you.
> > ```
> >                 die_errno(_("failed to get the ssh fingerprint for key '%s'"),
> >                           signing_key);

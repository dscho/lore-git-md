# BUG: commit-graph + objects/alternate -> SIGSEGV

| Header | Value |
|--------|-------|
| **From** | Philipp Hahn <phahn-oss@avm.de> |
| **To** | git@vger.kernel.org |
| **Date** | 2025-10-17T11:47:11+02:00 |
| **Message-ID** | [20251017094717.626300-1-phahn-oss@avm.de](https://lore.kernel.org/git/20251017094717.626300-1-phahn-oss@avm.de) |

---

**Thread**: [thread](./09-47-11.thread.md#:~:text=2025/10/17/09-47-11)

# [PATCH v6 04/15] odb: move packfile map into `struct packfile_store`

| Header | Value |
|--------|-------|
| **From** | Patrick Steinhardt <ps@pks.im> |
| **To** | git@vger.kernel.org |
| **Date** | 2025-09-23T12:17:03+02:00 |
| **Message-ID** | [20250923-b4-pks-packfiles-store-v6-4-b48f2a882759@pks.im](https://lore.kernel.org/git/20250923-b4-pks-packfiles-store-v6-4-b48f2a882759@pks.im) |

---

**Thread**: [thread](./../../08/19/08-19-29.thread.md#:~:text=2025/09/23/10-17-03)

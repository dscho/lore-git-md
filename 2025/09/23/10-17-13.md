# [PATCH v6 14/15] packfile: refactor `get_all_packs()` to work on packfile store

| Header | Value |
|--------|-------|
| **From** | Patrick Steinhardt <ps@pks.im> |
| **To** | git@vger.kernel.org |
| **Date** | 2025-09-23T12:17:13+02:00 |
| **Message-ID** | [20250923-b4-pks-packfiles-store-v6-14-b48f2a882759@pks.im](https://lore.kernel.org/git/20250923-b4-pks-packfiles-store-v6-14-b48f2a882759@pks.im) |

---

**Thread**: [thread](./../../08/19/08-19-29.thread.md#:~:text=2025/09/23/10-17-13)

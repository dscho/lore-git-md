# Re: [PATCH] doc: change the markup of paragraphs following a nested list item

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | Jean-Noël Avila <jn.avila@free.fr> |
| **Date** | 2025-09-26T13:54:10-07:00 |
| **Message-ID** | [xmqq5xd5aqa5.fsf@gitster.g](https://lore.kernel.org/git/xmqq5xd5aqa5.fsf@gitster.g) |

---

**Thread**: [thread](./../23/18-34-00.thread.md#:~:text=2025/09/26/20-54-10)

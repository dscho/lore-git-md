# [PATCH v4 02/15] odb: move list of packfiles into `struct packfile_store`

| Header | Value |
|--------|-------|
| **From** | Patrick Steinhardt <ps@pks.im> |
| **To** | git@vger.kernel.org |
| **Date** | 2025-09-09T13:03:01+02:00 |
| **Message-ID** | [20250909-b4-pks-packfiles-store-v4-2-151c4ba3619f@pks.im](https://lore.kernel.org/git/20250909-b4-pks-packfiles-store-v4-2-151c4ba3619f@pks.im) |

---

**Thread**: [thread](./../../08/19/08-19-29.thread.md#:~:text=2025/09/09/11-03-01)

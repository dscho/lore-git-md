# [PATCH v5 14/15] packfile: refactor `get_all_packs()` to work on packfile store

| Header | Value |
|--------|-------|
| **From** | Patrick Steinhardt <ps@pks.im> |
| **To** | git@vger.kernel.org |
| **Date** | 2025-09-15T10:54:32+02:00 |
| **Message-ID** | [20250915-b4-pks-packfiles-store-v5-14-d6340350934f@pks.im](https://lore.kernel.org/git/20250915-b4-pks-packfiles-store-v5-14-d6340350934f@pks.im) |

---

**Thread**: [thread](./../../08/19/08-19-29.thread.md#:~:text=2025/09/15/08-54-32)

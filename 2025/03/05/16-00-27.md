# Re: [ANNOUNCE] Git for Windows 2.49.0-rc1

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | Johannes Schindelin <johannes.schindelin@gmx.de> |
| **Date** | 2025-03-05T08:00:27-08:00 |
| **Message-ID** | [xmqqv7snlb6s.fsf@gitster.g](https://lore.kernel.org/git/xmqqv7snlb6s.fsf@gitster.g) |

---

**Thread**: [thread](./14-52-33.thread.md#:~:text=2025/03/05/16-00-27)

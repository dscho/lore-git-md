...
| **Date** | 2025-03-03T09:47:41+01:00 |
| **Message-ID** | [20250303-b4-pks-objects-without-the-repository-v1-12-c5dd43f2476e@pks.im](https://lore.kernel.org/git/20250303-b4-pks-objects-without-the-repository-v1-12-c5dd43f2476e@pks.im) |

---

**Thread**: [thread](./08-47-29.thread.md#:~:text=2025/03/03/08-47-41)
...
```
 ...
 wt-status.c                                  |  4 ++--
 xdiff-interface.c                            |  2 +-
 48 files changed, 135 insertions(+), 136 deletions(-)
...
index a441eda7ff9..5da3a2078d0 100644
--- a/builtin/fsck.c
+++ b/builtin/fsck.c
...
index 2b37d1e28f1..19b82f3b3d3 100644
--- a/upload-pack.c
+++ b/upload-pack.c

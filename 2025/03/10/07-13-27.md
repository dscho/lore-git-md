# [PATCH v4 08/12] object-file-convert: stop depending on `the_repository`

| Header | Value |
|--------|-------|
| **From** | Patrick Steinhardt <ps@pks.im> |
| **To** | git@vger.kernel.org |
| **Date** | 2025-03-10T08:13:27+01:00 |
| **Message-ID** | [20250310-b4-pks-objects-without-the-repository-v4-8-f201b8ec57ba@pks.im](https://lore.kernel.org/git/20250310-b4-pks-objects-without-the-repository-v4-8-f201b8ec57ba@pks.im) |

---

**Thread**: [thread](./../03/08-47-29.thread.md#:~:text=2025/03/10/07-13-27)

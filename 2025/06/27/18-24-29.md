...
| **Date** | 2025-06-27T18:24:29Z |
| **Message-ID** | [AM7PR02MB64846D60AF39992B13B36E75FB45A@AM7PR02MB6484.eurprd02.prod.outlook.com](https://lore.kernel.org/git/AM7PR02MB64846D60AF39992B13B36E75FB45A@AM7PR02MB6484.eurprd02.prod.outlook.com) |

---

**Thread**: [thread](./../../03/03/15-20-22.thread.md#:~:text=2025/06/27/18-24-29)

Hi there,

I have news:

I uninstalled git 2.48.1.windows.1 and installed Git-2.50.0-64-bit.exe.
The problems persisted and since I was blocked anyhow, I decided to move the repo to an archive folder and clone from scratch.
I tried this 20x times and it always failed.
I got something like this

Receiving objects:  34% (4912036/14447164), 429.30 MiB | 14.19 MiB/s

And at some random point (1%, 34%, max. was between 50% and 60%) it crashed with

client_loop: send disconnect: Connection reset by peer

I asked my colleagues and they tested this and it worked fine.
They had older versions of git.
So I uninstalled git once more and now installed Git-2.46.0-64-bit.exe (4 releases back in my downloads folder).

Surpise: git clone worked on the first try like a charm.

BTW: with Git-2.50.0-64-bit.exe also step 1. (install the Git for Windows SDK) failed on the first try with the same error but succeeded after deleting the installation and installing again.

So my assumption is recent versions of Git have QA issues.
I assume that maybe bundled OpenSSL may be a candidate to have a deeper look, but is just my first guess.

p.s.: I also used git 2.46.0.windows.1 and went to my archived broken git clone and did run
git remote update origin --prune

But that failed again with the same error after claiming to have deleted hundreds of remote branches and added other hundreds of remote branches from/to origin.
So maybe after all the experiments with latest git releases something in `.git` folder got corrupted. Again just gut feeling...
...
-----Original Message-----
From: Hohwiller, Jörg 
Sent: Friday, June 27, 2025 17:35
To: Johannes Schindelin <Johannes.Schindelin@gmx.de>

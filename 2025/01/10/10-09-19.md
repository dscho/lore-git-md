# [PATCH v2] doc: convert git-restore to new style format

| Header | Value |
|--------|-------|
| **From** | Jean-Noël Avila via GitGitGadget <gitgitgadget@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2025-01-10T10:09:19Z |
| **Message-ID** | [pull.1847.v2.git.1736503760086.gitgitgadget@gmail.com](https://lore.kernel.org/git/pull.1847.v2.git.1736503760086.gitgitgadget@gmail.com) |

---

**Thread**: [thread](./../04/13-16-40.thread.md#:~:text=2025/01/10/10-09-19)

# [PATCH v2] completion: repair config completion for Zsh

| Header | Value |
|--------|-------|
| **From** | D. Ben Knoble via GitGitGadget <gitgitgadget@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2025-01-04T14:47:53Z |
| **Message-ID** | [pull.1860.v2.git.git.1736002073641.gitgitgadget@gmail.com](https://lore.kernel.org/git/pull.1860.v2.git.git.1736002073641.gitgitgadget@gmail.com) |

---

**Thread**: [thread](./../../../2024/12/30/00-00-31.thread.md#:~:text=2025/01/04/14-47-53)

# Re: [ANNOUNCE] Git for Windows 2.48.0-rc1

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | Johannes Schindelin <johannes.schindelin@gmx.de> |
| **Date** | 2025-01-01T08:45:43-08:00 |
| **Message-ID** | [xmqqfrm2xz2g.fsf@gitster.g](https://lore.kernel.org/git/xmqqfrm2xz2g.fsf@gitster.g) |

---

**Thread**: [thread](./09-23-29.thread.md#:~:text=2025/01/01/16-45-43)

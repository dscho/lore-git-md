...
| **Date** | 2025-07-10T11:26:10+02:00 |
| **Message-ID** | [aG-HMnO11lCYgPiY@pks.im](https://lore.kernel.org/git/aG-HMnO11lCYgPiY@pks.im) |

---

**Thread**: [thread](./09-12-40.thread.md#:~:text=2025/07/10/09-26-10)
...
- [0001-sane-ctype-fix-compiler-error-on-Amazon-Linux-2.patch](0001-sane-ctype-fix-compiler-error-on-Amazon-Linux-2.patch) (text)

# Re: [PATCH] ci: update FreeBSD image to 14.3

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | Carlo Marcelo Arenas Belón via GitGitGadget <gitgitgadget@gmail.com> |
| **Date** | 2025-07-01T07:45:57-07:00 |
| **Message-ID** | [xmqqsejgklzu.fsf@gitster.g](https://lore.kernel.org/git/xmqqsejgklzu.fsf@gitster.g) |

---

**Thread**: [thread](./04-52-58.thread.md#:~:text=2025/07/01/14-45-57)

# [PATCH v2 09/19] streaming: create structure for filtered object streams

| Header | Value |
|--------|-------|
| **From** | Patrick Steinhardt <ps@pks.im> |
| **To** | git@vger.kernel.org |
| **Date** | 2025-11-21T08:40:54+01:00 |
| **Message-ID** | [20251121-b4-pks-odb-read-stream-v2-9-ca8534963150@pks.im](https://lore.kernel.org/git/20251121-b4-pks-odb-read-stream-v2-9-ca8534963150@pks.im) |

---

**Thread**: [thread](./../19/07-47-00.thread.md#:~:text=2025/11/21/07-40-54)

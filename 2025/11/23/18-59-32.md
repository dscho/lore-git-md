# [PATCH v3 07/19] streaming: create structure for loose object streams

| Header | Value |
|--------|-------|
| **From** | Patrick Steinhardt <ps@pks.im> |
| **To** | git@vger.kernel.org |
| **Date** | 2025-11-23T19:59:32+01:00 |
| **Message-ID** | [20251123-b4-pks-odb-read-stream-v3-7-1a129182822b@pks.im](https://lore.kernel.org/git/20251123-b4-pks-odb-read-stream-v3-7-1a129182822b@pks.im) |

---

**Thread**: [thread](./../19/07-47-00.thread.md#:~:text=2025/11/23/18-59-32)

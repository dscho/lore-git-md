# [PATCH v3 16/19] streaming: move logic to read packed objects streams into backend

| Header | Value |
|--------|-------|
| **From** | Patrick Steinhardt <ps@pks.im> |
| **To** | git@vger.kernel.org |
| **Date** | 2025-11-23T19:59:41+01:00 |
| **Message-ID** | [20251123-b4-pks-odb-read-stream-v3-16-1a129182822b@pks.im](https://lore.kernel.org/git/20251123-b4-pks-odb-read-stream-v3-16-1a129182822b@pks.im) |

---

**Thread**: [thread](./../19/07-47-00.thread.md#:~:text=2025/11/23/18-59-41)

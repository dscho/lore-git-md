# Re: [PATCH v2 18/19] streaming: move into object database subsystem

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | Patrick Steinhardt <ps@pks.im> |
| **Date** | 2025-11-22T18:20:20-08:00 |
| **Message-ID** | [xmqq5xb132xn.fsf@gitster.g](https://lore.kernel.org/git/xmqq5xb132xn.fsf@gitster.g) |

---

**Thread**: [thread](./../19/07-47-00.thread.md#:~:text=2025/11/23/02-20-20)

# [PATCH 16/18] streaming: move logic to read packed objects streams into backend

| Header | Value |
|--------|-------|
| **From** | Patrick Steinhardt <ps@pks.im> |
| **To** | git@vger.kernel.org |
| **Date** | 2025-11-19T08:47:16+01:00 |
| **Message-ID** | [20251119-b4-pks-odb-read-stream-v1-16-adacf03c2ccf@pks.im](https://lore.kernel.org/git/20251119-b4-pks-odb-read-stream-v1-16-adacf03c2ccf@pks.im) |

---

**Thread**: [thread](./07-47-00.thread.md#:~:text=2025/11/19/07-47-16)

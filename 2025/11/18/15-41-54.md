# [PATCH v2] win32: return error if SleepConditionVariableCS fails

| Header | Value |
|--------|-------|
| **From** | AZero13 via GitGitGadget <gitgitgadget@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2025-11-18T15:41:54Z |
| **Message-ID** | [pull.2104.v2.git.git.1763480514065.gitgitgadget@gmail.com](https://lore.kernel.org/git/pull.2104.v2.git.git.1763480514065.gitgitgadget@gmail.com) |

---

**Thread**: [thread](./00-59-51.thread.md#:~:text=2025/11/18/15-41-54)

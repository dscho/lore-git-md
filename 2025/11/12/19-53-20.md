# [PATCH v7] doc: add an explanation of Git's data model

| Header | Value |
|--------|-------|
| **From** | Julia Evans via GitGitGadget <gitgitgadget@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2025-11-12T19:53:20Z |
| **Message-ID** | [pull.1981.v7.git.1762977200244.gitgitgadget@gmail.com](https://lore.kernel.org/git/pull.1981.v7.git.1762977200244.gitgitgadget@gmail.com) |

---

**Thread**: [thread](./../../10/03/17-34-36.thread.md#:~:text=2025/11/12/19-53-20)

# [PATCH v3] commit: add --committer option

| Header | Value |
|--------|-------|
| **From** | ZheNing Hu via GitGitGadget <gitgitgadget@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2025-11-12T16:55:35Z |
| **Message-ID** | [pull.1997.v3.git.1762966535495.gitgitgadget@gmail.com](https://lore.kernel.org/git/pull.1997.v3.git.1762966535495.gitgitgadget@gmail.com) |

---

**Thread**: [thread](./../09/10-22-54.thread.md#:~:text=2025/11/12/16-55-35)

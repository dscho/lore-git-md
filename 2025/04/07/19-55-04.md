# [PATCH 1/1] t5601: modernize test by using test_path_is_file

| Header | Value |
|--------|-------|
| **From** | ayushjaiswal12123@gmail.com |
| **To** | git@vger.kernel.org |
| **Date** | 2025-04-08T01:25:04+05:30 |
| **Message-ID** | [20250407195505.86-2-ayushjaiswal12123@gmail.com](https://lore.kernel.org/git/20250407195505.86-2-ayushjaiswal12123@gmail.com) |

---

**Thread**: [thread](./19-55-03.thread.md#:~:text=2025/04/07/19-55-04)

From: Ayush Jaiswal <ayushjaiswal12123@gmail.com>

Updated a test to use 'test_path_is_file' instead of manually comparing output using 'test_cmp',
to align with modern Git test style and improve readability.

Verified that all tests pass after this change.
Initially, test 30 ('clone separate gitdir: output') failed due to incorrect output format.
Fixed the test logic and confirmed all tests pass.

Command used to find instances to modernize:
  git grep -F 'test -f' -- t/t5601-clone.sh

Signed-off-by: Ayush Jaiswal <ayushjaiswal12123@gmail.com>
---
```
...
+	gitdirpath=$(cat dst/.git | sed "s/gitdir: //") &&
+    abs_gitdir=$(cd dst && readlink -f "$gitdirpath") &&
+    echo "gitdir: $abs_gitdir" >expected &&

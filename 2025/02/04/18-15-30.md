# Re: [PATCH v4] gc: add `--expire-to` option

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | ZheNing Hu via GitGitGadget <gitgitgadget@gmail.com> |
| **Date** | 2025-02-04T10:15:30-08:00 |
| **Message-ID** | [xmqqh659tw3h.fsf@gitster.g](https://lore.kernel.org/git/xmqqh659tw3h.fsf@gitster.g) |

---

**Thread**: [thread](./../../../2024/12/24/11-52-57.thread.md#:~:text=2025/02/04/18-15-30)

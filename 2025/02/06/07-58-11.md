# [PATCH 15/16] environment: move access to "core.sharedRepository" into repo settings

| Header | Value |
|--------|-------|
| **From** | Patrick Steinhardt <ps@pks.im> |
| **To** | git@vger.kernel.org |
| **Date** | 2025-02-06T08:58:11+01:00 |
| **Message-ID** | [20250206-b4-pks-path-drop-the-repository-v1-15-4e77f0313206@pks.im](https://lore.kernel.org/git/20250206-b4-pks-path-drop-the-repository-v1-15-4e77f0313206@pks.im) |

---

**Thread**: [thread](./07-57-56.thread.md#:~:text=2025/02/06/07-58-11)

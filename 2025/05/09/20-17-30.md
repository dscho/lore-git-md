# Re: [GIT PULL] gitk: fix Cygwin infinite recursion, Tamil translation

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | Johannes Sixt <j6t@kdbg.org> |
| **Date** | 2025-05-09T13:17:30-07:00 |
| **Message-ID** | [xmqqjz6pzgh1.fsf@gitster.g](https://lore.kernel.org/git/xmqqjz6pzgh1.fsf@gitster.g) |

---

**Thread**: [thread](./17-29-16.thread.md#:~:text=2025/05/09/20-17-30)

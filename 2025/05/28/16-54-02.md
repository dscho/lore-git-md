# [ANNOUNCE] Git v2.50.0-rc0

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2025-05-28T09:54:02-07:00 |
| **Message-ID** | [xmqqzfewsml1.fsf@gitster.g](https://lore.kernel.org/git/xmqqzfewsml1.fsf@gitster.g) |

---

**Thread**: [thread](./16-54-02.thread.md#:~:text=2025/05/28/16-54-02)

...
| **Date** | 2014-12-07T14:14:52-05:00 |
| **Message-ID** | [8A724B8FE46E4B628FCC5A1A8A09918B@black](https://lore.kernel.org/git/8A724B8FE46E4B628FCC5A1A8A09918B@black) |

---

**Thread**: [thread](./14-24-09.thread.md#:~:text=2014/12/07/19-14-52)
...
>
> 'git credential-cache --timeout=99999999999 get'
> > 09:08:46.256967 run-command.c:192       trace: exec: 
>
> '/bin/sh' '-c' 'git credential-cache --timeout=99999999999 
> get' 'git credential-cache --timeout=99999999999 get'
...
>
> 'git credential-cache --timeout=99999999999 store'
> > 09:08:47.038632 run-command.c:192       trace: exec: 
>
> '/bin/sh' '-c' 'git credential-cache --timeout=99999999999 
> store' 'git credential-cache --timeout=99999999999 store'
...
I will have to make a testcase, sice the underlying problem was fixed at the time.

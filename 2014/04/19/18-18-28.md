...
| **Date** | 2014-04-19T20:18:28+02:00 |
| **Message-ID** | [1397931508-9752-1-git-send-email-ralf.thielow@gmail.com](https://lore.kernel.org/git/1397931508-9752-1-git-send-email-ralf.thielow@gmail.com) |

---

**Thread**: [thread](./18-18-28.thread.md#:~:text=2014/04/19/18-18-28)
...
@@ -5394,20 +5384,18 @@ msgstr "Schüssel"
...
+msgstr "Prüfe Objekt-Verzeichnisse"
 ...
 #: builtin/fsck.c:613
@@ -5448,15 +5436,14 @@ msgstr "schreibt unreferenzierte Objekte nach .git/lost-found"
...
+msgstr "Siehe \"git help gc\" für manuelle Einstellungen.\n"
 ...
 msgstr ""
@@ -7510,15 +7497,15 @@ msgstr "Konnte '%s' nicht als gültige Referenz auflösen."
 #: builtin/notes.c:272
 #, c-format
...
@@ -7659,13 +7646,12 @@ msgstr "der Versuch, eine nicht existierende Notiz zu löschen, ist kein Fehler"
...
@@ -7848,22 +7833,21 @@ msgstr "Komprimierungsgrad für Paketierung"
...
@@ -8870,13 +8852,13 @@ msgstr "git-update-server-info nicht ausführen"
...
@@ -9025,15 +9007,14 @@ msgstr "setzt HEAD, Staging-Area und Arbeitsverzeichnis um"
...
@@ -9065,15 +9046,14 @@ msgstr "Ein '%s'-Reset mit Pfaden ist nicht möglich."
 #: builtin/reset.c:340
 #, c-format

...
| **Date** | 2014-02-13T18:02:54+04:00 |
| **Message-ID** | [1dd9ca564e00ef235875aae4944675f53dcd25a3.1392299516.git.kirr@mns.spb.ru](https://lore.kernel.org/git/1dd9ca564e00ef235875aae4944675f53dcd25a3.1392299516.git.kirr@mns.spb.ru) |

---

**Thread**: [thread](./14-02-53.thread.md#:~:text=2014/02/13/14-02-54)
...
+/*
  ...
  *
@@ -33,72 +52,148 @@ static int tree_entry_pathcmp(struct tree_desc *t1, struct tree_desc *t2)
 }
...
@@ -107,18 +202,78 @@ static void show_path(struct strbuf *base, struct diff_options *opt,
...
@@ -137,59 +292,259 @@ static void skip_uninteresting(struct tree_desc *t, struct strbuf *base,
 	}
 }
...
+	return p;
 ...
 /*
@@ -300,6 +655,24 @@ static void try_to_follow_renames(const unsigned char *old, const unsigned char
 	q->nr = 1;
 }

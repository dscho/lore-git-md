...
| **Date** | 2014-07-28T19:03:10+07:00 |
| **Message-ID** | [1406548995-28549-5-git-send-email-pclouds@gmail.com](https://lore.kernel.org/git/1406548995-28549-5-git-send-email-pclouds@gmail.com) |

---

**Thread**: [thread](./12-03-06.thread.md#:~:text=2014/07/28/12-03-10)
...
--- a/git-compat-util.h
+++ b/git-compat-util.h
@@ -417,6 +417,7 @@ static inline int ends_with(const char *str, const char *suffix)
 #define PROT_READ 1
 #define PROT_WRITE 2
...
+	git_setup_gettext();
+	dont_poke_index_helper = 1; /* cyclic poking is no fun */
+
...
@@ -45,6 +46,7 @@ static struct cache_entry *refresh_cache_entry(struct cache_entry *ce,
...
+
 ...
 {
@@ -1498,15 +1559,17 @@ int do_read_index(struct index_state *istate, const char *path, int must_exist)
...
@@ -2054,9 +2117,13 @@ static int do_write_locked_index(struct index_state *istate, struct lock_file *l
 		return ret;

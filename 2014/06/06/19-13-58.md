...
| **Date** | 2014-06-06T12:13:58-07:00 |
| **Message-ID** | [xmqq1tv1rguh.fsf@gitster.dls.corp.google.com](https://lore.kernel.org/git/xmqq1tv1rguh.fsf@gitster.dls.corp.google.com) |

---

**Thread**: [thread](./../../05/29/10-43-29.thread.md#:~:text=2014/06/06/19-13-58)
...
```
    ...
    be deﬁned with a return type of int and with no parameters:
    ...
    or equivalent;10) or in some other implementation-deﬁned manner.

    ---
    10) Thus, int can be replaced by a typedef name deﬁned as int,

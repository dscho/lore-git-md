...
| **Date** | 2014-06-17T08:53:55-07:00 |
| **Message-ID** | [1403020442-31049-42-git-send-email-sahlberg@google.com](https://lore.kernel.org/git/1403020442-31049-42-git-send-email-sahlberg@google.com) |

---

**Thread**: [thread](./15-53-55.thread.md#:~:text=2014/06/17/15-53-55)
...
index aa5a74d..c501b9e 100644
--- a/refs.c
+++ b/refs.c
@@ -2394,8 +2394,8 @@ static void prune_ref(struct ref_to_prune *r)
 	transaction = ref_transaction_begin(&err);
 	if (!transaction ||
...
+	    ref_transaction_commit(transaction, &err)) {
 		...
 		error("%s", err.buf);
 		strbuf_release(&err);
@@ -2590,8 +2590,8 @@ int delete_ref(const char *refname, const unsigned char *sha1, int delopt)
 	transaction = ref_transaction_begin(&err);
 	if (!transaction ||
...
+	    ref_transaction_commit(transaction, &err)) {
 		...
 		ref_transaction_free(transaction);
 		strbuf_release(&err);
@@ -3368,6 +3368,7 @@ struct ref_update {
...
@@ -3415,9 +3416,10 @@ void ref_transaction_free(struct ref_transaction *transaction)
 	if (!transaction)
 		return;
...
@@ -3438,7 +3440,7 @@ int ref_transaction_update(struct ref_transaction *transaction,
 			   const char *refname,
...
@@ -3455,13 +3457,15 @@ int ref_transaction_update(struct ref_transaction *transaction,
...
+			   int flags, const char *msg,
 ...
 {
 	struct ref_update *update;
@@ -3478,13 +3482,15 @@ int ref_transaction_create(struct ref_transaction *transaction,
...
+			   int flags, int have_old, const char *msg,
 ...
 {
 	struct ref_update *update;
@@ -3502,6 +3508,8 @@ int ref_transaction_delete(struct ref_transaction *transaction,
...
@@ -3515,8 +3523,8 @@ int update_ref(const char *action, const char *refname,
...
@@ -3557,7 +3565,7 @@ static int ref_update_reject_duplicates(struct ref_update **updates, int n,
 }
...
+			   struct strbuf *err)
 {
 	...
 	const char **delnames;
@@ -3606,7 +3614,7 @@ int ref_transaction_commit(struct ref_transaction *transaction,

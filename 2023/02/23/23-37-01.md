# Re: [PATCH 14/16] t/lib-httpd: enable HTTP/2 "h2" protocol, not just h2c

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | Jeff King <peff@peff.net> |
| **Date** | 2023-02-23T15:37:01-08:00 |
| **Message-ID** | [xmqqfsaw3qea.fsf@gitster.g](https://lore.kernel.org/git/xmqqfsaw3qea.fsf@gitster.g) |

---

**Thread**: [thread](./10-48-01.thread.md#:~:text=2023/02/23/23-37-01)

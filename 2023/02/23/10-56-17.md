# [PATCH 06/16] t5551: handle HTTP/2 when checking curl trace

| Header | Value |
|--------|-------|
| **From** | Jeff King <peff@peff.net> |
| **To** | git@vger.kernel.org |
| **Date** | 2023-02-23T05:56:17-05:00 |
| **Message-ID** | [Y/dGUXaYrp6AqMxB@coredump.intra.peff.net](https://lore.kernel.org/git/Y/dGUXaYrp6AqMxB@coredump.intra.peff.net) |

---

**Thread**: [thread](./10-48-01.thread.md#:~:text=2023/02/23/10-56-17)

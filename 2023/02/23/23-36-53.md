# Re: [PATCH 04/16] t5551: drop redundant grep for Accept-Language

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | Jeff King <peff@peff.net> |
| **Date** | 2023-02-23T15:36:53-08:00 |
| **Message-ID** | [xmqqmt543qei.fsf@gitster.g](https://lore.kernel.org/git/xmqqmt543qei.fsf@gitster.g) |

---

**Thread**: [thread](./10-48-01.thread.md#:~:text=2023/02/23/23-36-53)

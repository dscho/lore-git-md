...
| **Date** | 2023-02-06T23:58:56+01:00 |
| **Message-ID** | [patch-v2-1.3-71c7922b25f-20230206T225639Z-avarab@gmail.com](https://lore.kernel.org/git/patch-v2-1.3-71c7922b25f-20230206T225639Z-avarab@gmail.com) |

---

**Thread**: [thread](./../03/16-30-01.thread.md#:~:text=2023/02/06/22-58-56)
...
```
 ...
 t/test-lib.sh                |    4 -
 12 files changed, 47 insertions(+), 2000 deletions(-)
...
index d5694f8c470..4b422888828 100644
--- a/INSTALL
+++ b/INSTALL

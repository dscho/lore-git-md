...
| **Date** | 2023-12-21T12:48:12+01:00 |
| **Message-ID** | [ZYQl_G-S4vQibHWn@framework](https://lore.kernel.org/git/ZYQl_G-S4vQibHWn@framework) |

---

**Thread**: [thread](./11-30-02.thread.md#:~:text=2023/12/21/11-48-12)

# [PATCH v2] [RFC] transport: add --show-service option

| Header | Value |
|--------|-------|
| **From** | ZheNing Hu via GitGitGadget <gitgitgadget@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2023-05-04T15:28:23Z |
| **Message-ID** | [pull.1523.v2.git.1683214104399.gitgitgadget@gmail.com](https://lore.kernel.org/git/pull.1523.v2.git.1683214104399.gitgitgadget@gmail.com) |

---

**Thread**: [thread](./../../04/24/13-17-21.thread.md#:~:text=2023/05/04/15-28-23)
